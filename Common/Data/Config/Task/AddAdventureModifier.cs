...
public class AddAdventureModifier : TaskConfigInfo
{
	...
	{
		AddAdventureModifier addAdventureModifier = new AddAdventureModifier
		{
		...
		if (obj.TryGetValue("TargetType", out JToken value))
		{
			...
			addAdventureModifier.TargetType = jObject.ToObject(type) as TargetEvaluator;
		}
		if (obj.TryGetValue("ModifierName", out value))
		{
			addAdventureModifier.ModifierName = value.ToObject<string>();
		}
		return addAdventureModifier;
	}
}
