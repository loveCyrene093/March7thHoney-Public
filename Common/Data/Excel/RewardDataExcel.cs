...
public class RewardDataExcel : ExcelResource
{
	...
	public List<(int, int)> GetItems()
	{
		...
		if (ItemID_1 != 0)
		{
			list.Add((ItemID_1, Count_1));
		}
		if (ItemID_2 != 0)
		{
			list.Add((ItemID_2, Count_2));
		}
		if (ItemID_3 != 0)
		{
			list.Add((ItemID_3, Count_3));
		}
		if (ItemID_4 != 0)
		{
			list.Add((ItemID_4, Count_4));
		}
		if (ItemID_5 != 0)
		{
			list.Add((ItemID_5, Count_5));
		}
		if (ItemID_6 != 0)
		{
			list.Add((ItemID_6, Count_6));
		}
		return list;
	}
}
