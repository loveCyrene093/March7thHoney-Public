...
public sealed class PrepareRogueAdventureRoomCsReq : IMessage<PrepareRogueAdventureRoomCsReq>, IMessage, IEquatable<PrepareRogueAdventureRoomCsReq>, IDeepCloneable<PrepareRogueAdventureRoomCsReq>, IBufferMessage
{
	...
	public static MessageParser<PrepareRogueAdventureRoomCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => PrepareRogueAdventureRoomCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public PrepareRogueAdventureRoomCsReq(PrepareRogueAdventureRoomCsReq other)
		: this()
	{
