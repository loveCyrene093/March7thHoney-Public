...
public sealed class GetTrackPhotoActivityDataCsReq : IMessage<GetTrackPhotoActivityDataCsReq>, IMessage, IEquatable<GetTrackPhotoActivityDataCsReq>, IDeepCloneable<GetTrackPhotoActivityDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetTrackPhotoActivityDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetTrackPhotoActivityDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetTrackPhotoActivityDataCsReq(GetTrackPhotoActivityDataCsReq other)
		: this()
	{
