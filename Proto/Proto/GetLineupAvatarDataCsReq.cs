...
public sealed class GetLineupAvatarDataCsReq : IMessage<GetLineupAvatarDataCsReq>, IMessage, IEquatable<GetLineupAvatarDataCsReq>, IDeepCloneable<GetLineupAvatarDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetLineupAvatarDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetLineupAvatarDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetLineupAvatarDataCsReq(GetLineupAvatarDataCsReq other)
		: this()
	{
