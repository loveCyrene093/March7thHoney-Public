...
public sealed class RogueMagicEnterCsReq : IMessage<RogueMagicEnterCsReq>, IMessage, IEquatable<RogueMagicEnterCsReq>, IDeepCloneable<RogueMagicEnterCsReq>, IBufferMessage
{
	...
	public static MessageParser<RogueMagicEnterCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueMagicEnterCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueMagicEnterCsReq(RogueMagicEnterCsReq other)
		: this()
	{
