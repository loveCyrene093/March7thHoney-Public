...
public static class FightFestUpdateChallengeRecordNotifyReflection
{
	...
	static FightFestUpdateChallengeRecordNotifyReflection()
	{
		...
		buffer[0] = "CipGaWdodEZlc3RVcGRhdGVDaGFsbGVuZ2VSZWNvcmROb3RpZnkucHJvdG8a";
		buffer[1] = "EVBCT0ZJQkxCUEdKLnByb3RvIqMBCiRGaWdodEZlc3RVcGRhdGVDaGFsbGVu";
		buffer[2] = "Z2VSZWNvcmROb3RpZnkSEwoLSEVJTEtCSkNBR0IYAyABKA0SIQoLTEpNTE5J";
		buffer[3] = "TkRIRUYYBCABKA4yDC5QQk9GSUJMQlBHShIaCgRyYW5rGAUgASgOMgwuUEJP";
		buffer[4] = "RklCTEJQR0oSFAoMY2hhbGxlbmdlX2lkGAYgASgNEhEKCXR1cm5fbGVmdBgM";
