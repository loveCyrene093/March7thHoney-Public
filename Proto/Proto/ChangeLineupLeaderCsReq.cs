...
public sealed class ChangeLineupLeaderCsReq : IMessage<ChangeLineupLeaderCsReq>, IMessage, IEquatable<ChangeLineupLeaderCsReq>, IDeepCloneable<ChangeLineupLeaderCsReq>, IBufferMessage
{
	...
	public static MessageParser<ChangeLineupLeaderCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ChangeLineupLeaderCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ChangeLineupLeaderCsReq(ChangeLineupLeaderCsReq other)
		: this()
	{
		slot_ = other.slot_;
