...
public sealed class GetShopListCsReq : IMessage<GetShopListCsReq>, IMessage, IEquatable<GetShopListCsReq>, IDeepCloneable<GetShopListCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetShopListCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetShopListCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetShopListCsReq(GetShopListCsReq other)
		: this()
	{
