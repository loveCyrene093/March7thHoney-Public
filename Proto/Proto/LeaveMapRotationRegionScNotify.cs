...
public sealed class LeaveMapRotationRegionScNotify : IMessage<LeaveMapRotationRegionScNotify>, IMessage, IEquatable<LeaveMapRotationRegionScNotify>, IDeepCloneable<LeaveMapRotationRegionScNotify>, IBufferMessage
{
	...
	public static MessageParser<LeaveMapRotationRegionScNotify> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => LeaveMapRotationRegionScNotifyReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public LeaveMapRotationRegionScNotify(LeaveMapRotationRegionScNotify other)
		: this()
	{
	...
	{
		return Equals(other as LeaveMapRotationRegionScNotify);
	}
