...
public sealed class ChooseBoxingClubResonanceScRsp : IMessage<ChooseBoxingClubResonanceScRsp>, IMessage, IEquatable<ChooseBoxingClubResonanceScRsp>, IDeepCloneable<ChooseBoxingClubResonanceScRsp>, IBufferMessage
{
	...
	public const int OPCGNJMGJDEFieldNumber = 15;

	private OOMINGEFPAF oPCGNJMGJDE_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<ChooseBoxingClubResonanceScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ChooseBoxingClubResonanceScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ChooseBoxingClubResonanceScRsp(ChooseBoxingClubResonanceScRsp other)
		: this()
	{
