...
public sealed class TakeApRewardCsReq : IMessage<TakeApRewardCsReq>, IMessage, IEquatable<TakeApRewardCsReq>, IDeepCloneable<TakeApRewardCsReq>, IBufferMessage
{
	...
	public static MessageParser<TakeApRewardCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => TakeApRewardCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public TakeApRewardCsReq(TakeApRewardCsReq other)
		: this()
	{
		level_ = other.level_;
