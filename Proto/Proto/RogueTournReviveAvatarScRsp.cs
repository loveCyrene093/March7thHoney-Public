...
public sealed class RogueTournReviveAvatarScRsp : IMessage<RogueTournReviveAvatarScRsp>, IMessage, IEquatable<RogueTournReviveAvatarScRsp>, IDeepCloneable<RogueTournReviveAvatarScRsp>, IBufferMessage
{
	...
	public const int EBMKBDJMAAFFieldNumber = 5;

	private ItemCostData eBMKBDJMAAF_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<RogueTournReviveAvatarScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueTournReviveAvatarScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueTournReviveAvatarScRsp(RogueTournReviveAvatarScRsp other)
		: this()
	{
