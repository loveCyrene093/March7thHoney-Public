...
public sealed class GetQuestRecordCsReq : IMessage<GetQuestRecordCsReq>, IMessage, IEquatable<GetQuestRecordCsReq>, IDeepCloneable<GetQuestRecordCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetQuestRecordCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetQuestRecordCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetQuestRecordCsReq(GetQuestRecordCsReq other)
		: this()
	{
