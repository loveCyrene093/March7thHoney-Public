...
public sealed class AetherDivideRefreshEndlessCsReq : IMessage<AetherDivideRefreshEndlessCsReq>, IMessage, IEquatable<AetherDivideRefreshEndlessCsReq>, IDeepCloneable<AetherDivideRefreshEndlessCsReq>, IBufferMessage
{
	...
	public static MessageParser<AetherDivideRefreshEndlessCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => AetherDivideRefreshEndlessCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public AetherDivideRefreshEndlessCsReq(AetherDivideRefreshEndlessCsReq other)
		: this()
	{
