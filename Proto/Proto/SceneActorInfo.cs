...
public sealed class SceneActorInfo : IMessage<SceneActorInfo>, IMessage, IEquatable<SceneActorInfo>, IDeepCloneable<SceneActorInfo>, IBufferMessage
{
	...
	public static MessageParser<SceneActorInfo> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => SceneActorInfoReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public SceneActorInfo(SceneActorInfo other)
		: this()
	{
