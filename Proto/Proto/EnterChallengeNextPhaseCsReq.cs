...
public sealed class EnterChallengeNextPhaseCsReq : IMessage<EnterChallengeNextPhaseCsReq>, IMessage, IEquatable<EnterChallengeNextPhaseCsReq>, IDeepCloneable<EnterChallengeNextPhaseCsReq>, IBufferMessage
{
	...
	public static MessageParser<EnterChallengeNextPhaseCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => EnterChallengeNextPhaseCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EnterChallengeNextPhaseCsReq(EnterChallengeNextPhaseCsReq other)
		: this()
	{
