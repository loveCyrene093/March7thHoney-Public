...
public sealed class PrestigeLevelUpScRsp : IMessage<PrestigeLevelUpScRsp>, IMessage, IEquatable<PrestigeLevelUpScRsp>, IDeepCloneable<PrestigeLevelUpScRsp>, IBufferMessage
{
	...
	public static MessageParser<PrestigeLevelUpScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => PrestigeLevelUpScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public PrestigeLevelUpScRsp(PrestigeLevelUpScRsp other)
		: this()
	{
		level_ = other.level_;
