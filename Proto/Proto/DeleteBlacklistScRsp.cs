...
public sealed class DeleteBlacklistScRsp : IMessage<DeleteBlacklistScRsp>, IMessage, IEquatable<DeleteBlacklistScRsp>, IDeepCloneable<DeleteBlacklistScRsp>, IBufferMessage
{
	...
	public static MessageParser<DeleteBlacklistScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => DeleteBlacklistScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public DeleteBlacklistScRsp(DeleteBlacklistScRsp other)
		: this()
	{
		uid_ = other.uid_;
