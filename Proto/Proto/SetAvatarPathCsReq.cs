...
public sealed class SetAvatarPathCsReq : IMessage<SetAvatarPathCsReq>, IMessage, IEquatable<SetAvatarPathCsReq>, IDeepCloneable<SetAvatarPathCsReq>, IBufferMessage
{
	...
	public static MessageParser<SetAvatarPathCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => SetAvatarPathCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public SetAvatarPathCsReq(SetAvatarPathCsReq other)
		: this()
	{
