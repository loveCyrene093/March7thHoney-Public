...
public sealed class RogueTournQueryCsReq : IMessage<RogueTournQueryCsReq>, IMessage, IEquatable<RogueTournQueryCsReq>, IDeepCloneable<RogueTournQueryCsReq>, IBufferMessage
{
	...
	public static MessageParser<RogueTournQueryCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueTournQueryCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueTournQueryCsReq(RogueTournQueryCsReq other)
		: this()
	{
	...
	{
		return Equals(other as RogueTournQueryCsReq);
	}
