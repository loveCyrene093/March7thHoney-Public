...
public sealed class GetChallengeCsReq : IMessage<GetChallengeCsReq>, IMessage, IEquatable<GetChallengeCsReq>, IDeepCloneable<GetChallengeCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetChallengeCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetChallengeCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetChallengeCsReq(GetChallengeCsReq other)
		: this()
	{
