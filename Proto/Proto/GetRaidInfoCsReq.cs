...
public sealed class GetRaidInfoCsReq : IMessage<GetRaidInfoCsReq>, IMessage, IEquatable<GetRaidInfoCsReq>, IDeepCloneable<GetRaidInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetRaidInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetRaidInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetRaidInfoCsReq(GetRaidInfoCsReq other)
		: this()
	{
