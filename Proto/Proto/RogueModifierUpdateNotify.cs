...
public sealed class RogueModifierUpdateNotify : IMessage<RogueModifierUpdateNotify>, IMessage, IEquatable<RogueModifierUpdateNotify>, IDeepCloneable<RogueModifierUpdateNotify>, IBufferMessage
{
	...
	public const int IMIBFEHPDDIFieldNumber = 4;

	private DOIJNCLJGKO iMIBFEHPDDI_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<RogueModifierUpdateNotify> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueModifierUpdateNotifyReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueModifierUpdateNotify(RogueModifierUpdateNotify other)
		: this()
	{
