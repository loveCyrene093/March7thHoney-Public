...
public sealed class GetCurLineupDataCsReq : IMessage<GetCurLineupDataCsReq>, IMessage, IEquatable<GetCurLineupDataCsReq>, IDeepCloneable<GetCurLineupDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetCurLineupDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetCurLineupDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetCurLineupDataCsReq(GetCurLineupDataCsReq other)
		: this()
	{
