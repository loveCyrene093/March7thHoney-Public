...
public sealed class TakeOffRelicScRsp : IMessage<TakeOffRelicScRsp>, IMessage, IEquatable<TakeOffRelicScRsp>, IDeepCloneable<TakeOffRelicScRsp>, IBufferMessage
{
	...
	public static MessageParser<TakeOffRelicScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => TakeOffRelicScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public TakeOffRelicScRsp(TakeOffRelicScRsp other)
		: this()
	{
