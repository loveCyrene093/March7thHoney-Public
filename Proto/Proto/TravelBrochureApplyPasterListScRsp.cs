...
public sealed class TravelBrochureApplyPasterListScRsp : IMessage<TravelBrochureApplyPasterListScRsp>, IMessage, IEquatable<TravelBrochureApplyPasterListScRsp>, IDeepCloneable<TravelBrochureApplyPasterListScRsp>, IBufferMessage
{
	...
	public const int MHMDIDKNCIHFieldNumber = 8;

	private PBPIOFGODHC mHMDIDKNCIH_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<TravelBrochureApplyPasterListScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => TravelBrochureApplyPasterListScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public TravelBrochureApplyPasterListScRsp(TravelBrochureApplyPasterListScRsp other)
		: this()
	{
