...
public sealed class MonopolyGameGachaCsReq : IMessage<MonopolyGameGachaCsReq>, IMessage, IEquatable<MonopolyGameGachaCsReq>, IDeepCloneable<MonopolyGameGachaCsReq>, IBufferMessage
{
	...
	public static MessageParser<MonopolyGameGachaCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MonopolyGameGachaCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MonopolyGameGachaCsReq(MonopolyGameGachaCsReq other)
		: this()
	{
	...
	{
		return Equals(other as MonopolyGameGachaCsReq);
	}
