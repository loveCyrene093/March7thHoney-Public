...
public sealed class GetPlayerBoardDataCsReq : IMessage<GetPlayerBoardDataCsReq>, IMessage, IEquatable<GetPlayerBoardDataCsReq>, IDeepCloneable<GetPlayerBoardDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetPlayerBoardDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetPlayerBoardDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetPlayerBoardDataCsReq(GetPlayerBoardDataCsReq other)
		: this()
	{
