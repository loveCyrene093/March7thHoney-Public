...
public sealed class GetCurBattleInfoCsReq : IMessage<GetCurBattleInfoCsReq>, IMessage, IEquatable<GetCurBattleInfoCsReq>, IDeepCloneable<GetCurBattleInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetCurBattleInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetCurBattleInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetCurBattleInfoCsReq(GetCurBattleInfoCsReq other)
		: this()
	{
