...
public sealed class SwordTrainingStoryConfirmCsReq : IMessage<SwordTrainingStoryConfirmCsReq>, IMessage, IEquatable<SwordTrainingStoryConfirmCsReq>, IDeepCloneable<SwordTrainingStoryConfirmCsReq>, IBufferMessage
{
	...
	public static MessageParser<SwordTrainingStoryConfirmCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => SwordTrainingStoryConfirmCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public SwordTrainingStoryConfirmCsReq(SwordTrainingStoryConfirmCsReq other)
		: this()
	{
