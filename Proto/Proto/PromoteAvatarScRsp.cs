...
public sealed class PromoteAvatarScRsp : IMessage<PromoteAvatarScRsp>, IMessage, IEquatable<PromoteAvatarScRsp>, IDeepCloneable<PromoteAvatarScRsp>, IBufferMessage
{
	...
	public static MessageParser<PromoteAvatarScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => PromoteAvatarScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public PromoteAvatarScRsp(PromoteAvatarScRsp other)
		: this()
	{
