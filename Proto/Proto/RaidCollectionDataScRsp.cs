...
public sealed class RaidCollectionDataScRsp : IMessage<RaidCollectionDataScRsp>, IMessage, IEquatable<RaidCollectionDataScRsp>, IDeepCloneable<RaidCollectionDataScRsp>, IBufferMessage
{
	...
	private static readonly FieldCodec<ALEOILCIFIN> _repeated_challengeList_codec = FieldCodec.ForMessage(66u, ALEOILCIFIN.Parser);

	private readonly RepeatedField<ALEOILCIFIN> challengeList_ = new RepeatedField<ALEOILCIFIN>();
	...
	public static MessageParser<RaidCollectionDataScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RaidCollectionDataScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RepeatedField<ALEOILCIFIN> ChallengeList => challengeList_;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RaidCollectionDataScRsp(RaidCollectionDataScRsp other)
		: this()
	{
