...
public sealed class MarkReadMailCsReq : IMessage<MarkReadMailCsReq>, IMessage, IEquatable<MarkReadMailCsReq>, IDeepCloneable<MarkReadMailCsReq>, IBufferMessage
{
	...
	public static MessageParser<MarkReadMailCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MarkReadMailCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MarkReadMailCsReq(MarkReadMailCsReq other)
		: this()
	{
		id_ = other.id_;
