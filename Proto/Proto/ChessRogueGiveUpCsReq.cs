...
public sealed class ChessRogueGiveUpCsReq : IMessage<ChessRogueGiveUpCsReq>, IMessage, IEquatable<ChessRogueGiveUpCsReq>, IDeepCloneable<ChessRogueGiveUpCsReq>, IBufferMessage
{
	...
	public static MessageParser<ChessRogueGiveUpCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ChessRogueGiveUpCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ChessRogueGiveUpCsReq(ChessRogueGiveUpCsReq other)
		: this()
	{
	...
	{
		return Equals(other as ChessRogueGiveUpCsReq);
	}
