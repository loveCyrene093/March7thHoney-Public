...
public sealed class GetFirstTalkNpcScRsp : IMessage<GetFirstTalkNpcScRsp>, IMessage, IEquatable<GetFirstTalkNpcScRsp>, IDeepCloneable<GetFirstTalkNpcScRsp>, IBufferMessage
{
	...
	public const int NpcMeetStatusListFieldNumber = 4;

	private static readonly FieldCodec<FirstNpcTalkInfo> _repeated_npcMeetStatusList_codec = FieldCodec.ForMessage(34u, FirstNpcTalkInfo.Parser);
	...
	public static MessageParser<GetFirstTalkNpcScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetFirstTalkNpcScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RepeatedField<FirstNpcTalkInfo> NpcMeetStatusList => npcMeetStatusList_;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetFirstTalkNpcScRsp(GetFirstTalkNpcScRsp other)
		: this()
	{
