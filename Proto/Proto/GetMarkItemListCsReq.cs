...
public sealed class GetMarkItemListCsReq : IMessage<GetMarkItemListCsReq>, IMessage, IEquatable<GetMarkItemListCsReq>, IDeepCloneable<GetMarkItemListCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetMarkItemListCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetMarkItemListCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetMarkItemListCsReq(GetMarkItemListCsReq other)
		: this()
	{
