...
public sealed class DifficultyAdjustmentGetDataScRsp : IMessage<DifficultyAdjustmentGetDataScRsp>, IMessage, IEquatable<DifficultyAdjustmentGetDataScRsp>, IDeepCloneable<DifficultyAdjustmentGetDataScRsp>, IBufferMessage
{
	...
	private static readonly FieldCodec<LMHOIMLGNGM> _repeated_contentPackageList_codec = FieldCodec.ForMessage(26u, LMHOIMLGNGM.Parser);

	private readonly RepeatedField<LMHOIMLGNGM> contentPackageList_ = new RepeatedField<LMHOIMLGNGM>();

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<DifficultyAdjustmentGetDataScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => DifficultyAdjustmentGetDataScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public DifficultyAdjustmentGetDataScRsp(DifficultyAdjustmentGetDataScRsp other)
		: this()
	{
