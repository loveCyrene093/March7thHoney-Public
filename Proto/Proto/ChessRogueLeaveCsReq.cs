...
public sealed class ChessRogueLeaveCsReq : IMessage<ChessRogueLeaveCsReq>, IMessage, IEquatable<ChessRogueLeaveCsReq>, IDeepCloneable<ChessRogueLeaveCsReq>, IBufferMessage
{
	...
	public static MessageParser<ChessRogueLeaveCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ChessRogueLeaveCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ChessRogueLeaveCsReq(ChessRogueLeaveCsReq other)
		: this()
	{
	...
	{
		return Equals(other as ChessRogueLeaveCsReq);
	}
