...
public sealed class EnterSectionScRsp : IMessage<EnterSectionScRsp>, IMessage, IEquatable<EnterSectionScRsp>, IDeepCloneable<EnterSectionScRsp>, IBufferMessage
{
	...
	public static MessageParser<EnterSectionScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => EnterSectionScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EnterSectionScRsp(EnterSectionScRsp other)
		: this()
	{
