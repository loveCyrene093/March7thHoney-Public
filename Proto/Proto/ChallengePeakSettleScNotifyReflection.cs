...
public static class ChallengePeakSettleScNotifyReflection
{
	...
	static ChallengePeakSettleScNotifyReflection()
	{
		...
		buffer[0] = "CiFDaGFsbGVuZ2VQZWFrU2V0dGxlU2NOb3RpZnkucHJvdG8aHkNoYWxsZW5n";
		buffer[1] = "ZVBlYWtSZXdhcmRHcm91cC5wcm90byLJAgobQ2hhbGxlbmdlUGVha1NldHRs";
		buffer[2] = "ZVNjTm90aWZ5EhwKFGhhcmRfbW9kZV9oYXNfcGFzc2VkGAIgASgIEhsKE2lz";
		buffer[3] = "X3VubG9ja19lYXN5X2Jvc3MYAyABKAgSHAoUZmluaXNoZWRfdGFyZ2V0X2xp";
		buffer[4] = "c3QYBSADKA0SDwoHcGVha19pZBgGIAEoDRIRCgl0dXJuX2xlZnQYByABKA0S";
		buffer[5] = "HQoVaXNfYm9zc190YXJnZXRfYmV0dGVyGAggASgIEhMKC2N5Y2xlc191c2Vk";
		buffer[6] = "GAogASgNEhcKD2lzX3dhaXRfY29uZmlybRgLIAEoCBIOCgZpc193aW4YDSAB";
		buffer[7] = "KAgSOQoWcGVha19yZXdhcmRfZ3JvdXBfbGlzdBgOIAMoCzIZLkNoYWxsZW5n";
		buffer[8] = "ZVBlYWtSZXdhcmRHcm91cBIVCg1pc19maXJzdF9wYXNzGA8gASgIQhaqAhNN";
