...
public sealed class GetAlleyInfoCsReq : IMessage<GetAlleyInfoCsReq>, IMessage, IEquatable<GetAlleyInfoCsReq>, IDeepCloneable<GetAlleyInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetAlleyInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetAlleyInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetAlleyInfoCsReq(GetAlleyInfoCsReq other)
		: this()
	{
