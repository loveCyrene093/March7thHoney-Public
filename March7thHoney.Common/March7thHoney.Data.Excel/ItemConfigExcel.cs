...
[ResourceEntity("ItemConfig.json,ItemConfigAvatar.json,ItemConfigAvatarPlayerIcon.json,ItemConfigAvatarRank.json,ItemConfigBook.json,ItemConfigDisk.json,ItemConfigEquipment.json,ItemConfigRelic.json,ItemPlayerCard.json,ItemConfigTrainDynamic.json", true)]
