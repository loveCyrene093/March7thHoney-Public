...
public static class HardwareIdManager
{
	public static string GetHwid()
	{
		...
		global::_003CPrivateImplementationDetails_003E.InlineArrayElementRef<InlineArray4<string>, string>(ref buffer, 0) = GetMachineGuid();
		global::_003CPrivateImplementationDetails_003E.InlineArrayElementRef<InlineArray4<string>, string>(ref buffer, 1) = Environment.MachineName;
		global::_003CPrivateImplementationDetails_003E.InlineArrayElementRef<InlineArray4<string>, string>(ref buffer, 2) = Environment.UserDomainName;
		global::_003CPrivateImplementationDetails_003E.InlineArrayElementRef<InlineArray4<string>, string>(ref buffer, 3) = Environment.OSVersion.VersionString;
		string s = string.Join("|", global::_003CPrivateImplementationDetails_003E.InlineArrayAsReadOnlySpan<InlineArray4<string>, string>(in buffer, 4));
