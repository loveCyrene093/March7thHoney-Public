...
public class BattleInstance(PlayerInstance player, March7thHoney.Database.Lineup.LineupInfo lineup, List<StageConfigExcel> stages) : BasePlayerManager(player)
{
	...
	public List<ItemData> MonsterDropItems { get; set; } = new List<ItemData>();

	public List<StageConfigExcel> Stages { get; set; } = stages;

	public March7thHoney.Database.Lineup.LineupInfo Lineup { get; set; } = lineup;

	public List<EntityMonster> EntityMonsters { get; set; } = new List<EntityMonster>();

	public List<AvatarSceneInfo> AvatarInfo { get; set; } = new List<AvatarSceneInfo>();

	public List<MazeBuff> Buffs { get; set; } = new List<MazeBuff>();

	public BattleRogueMagicInfo? MagicInfo { get; set; }

	public Dictionary<int, BattleEventInstance> BattleEvents { get; set; } = new Dictionary<int, BattleEventInstance>();

	public Dictionary<int, BattleTargetList> BattleTargets { get; set; } = new Dictionary<int, BattleTargetList>();
