...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from BBBJMJJOJDP.proto</summary>
  public static partial class BBBJMJJOJDPReflection {

    #region Descriptor
    /// <summary>File descriptor for BBBJMJJOJDP.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "BICBJMPAAAN" field.</summary>
    ...
    /// <summary>Field number for the "AGOODNEGKBA" field.</summary>
    ...
    /// <summary>Field number for the "FCKNPGPHCEL" field.</summary>
    ...
    /// <summary>Field number for the "CONJDDKAFKO" field.</summary>
    ...
    /// <summary>Field number for the "LODDNBBEFKB" field.</summary>
    ...
    /// <summary>Field number for the "OGKNEBGDEFN" field.</summary>
    ...
    /// <summary>Field number for the "ODFMPNINDEL" field.</summary>
    ...
    /// <summary>Field number for the "AMIBFOEAJGL" field.</summary>
    ...
    /// <summary>Field number for the "FHJFFLDHJGJ" field.</summary>
    ...
    /// <summary>Field number for the "NGCACDGALBI" field.</summary>
    ...
    /// <summary>Field number for the "OEEJPPJGKDI" field.</summary>
    ...
    /// <summary>Field number for the "AGDPOMEMMNB" field.</summary>
    ...
    /// <summary>Field number for the "IFLBGGLOPLF" field.</summary>
    ...
    /// <summary>Field number for the "GFDLPEIOCOG" field.</summary>
