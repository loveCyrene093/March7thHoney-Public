...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from FNBJPMGMJDP.proto</summary>
  public static partial class FNBJPMGMJDPReflection {

    #region Descriptor
    /// <summary>File descriptor for FNBJPMGMJDP.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "NONOOKBIBOM" field.</summary>
    ...
    /// <summary>Field number for the "JOGONJILJDL" field.</summary>
    ...
    /// <summary>Field number for the "DHHGLGJBDMJ" field.</summary>
