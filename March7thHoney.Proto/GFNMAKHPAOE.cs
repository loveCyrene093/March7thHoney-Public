...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from GFNMAKHPAOE.proto</summary>
  public static partial class GFNMAKHPAOEReflection {

    #region Descriptor
    /// <summary>File descriptor for GFNMAKHPAOE.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "GEMHDNHDAFB" field.</summary>
    ...
    /// <summary>Field number for the "CJECINJPIIJ" field.</summary>
    ...
    /// <summary>Field number for the "MNIOANAMFMK" field.</summary>
    ...
    /// <summary>Field number for the "GPBDPOOPAAD" field.</summary>
