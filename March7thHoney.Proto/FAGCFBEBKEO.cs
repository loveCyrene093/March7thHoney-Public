...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from FAGCFBEBKEO.proto</summary>
  public static partial class FAGCFBEBKEOReflection {

    #region Descriptor
    /// <summary>File descriptor for FAGCFBEBKEO.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "PLKJCAMBAIC" field.</summary>
    ...
    /// <summary>Field number for the "BKKEFFGGEFA" field.</summary>
    ...
    /// <summary>Field number for the "BLDEPELAIHM" field.</summary>
    ...
    /// <summary>Field number for the "DGPPEAPLMPA" field.</summary>
    ...
    /// <summary>Field number for the "KJFLCBDNLCF" field.</summary>
