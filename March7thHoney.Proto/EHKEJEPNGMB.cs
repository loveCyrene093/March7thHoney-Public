...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from EHKEJEPNGMB.proto</summary>
  public static partial class EHKEJEPNGMBReflection {

    #region Descriptor
    /// <summary>File descriptor for EHKEJEPNGMB.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "NINNEKFGNLI" field.</summary>
    ...
    /// <summary>Field number for the "FJHHJEDPHMA" field.</summary>
    ...
    /// <summary>Field number for the "GNCOPJNBCKI" field.</summary>
    ...
    /// <summary>Field number for the "OFOMBFJEDKC" field.</summary>
