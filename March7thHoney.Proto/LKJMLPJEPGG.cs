...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from LKJMLPJEPGG.proto</summary>
  public static partial class LKJMLPJEPGGReflection {

    #region Descriptor
    /// <summary>File descriptor for LKJMLPJEPGG.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "HEIHGFAOFNK" field.</summary>
    ...
    /// <summary>Field number for the "MNBPGMBLMJP" field.</summary>
    ...
    /// <summary>Field number for the "FFBMMHAOHCA" field.</summary>
