...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from BPCGILFKCFE.proto</summary>
  public static partial class BPCGILFKCFEReflection {

    #region Descriptor
    /// <summary>File descriptor for BPCGILFKCFE.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JFNCMHCAGGH" field.</summary>
    ...
    /// <summary>Field number for the "CJAJBMAJNJP" field.</summary>
    ...
    /// <summary>Field number for the "BNALACMGKFJ" field.</summary>
