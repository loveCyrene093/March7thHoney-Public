...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from OAHNIFMDLCJ.proto</summary>
  public static partial class OAHNIFMDLCJReflection {

    #region Descriptor
    /// <summary>File descriptor for OAHNIFMDLCJ.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "PFGLKFBHGKM" field.</summary>
    ...
    /// <summary>Field number for the "ILGIANHEALF" field.</summary>
    ...
    /// <summary>Field number for the "NGDKBDAMEHM" field.</summary>
    ...
    /// <summary>Field number for the "JOEBAPNOLAF" field.</summary>
