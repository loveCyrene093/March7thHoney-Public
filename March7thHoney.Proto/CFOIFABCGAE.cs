...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from CFOIFABCGAE.proto</summary>
  public static partial class CFOIFABCGAEReflection {

    #region Descriptor
    /// <summary>File descriptor for CFOIFABCGAE.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "IKLDFMBGHGB" field.</summary>
    ...
    /// <summary>Field number for the "NAFLDJFCCPC" field.</summary>
    ...
    /// <summary>Field number for the "IAHOBGFDBML" field.</summary>
