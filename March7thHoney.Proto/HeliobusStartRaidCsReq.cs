...
namespace March7thHoney.Proto {
    ...
    static HeliobusStartRaidCsReqReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "YXJ0UmFpZENzUmVxEg8KB3JhaWRfaWQYBiABKA0SFgoOcHJvcF9lbnRpdHlf",
            "aWQYCSABKA0SDwoHaXNfc2F2ZRgLIAEoCBIQCghza2lsbF9pZBgNIAEoDRIT",
            "CgtQS0JBRUJESEZETBgOIAEoDRITCgthdmF0YXJfbGlzdBgPIAMoDUIWqgIT",
            "TWFyY2g3dGhIb25leS5Qcm90b2IGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::March7thHoney.Proto.HeliobusStartRaidCsReq), global::March7thHoney.Proto.HeliobusStartRaidCsReq.Parser, new[]{ "RaidId", "PropEntityId", "IsSave", "SkillId", "PKBAEBDHFDL", "AvatarList" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::March7thHoney.Proto.HeliobusStartRaidCsReqReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    public bool Equals(HeliobusStartRaidCsReq other) {
      ...
      if (PKBAEBDHFDL != other.PKBAEBDHFDL) return false;
    ...
    public override int GetHashCode() {
      ...
      if (PKBAEBDHFDL != 0) hash ^= PKBAEBDHFDL.GetHashCode();
    ...
    public int CalculateSize() {
      ...
      if (PKBAEBDHFDL != 0) {
        size += 1 + pb::CodedOutputStream.ComputeUInt32Size(PKBAEBDHFDL);
      }
