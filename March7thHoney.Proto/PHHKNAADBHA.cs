...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from PHHKNAADBHA.proto</summary>
  public static partial class PHHKNAADBHAReflection {

    #region Descriptor
    /// <summary>File descriptor for PHHKNAADBHA.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "HHHNONKPFGP" field.</summary>
    ...
    /// <summary>Field number for the "PKCOBJBILEO" field.</summary>
    ...
    /// <summary>Field number for the "DJCILMADPKC" field.</summary>
    ...
    /// <summary>Field number for the "DEMDFDBCOAJ" field.</summary>
    ...
    /// <summary>Field number for the "NLBOGKNFNNE" field.</summary>
    ...
    /// <summary>Field number for the "LFMEPGNEHHF" field.</summary>
    ...
    /// <summary>Field number for the "MHAAMIGLIKI" field.</summary>
    ...
    /// <summary>Field number for the "PGKHBPKIFBE" field.</summary>
