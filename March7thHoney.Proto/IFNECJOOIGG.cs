...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from IFNECJOOIGG.proto</summary>
  public static partial class IFNECJOOIGGReflection {

    #region Descriptor
    /// <summary>File descriptor for IFNECJOOIGG.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "NFEJLJDLAGF" field.</summary>
    ...
    /// <summary>Field number for the "NBFMEMNCGMJ" field.</summary>
    ...
    /// <summary>Field number for the "LMGHANJCECF" field.</summary>
