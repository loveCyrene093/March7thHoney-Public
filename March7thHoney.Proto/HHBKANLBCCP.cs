...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from HHBKANLBCCP.proto</summary>
  public static partial class HHBKANLBCCPReflection {

    #region Descriptor
    /// <summary>File descriptor for HHBKANLBCCP.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "CIGFOLLCKKI" field.</summary>
    ...
    /// <summary>Field number for the "EFLLPPLCKBB" field.</summary>
    ...
    /// <summary>Field number for the "FBHGPPCKEIC" field.</summary>
