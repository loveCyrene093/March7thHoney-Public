...
namespace March7thHoney.Proto {
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "AJMBOLHDGHK" field.</summary>
    ...
    /// <summary>Field number for the "PDLBECHDJBL" field.</summary>
    ...
    /// <summary>Field number for the "BMPCCPCCJJO" field.</summary>
    ...
    /// <summary>Field number for the "CALIMAKGGHJ" field.</summary>
    ...
    /// <summary>Field number for the "DKCFJNDCBEP" field.</summary>
