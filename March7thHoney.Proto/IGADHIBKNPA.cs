...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from IGADHIBKNPA.proto</summary>
  public static partial class IGADHIBKNPAReflection {

    #region Descriptor
    /// <summary>File descriptor for IGADHIBKNPA.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "KCFPIGCEHIG" field.</summary>
    ...
    /// <summary>Field number for the "NIFHFOHLCED" field.</summary>
    ...
    /// <summary>Field number for the "KIENHENNAKJ" field.</summary>
    ...
    /// <summary>Field number for the "NBMNHCMJDFO" field.</summary>
