...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from CIDLPPKAJPO.proto</summary>
  public static partial class CIDLPPKAJPOReflection {

    #region Descriptor
    /// <summary>File descriptor for CIDLPPKAJPO.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "LGJHGODNJGM" field.</summary>
    ...
    /// <summary>Field number for the "HGPIGGLBFMM" field.</summary>
    ...
    /// <summary>Enum of possible cases for the "IHCIAHIFPLL" oneof.</summary>
