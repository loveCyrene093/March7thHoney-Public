...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from OOKCIAEIPON.proto</summary>
  public static partial class OOKCIAEIPONReflection {

    #region Descriptor
    /// <summary>File descriptor for OOKCIAEIPON.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "IMIHGLAOIEG" field.</summary>
    ...
    /// <summary>Field number for the "KKHNDGEJBHJ" field.</summary>
    ...
    /// <summary>Field number for the "GOODPDKGJAJ" field.</summary>
    ...
    /// <summary>Field number for the "GFELHICKOGI" field.</summary>
