...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from IHGBDAGHDME.proto</summary>
  public static partial class IHGBDAGHDMEReflection {

    #region Descriptor
    /// <summary>File descriptor for IHGBDAGHDME.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "BNFHLIBFLID" field.</summary>
    ...
    /// <summary>Field number for the "IIDPHLIMMPF" field.</summary>
    ...
    /// <summary>Field number for the "OMNFDNBEPLA" field.</summary>
    ...
    /// <summary>Field number for the "KDBLAHBIHDO" field.</summary>
    ...
    /// <summary>Field number for the "BNMOMHOCBPH" field.</summary>
