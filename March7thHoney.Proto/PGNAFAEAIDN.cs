...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from PGNAFAEAIDN.proto</summary>
  public static partial class PGNAFAEAIDNReflection {

    #region Descriptor
    /// <summary>File descriptor for PGNAFAEAIDN.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "HLKAFPCLMEO" field.</summary>
    ...
    /// <summary>Field number for the "GGFIJFDFGCM" field.</summary>
    ...
    /// <summary>Field number for the "CJOPNFDBJHD" field.</summary>
    ...
    /// <summary>Field number for the "IMLOEHHAJOI" field.</summary>
    ...
    /// <summary>Field number for the "PGHPKHCNPMF" field.</summary>
    ...
    /// <summary>Field number for the "JJNKPCBKOKB" field.</summary>
    ...
    /// <summary>Field number for the "KLONCIGADNI" field.</summary>
