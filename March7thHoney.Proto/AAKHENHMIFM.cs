...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from AAKHENHMIFM.proto</summary>
  public static partial class AAKHENHMIFMReflection {

    #region Descriptor
    /// <summary>File descriptor for AAKHENHMIFM.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "OFAMBDEICME" field.</summary>
    ...
    /// <summary>Field number for the "PBAGJGMOLFB" field.</summary>
    ...
    /// <summary>Field number for the "KNFCAGFAHBJ" field.</summary>
    ...
    /// <summary>Field number for the "BDECLDMDNGI" field.</summary>
