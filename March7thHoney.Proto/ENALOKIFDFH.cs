...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from ENALOKIFDFH.proto</summary>
  public static partial class ENALOKIFDFHReflection {

    #region Descriptor
    /// <summary>File descriptor for ENALOKIFDFH.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "FADFCMMNDDK" field.</summary>
    ...
    /// <summary>Field number for the "KLOBEEOJBCN" field.</summary>
    ...
    /// <summary>Field number for the "FHJBMBLFAFH" field.</summary>
