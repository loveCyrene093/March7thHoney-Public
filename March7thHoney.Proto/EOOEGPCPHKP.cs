...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from EOOEGPCPHKP.proto</summary>
  public static partial class EOOEGPCPHKPReflection {

    #region Descriptor
    /// <summary>File descriptor for EOOEGPCPHKP.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "DAPJEDHFKCM" field.</summary>
    ...
    /// <summary>Field number for the "IADDBBBDGGM" field.</summary>
    ...
    /// <summary>Field number for the "ECJCCKFEFEJ" field.</summary>
    ...
    /// <summary>Enum of possible cases for the "FHPJJJDNKIO" oneof.</summary>
