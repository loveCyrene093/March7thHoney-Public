...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from ELLNDNEBHDK.proto</summary>
  public static partial class ELLNDNEBHDKReflection {

    #region Descriptor
    /// <summary>File descriptor for ELLNDNEBHDK.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "OCLLADBFKHP" field.</summary>
    ...
    /// <summary>Field number for the "LGPPFKDKHEC" field.</summary>
    ...
    /// <summary>Field number for the "OCINKMOAMOM" field.</summary>
    ...
    /// <summary>Field number for the "IHEJOGHDPMI" field.</summary>
