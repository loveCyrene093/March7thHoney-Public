...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from JHAKADEKJEJ.proto</summary>
  public static partial class JHAKADEKJEJReflection {

    #region Descriptor
    /// <summary>File descriptor for JHAKADEKJEJ.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "CGHMNCEAPPB" field.</summary>
    ...
    /// <summary>Field number for the "EIPLGIIHDID" field.</summary>
    ...
    /// <summary>Field number for the "AKAFHHLKFKI" field.</summary>
