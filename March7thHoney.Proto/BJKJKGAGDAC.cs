...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from BJKJKGAGDAC.proto</summary>
  public static partial class BJKJKGAGDACReflection {

    #region Descriptor
    /// <summary>File descriptor for BJKJKGAGDAC.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "DBBAEOHIAPA" field.</summary>
    ...
    /// <summary>Field number for the "GBOCDPDNFLF" field.</summary>
    ...
    /// <summary>Field number for the "IBLNHMFCLPP" field.</summary>
    ...
    /// <summary>Field number for the "DIOGJKODMPK" field.</summary>
    ...
    /// <summary>Field number for the "DOBENIECLNN" field.</summary>
