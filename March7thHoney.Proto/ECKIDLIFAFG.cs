...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from ECKIDLIFAFG.proto</summary>
  public static partial class ECKIDLIFAFGReflection {

    #region Descriptor
    /// <summary>File descriptor for ECKIDLIFAFG.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "PCPELPMKMCI" field.</summary>
    ...
    /// <summary>Field number for the "MGIAPAEKOMB" field.</summary>
    ...
    /// <summary>Field number for the "IPGMEHBCJCO" field.</summary>
    ...
    /// <summary>Field number for the "MKALAGHLBPF" field.</summary>
    ...
    /// <summary>Field number for the "BNEOOJJKKFM" field.</summary>
    ...
    /// <summary>Field number for the "LGIKOOEFLJM" field.</summary>
    ...
    /// <summary>Field number for the "BJBPFMMNDCM" field.</summary>
    ...
    /// <summary>Field number for the "EAJKJJADFLP" field.</summary>
    ...
    /// <summary>Field number for the "BEDFEJONFNK" field.</summary>
    ...
    /// <summary>Field number for the "OFAPPJDDIMM" field.</summary>
    ...
    /// <summary>Field number for the "CHCJICCNKBJ" field.</summary>
    ...
    /// <summary>Field number for the "OCJEMODOHIK" field.</summary>
    ...
    /// <summary>Field number for the "JFBPCDGCBNL" field.</summary>
    ...
    /// <summary>Field number for the "AKPAPLCNPDC" field.</summary>
