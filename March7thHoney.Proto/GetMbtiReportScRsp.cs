...
namespace March7thHoney.Proto {
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JBLLICOOCAK" field.</summary>
    ...
    /// <summary>Field number for the "EHMEFABLODD" field.</summary>
    ...
    /// <summary>Field number for the "HNLDLOOAPMI" field.</summary>
    ...
    /// <summary>Field number for the "HHPALHMBLFK" field.</summary>
    ...
    /// <summary>Field number for the "PMAGOBNHJJD" field.</summary>
