...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from DFAGKMFOENB.proto</summary>
  public static partial class DFAGKMFOENBReflection {

    #region Descriptor
    /// <summary>File descriptor for DFAGKMFOENB.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "LMIICENMOBI" field.</summary>
    ...
    /// <summary>Field number for the "PJFKJHLAAPF" field.</summary>
    ...
    /// <summary>Field number for the "OAMPHBHNNBK" field.</summary>
    ...
    /// <summary>Field number for the "ADEHMLEICHL" field.</summary>
    ...
    /// <summary>Field number for the "NEHOMOBBPEN" field.</summary>
    ...
    /// <summary>Field number for the "AHLMICKLGHP" field.</summary>
    ...
    /// <summary>Field number for the "AIFJPNDMACI" field.</summary>
    ...
    /// <summary>Field number for the "BGHMFOMMLOH" field.</summary>
    ...
    /// <summary>Field number for the "PMGCGIGPNFG" field.</summary>
    ...
    /// <summary>Field number for the "NFPKFFCHLHF" field.</summary>
    ...
    /// <summary>Field number for the "HHPMJNKNKHN" field.</summary>
    ...
    /// <summary>Field number for the "NGGADJOOMEK" field.</summary>
    ...
    /// <summary>Field number for the "NMELOCJNOAP" field.</summary>
    ...
    /// <summary>Field number for the "FBFHMKCFBPD" field.</summary>
    ...
    /// <summary>Field number for the "LPILMOECPLA" field.</summary>
    ...
    /// <summary>Field number for the "KECBLOHENKO" field.</summary>
    ...
    /// <summary>Field number for the "EGKOIJHKNFE" field.</summary>
    ...
    /// <summary>Field number for the "AACOABBJHKO" field.</summary>
    ...
    /// <summary>Field number for the "PKINLGBPHBP" field.</summary>
    ...
    /// <summary>Field number for the "OMFBJPDFDBJ" field.</summary>
    ...
    /// <summary>Field number for the "AFENAIBNKGI" field.</summary>
    ...
    /// <summary>Field number for the "EIMAFPEBCAE" field.</summary>
    ...
    /// <summary>Field number for the "CEFGOMFNHGO" field.</summary>
    ...
    /// <summary>Field number for the "JEEKEIGMDJN" field.</summary>
    ...
    /// <summary>Field number for the "KIIDBLFLAJN" field.</summary>
    ...
    /// <summary>Field number for the "GAFENFCGIFK" field.</summary>
    ...
    /// <summary>Field number for the "JNKFEGHCABK" field.</summary>
    ...
    /// <summary>Field number for the "MDGJHBJPDJH" field.</summary>
    ...
    /// <summary>Field number for the "IMJNJFCCJPC" field.</summary>
    ...
    /// <summary>Field number for the "GEEMCLCCFCN" field.</summary>
    ...
    /// <summary>Field number for the "IDCGKOMADPL" field.</summary>
    ...
    /// <summary>Field number for the "COIKELCNIIP" field.</summary>
    ...
    /// <summary>Field number for the "EIOKOADEOFC" field.</summary>
    ...
    /// <summary>Field number for the "HPGEDIAGCLI" field.</summary>
    ...
    /// <summary>Field number for the "AGKGMLOMDGE" field.</summary>
    ...
    /// <summary>Field number for the "NKLCEHNFCKM" field.</summary>
    ...
    /// <summary>Field number for the "BJCFPBDCCBG" field.</summary>
    ...
    /// <summary>Field number for the "OMKLLPFPABL" field.</summary>
    ...
    /// <summary>Field number for the "NHLCPDMOFLA" field.</summary>
