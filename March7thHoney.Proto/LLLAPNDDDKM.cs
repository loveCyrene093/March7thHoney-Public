...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from LLLAPNDDDKM.proto</summary>
  public static partial class LLLAPNDDDKMReflection {

    #region Descriptor
    /// <summary>File descriptor for LLLAPNDDDKM.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "OGHCMDFNGMF" field.</summary>
    ...
    /// <summary>Field number for the "NPBKLCHLJMG" field.</summary>
    ...
    /// <summary>Field number for the "NBAKHCLLEKJ" field.</summary>
