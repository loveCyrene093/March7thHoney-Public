...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from JAFMFGJLGGA.proto</summary>
  public static partial class JAFMFGJLGGAReflection {

    #region Descriptor
    /// <summary>File descriptor for JAFMFGJLGGA.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "DENHCJPAMAN" field.</summary>
    ...
    /// <summary>Field number for the "AEDBEGKAJMM" field.</summary>
    ...
    /// <summary>Field number for the "FFLLCPHLNIO" field.</summary>
    ...
    /// <summary>Field number for the "LEFOIGFGJGJ" field.</summary>
    ...
    /// <summary>Field number for the "INFGAKANLPN" field.</summary>
    ...
    /// <summary>Enum of possible cases for the "BJHPPIKHFMF" oneof.</summary>
