...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from EJDFGNGBNOO.proto</summary>
  public static partial class EJDFGNGBNOOReflection {

    #region Descriptor
    /// <summary>File descriptor for EJDFGNGBNOO.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "OOMACDMBOGF" field.</summary>
    ...
    /// <summary>Field number for the "IDFCIBLPOKD" field.</summary>
    ...
    /// <summary>Field number for the "FCEDANNICIJ" field.</summary>
