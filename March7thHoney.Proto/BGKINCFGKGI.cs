...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from BGKINCFGKGI.proto</summary>
  public static partial class BGKINCFGKGIReflection {

    #region Descriptor
    /// <summary>File descriptor for BGKINCFGKGI.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "OEBHCDPDNHF" field.</summary>
    ...
    /// <summary>Field number for the "NMCKJLHFPBJ" field.</summary>
    ...
    /// <summary>Field number for the "HAOBJABCBMP" field.</summary>
    ...
    /// <summary>Field number for the "GAMCPLJOEDK" field.</summary>
    ...
    /// <summary>Field number for the "DFLKNLMJOFB" field.</summary>
    ...
    /// <summary>Field number for the "ADGBKKIMJOA" field.</summary>
