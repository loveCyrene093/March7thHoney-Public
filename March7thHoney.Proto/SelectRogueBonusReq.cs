...
//     source: SelectRogueBonusReq.proto
// </auto-generated>
...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from SelectRogueBonusReq.proto</summary>
  public static partial class SelectRogueBonusReqReflection {

    #region Descriptor
    /// <summary>File descriptor for SelectRogueBonusReq.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "MJPCBEAAABJ" field.</summary>
    ...
    /// <summary>Field number for the "MBBKHCJMGGL" field.</summary>
    ...
    /// <summary>Field number for the "PCNEJJBDELC" field.</summary>
    ...
    /// <summary>Field number for the "ILAKOOPEODP" field.</summary>
    ...
    /// <summary>Field number for the "LCDOOHHNCOD" field.</summary>
    ...
    /// <summary>Field number for the "JCEHPPPCIPN" field.</summary>
    ...
    /// <summary>Field number for the "DJFJKBBAGEO" field.</summary>
    ...
    /// <summary>Field number for the "CLLLFIDINIM" field.</summary>
    ...
    /// <summary>Field number for the "BEMOELCIBAI" field.</summary>
    ...
    /// <summary>Field number for the "IICKOJJADNH" field.</summary>
    ...
    /// <summary>Field number for the "PONMAHEIHMJ" field.</summary>
    ...
    /// <summary>Field number for the "MIPEGJNMEEJ" field.</summary>
    ...
    /// <summary>Field number for the "PDGCLGLOFKK" field.</summary>
    ...
    /// <summary>Field number for the "LIMEFKDHOLD" field.</summary>
    ...
    /// <summary>Field number for the "HJPIKLALKOD" field.</summary>
    ...
    /// <summary>Field number for the "JPANPNNMOOF" field.</summary>
    ...
    /// <summary>Field number for the "GCKDDBHIHDB" field.</summary>
    ...
    /// <summary>Field number for the "HCGNAHNJCHA" field.</summary>
    ...
    /// <summary>Field number for the "FLIKEAKPKJC" field.</summary>
    ...
    /// <summary>Field number for the "PFKBADDNGDL" field.</summary>
    ...
    /// <summary>Field number for the "IACIAJGBOOO" field.</summary>
    ...
    /// <summary>Field number for the "AEIMJCGCPLH" field.</summary>
    ...
    /// <summary>Field number for the "PJMCAEAFIKH" field.</summary>
    ...
    /// <summary>Field number for the "CKAACNLOIAO" field.</summary>
    ...
    /// <summary>Field number for the "PNIOGGNHMOA" field.</summary>
    ...
    /// <summary>Field number for the "KEFGOLHKCDB" field.</summary>
    ...
    /// <summary>Field number for the "JENBGMOEAHI" field.</summary>
    ...
    /// <summary>Field number for the "EBBDGALMBJI" field.</summary>
    ...
    /// <summary>Field number for the "JBPJALBOEAP" field.</summary>
    ...
    /// <summary>Field number for the "GJFPEIFHHHD" field.</summary>
    ...
    /// <summary>Field number for the "EGBDLDKHEMG" field.</summary>
    ...
    /// <summary>Field number for the "AADLFJDEMJM" field.</summary>
    ...
    /// <summary>Field number for the "JOMKONFFCKH" field.</summary>
    ...
    /// <summary>Field number for the "JCPJHLICHFJ" field.</summary>
    ...
    /// <summary>Field number for the "GJDECBLAJDM" field.</summary>
    ...
    /// <summary>Field number for the "HOFIOBKIMGP" field.</summary>
    ...
    /// <summary>Field number for the "EMPHNDEJGCL" field.</summary>
    ...
    /// <summary>Field number for the "EODFHPDLFNO" field.</summary>
    ...
    /// <summary>Field number for the "PJNDBKMFIKH" field.</summary>
    ...
    /// <summary>Field number for the "JJFGEJFFCCC" field.</summary>
    ...
    /// <summary>Field number for the "MBMDOJFBAJN" field.</summary>
