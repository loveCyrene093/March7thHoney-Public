...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from IFJEDJAFCJN.proto</summary>
  public static partial class IFJEDJAFCJNReflection {

    #region Descriptor
    /// <summary>File descriptor for IFJEDJAFCJN.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "MNIOMFOAMFH" field.</summary>
    ...
    /// <summary>Field number for the "APDHGALNKEC" field.</summary>
    ...
    /// <summary>Enum of possible cases for the "OAIJOPKPDGJ" oneof.</summary>
