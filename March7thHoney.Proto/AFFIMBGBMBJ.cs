...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from AFFIMBGBMBJ.proto</summary>
  public static partial class AFFIMBGBMBJReflection {

    #region Descriptor
    /// <summary>File descriptor for AFFIMBGBMBJ.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "ILHABFJKEGD" field.</summary>
    ...
    /// <summary>Field number for the "HBDCHIMFKDK" field.</summary>
    ...
    /// <summary>Field number for the "GFHKBMLDKDP" field.</summary>
    ...
    /// <summary>Field number for the "DAODPGDDFCA" field.</summary>
