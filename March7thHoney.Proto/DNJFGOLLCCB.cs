...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from DNJFGOLLCCB.proto</summary>
  public static partial class DNJFGOLLCCBReflection {

    #region Descriptor
    /// <summary>File descriptor for DNJFGOLLCCB.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "LGMNKILABNL" field.</summary>
    ...
    /// <summary>Field number for the "CJBODNKDFAG" field.</summary>
    ...
    /// <summary>Field number for the "AJLGJKMEFJL" field.</summary>
    ...
    /// <summary>Field number for the "GNCPFFHBIPN" field.</summary>
    ...
    /// <summary>Field number for the "COOFHIGHJDN" field.</summary>
    ...
    /// <summary>Field number for the "NMBNLPOHJCM" field.</summary>
    ...
    /// <summary>Field number for the "CDNBELIAJFN" field.</summary>
