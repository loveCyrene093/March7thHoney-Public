...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from HBMNFGPKECH.proto</summary>
  public static partial class HBMNFGPKECHReflection {

    #region Descriptor
    /// <summary>File descriptor for HBMNFGPKECH.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "CDCBFHFJGMD" field.</summary>
    ...
    /// <summary>Field number for the "JFHMCDFDABI" field.</summary>
    ...
    /// <summary>Field number for the "PHALKDHHPPB" field.</summary>
