...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from MKEINLFOAEA.proto</summary>
  public static partial class MKEINLFOAEAReflection {

    #region Descriptor
    /// <summary>File descriptor for MKEINLFOAEA.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "CMHMNEEFCLC" field.</summary>
    ...
    /// <summary>Field number for the "BHFOOBPKIAN" field.</summary>
    ...
    /// <summary>Field number for the "MLLDHEAKDJC" field.</summary>
    ...
    /// <summary>Field number for the "HJMLKDNIIFP" field.</summary>
