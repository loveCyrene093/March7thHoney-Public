...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from BBMGPIKBJJC.proto</summary>
  public static partial class BBMGPIKBJJCReflection {

    #region Descriptor
    /// <summary>File descriptor for BBMGPIKBJJC.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "HEOKGAKLFPM" field.</summary>
    ...
    /// <summary>Field number for the "EGABLBJIJCK" field.</summary>
    ...
    /// <summary>Field number for the "JBEILMFIIGM" field.</summary>
