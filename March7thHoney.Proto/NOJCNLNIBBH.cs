...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from NOJCNLNIBBH.proto</summary>
  public static partial class NOJCNLNIBBHReflection {

    #region Descriptor
    /// <summary>File descriptor for NOJCNLNIBBH.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "LBEIHILHOKM" field.</summary>
    ...
    /// <summary>Field number for the "BKILELBILBO" field.</summary>
    ...
    /// <summary>Field number for the "NONKHEMLDNO" field.</summary>
    ...
    /// <summary>Field number for the "IOJLMOCPAPG" field.</summary>
    ...
    /// <summary>Field number for the "DMBGFLADNHA" field.</summary>
