...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from GDIECABCIGN.proto</summary>
  public static partial class GDIECABCIGNReflection {

    #region Descriptor
    /// <summary>File descriptor for GDIECABCIGN.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JOBOBJLDCAJ" field.</summary>
    ...
    /// <summary>Field number for the "LGMKFBIINGK" field.</summary>
    ...
    /// <summary>Field number for the "OEMMDHMBDPA" field.</summary>
