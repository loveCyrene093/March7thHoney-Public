...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from NNHGOBLNCIE.proto</summary>
  public static partial class NNHGOBLNCIEReflection {

    #region Descriptor
    /// <summary>File descriptor for NNHGOBLNCIE.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "ELKOCIJNABK" field.</summary>
    ...
    /// <summary>Field number for the "ELNCJFFJFIH" field.</summary>
    ...
    /// <summary>Field number for the "FNAODNGJAMM" field.</summary>
