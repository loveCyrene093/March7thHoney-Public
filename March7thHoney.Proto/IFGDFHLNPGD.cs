...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from IFGDFHLNPGD.proto</summary>
  public static partial class IFGDFHLNPGDReflection {

    #region Descriptor
    /// <summary>File descriptor for IFGDFHLNPGD.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "MNAIGBCOJDK" field.</summary>
    ...
    /// <summary>Field number for the "EDDOAIJIOCC" field.</summary>
    ...
    /// <summary>Field number for the "MCKLNGPCJIJ" field.</summary>
    ...
    /// <summary>Field number for the "KKLONJPKLEP" field.</summary>
    ...
    /// <summary>Field number for the "LJJALKIJONC" field.</summary>
    ...
    /// <summary>Field number for the "DDPJEAIOILD" field.</summary>
    ...
    /// <summary>Enum of possible cases for the "JIPBEABGOAK" oneof.</summary>
