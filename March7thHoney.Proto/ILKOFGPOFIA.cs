...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from ILKOFGPOFIA.proto</summary>
  public static partial class ILKOFGPOFIAReflection {

    #region Descriptor
    /// <summary>File descriptor for ILKOFGPOFIA.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "MOBPNNMGICC" field.</summary>
    ...
    /// <summary>Field number for the "OPALKIJMGLH" field.</summary>
    ...
    /// <summary>Field number for the "DKGNCNKPGKD" field.</summary>
