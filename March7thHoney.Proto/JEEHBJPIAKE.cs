...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from JEEHBJPIAKE.proto</summary>
  public static partial class JEEHBJPIAKEReflection {

    #region Descriptor
    /// <summary>File descriptor for JEEHBJPIAKE.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "ABAFOPBHILK" field.</summary>
    ...
    /// <summary>Field number for the "GFGFEHHHDAD" field.</summary>
    ...
    /// <summary>Field number for the "AMABBMOCBKD" field.</summary>
    ...
    /// <summary>Field number for the "AGAPFHKAODL" field.</summary>
    ...
    /// <summary>Field number for the "DBPDDHMAHAB" field.</summary>
    ...
    /// <summary>Field number for the "JFHKACLKHHC" field.</summary>
    ...
    /// <summary>Field number for the "NIIEKCMBENI" field.</summary>
    ...
    /// <summary>Field number for the "IPBOBNMLNHP" field.</summary>
    ...
    /// <summary>Field number for the "DFAKOMHIBGJ" field.</summary>
    ...
    /// <summary>Field number for the "DNPIEJNNJJM" field.</summary>
    ...
    /// <summary>Field number for the "FJLDAACGJGI" field.</summary>
    ...
    /// <summary>Field number for the "GOKEOHPOMDC" field.</summary>
    ...
    /// <summary>Field number for the "MAILGEJLKEN" field.</summary>
    ...
    /// <summary>Field number for the "MLJDIDHMJMJ" field.</summary>
    ...
    /// <summary>Field number for the "DDMMMPFPOAL" field.</summary>
    ...
    /// <summary>Field number for the "KCJMNLDPMKI" field.</summary>
    ...
    /// <summary>Field number for the "DOHDEDHOOLL" field.</summary>
