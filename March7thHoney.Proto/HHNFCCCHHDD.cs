...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from HHNFCCCHHDD.proto</summary>
  public static partial class HHNFCCCHHDDReflection {

    #region Descriptor
    /// <summary>File descriptor for HHNFCCCHHDD.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "HGJDMIFJKPO" field.</summary>
    ...
    /// <summary>Field number for the "LHADAIMMHMP" field.</summary>
    ...
    /// <summary>Field number for the "BFPLPAKPBLL" field.</summary>
    ...
    /// <summary>Field number for the "PGDAPDFOIDD" field.</summary>
