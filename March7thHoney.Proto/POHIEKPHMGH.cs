...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from POHIEKPHMGH.proto</summary>
  public static partial class POHIEKPHMGHReflection {

    #region Descriptor
    /// <summary>File descriptor for POHIEKPHMGH.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "KJAJMEHIGFE" field.</summary>
    ...
    /// <summary>Field number for the "PGDPMACFCMC" field.</summary>
    ...
    /// <summary>Field number for the "HOLLBADILEF" field.</summary>
