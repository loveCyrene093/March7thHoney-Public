...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from IDBCHLBACND.proto</summary>
  public static partial class IDBCHLBACNDReflection {

    #region Descriptor
    /// <summary>File descriptor for IDBCHLBACND.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "BIPJEHIOEGN" field.</summary>
    ...
    /// <summary>Field number for the "IGIKKGLMJED" field.</summary>
    ...
    /// <summary>Field number for the "FEBHLMNHFOC" field.</summary>
    ...
    /// <summary>Field number for the "MKHDOPGGBIE" field.</summary>
    ...
    /// <summary>Field number for the "PMICICPPDOP" field.</summary>
