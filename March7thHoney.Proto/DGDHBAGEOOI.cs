...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from DGDHBAGEOOI.proto</summary>
  public static partial class DGDHBAGEOOIReflection {

    #region Descriptor
    /// <summary>File descriptor for DGDHBAGEOOI.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "AOLFFOLEJLB" field.</summary>
    ...
    /// <summary>Field number for the "DKLIONPKIIJ" field.</summary>
    ...
    /// <summary>Field number for the "FPMCFJDOMDM" field.</summary>
    ...
    /// <summary>Field number for the "LOGPKCKNJEL" field.</summary>
    ...
    /// <summary>Field number for the "JLELBCFOBKN" field.</summary>
    ...
    /// <summary>Field number for the "JANDBBGLJEO" field.</summary>
