...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from JEBLAAGCNHN.proto</summary>
  public static partial class JEBLAAGCNHNReflection {

    #region Descriptor
    /// <summary>File descriptor for JEBLAAGCNHN.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "AHHJLMPKFHN" field.</summary>
    ...
    /// <summary>Field number for the "LOLCBFCJPAM" field.</summary>
    ...
    /// <summary>Field number for the "DNEKFLCJDKH" field.</summary>
    ...
    /// <summary>Field number for the "EMKOIOIFDKG" field.</summary>
    ...
    /// <summary>Field number for the "NLMMFJOPBFC" field.</summary>
    ...
    /// <summary>Field number for the "HLCIKBIFKIK" field.</summary>
    ...
    /// <summary>Field number for the "JFGEBNBAEGJ" field.</summary>
    ...
    /// <summary>Field number for the "MNKNAEECKPM" field.</summary>
