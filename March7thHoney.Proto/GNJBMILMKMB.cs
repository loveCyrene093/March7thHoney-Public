...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from GNJBMILMKMB.proto</summary>
  public static partial class GNJBMILMKMBReflection {

    #region Descriptor
    /// <summary>File descriptor for GNJBMILMKMB.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "GJOJLEOBJFJ" field.</summary>
    ...
    /// <summary>Field number for the "HGCFFBNCBGG" field.</summary>
    ...
    /// <summary>Field number for the "BEFJLFKJFJD" field.</summary>
    ...
    /// <summary>Field number for the "HDFHPKEPKAF" field.</summary>
    ...
    /// <summary>Field number for the "PBMLDOEBDEG" field.</summary>
    ...
    /// <summary>Field number for the "PHFMJGBJFPH" field.</summary>
    ...
    /// <summary>Field number for the "EPLBCNFMLIL" field.</summary>
    ...
    /// <summary>Field number for the "EKJKLCJKLPE" field.</summary>
    ...
    /// <summary>Field number for the "LHIMAFCIFAP" field.</summary>
    ...
    /// <summary>Field number for the "GAFCPIPKIKL" field.</summary>
    ...
    /// <summary>Field number for the "LPALGNILCGM" field.</summary>
