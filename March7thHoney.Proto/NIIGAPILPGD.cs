...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from NIIGAPILPGD.proto</summary>
  public static partial class NIIGAPILPGDReflection {

    #region Descriptor
    /// <summary>File descriptor for NIIGAPILPGD.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JHHHONJIKGL" field.</summary>
    ...
    /// <summary>Field number for the "IKIKMEEJNDN" field.</summary>
    ...
    /// <summary>Field number for the "CLDNGAEIBDF" field.</summary>
