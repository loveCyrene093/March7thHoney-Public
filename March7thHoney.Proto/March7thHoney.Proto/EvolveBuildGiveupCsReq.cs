...
public sealed class EvolveBuildGiveupCsReq : IMessage<EvolveBuildGiveupCsReq>, IMessage, IEquatable<EvolveBuildGiveupCsReq>, IDeepCloneable<EvolveBuildGiveupCsReq>, IBufferMessage
{
	...
	public static MessageParser<EvolveBuildGiveupCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => EvolveBuildGiveupCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EvolveBuildGiveupCsReq(EvolveBuildGiveupCsReq other)
		: this()
	{
