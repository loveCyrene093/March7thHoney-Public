...
public sealed class FinishTutorialScRsp : IMessage<FinishTutorialScRsp>, IMessage, IEquatable<FinishTutorialScRsp>, IDeepCloneable<FinishTutorialScRsp>, IBufferMessage
{
	...
	public static MessageParser<FinishTutorialScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => FinishTutorialScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public FinishTutorialScRsp(FinishTutorialScRsp other)
		: this()
	{
