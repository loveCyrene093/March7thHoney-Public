...
public sealed class GetRogueHandbookDataCsReq : IMessage<GetRogueHandbookDataCsReq>, IMessage, IEquatable<GetRogueHandbookDataCsReq>, IDeepCloneable<GetRogueHandbookDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetRogueHandbookDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetRogueHandbookDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetRogueHandbookDataCsReq(GetRogueHandbookDataCsReq other)
		: this()
	{
	...
	{
		return Equals(other as GetRogueHandbookDataCsReq);
	}
