...
public sealed class PlayerLoginFinishCsReq : IMessage<PlayerLoginFinishCsReq>, IMessage, IEquatable<PlayerLoginFinishCsReq>, IDeepCloneable<PlayerLoginFinishCsReq>, IBufferMessage
{
	...
	public static MessageParser<PlayerLoginFinishCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => PlayerLoginFinishCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public PlayerLoginFinishCsReq(PlayerLoginFinishCsReq other)
		: this()
	{
