...
public sealed class JLBJNHJILFP : IMessage<JLBJNHJILFP>, IMessage, IEquatable<JLBJNHJILFP>, IDeepCloneable<JLBJNHJILFP>, IBufferMessage
{
	private static readonly MessageParser<JLBJNHJILFP> _parser = new MessageParser<JLBJNHJILFP>(() => new JLBJNHJILFP());
	...
	public static MessageParser<JLBJNHJILFP> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => JLBJNHJILFPReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public JLBJNHJILFP(JLBJNHJILFP other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public JLBJNHJILFP Clone()
	{
		return new JLBJNHJILFP(this);
	}
	...
	{
		return Equals(other as JLBJNHJILFP);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(JLBJNHJILFP other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(JLBJNHJILFP other)
	{
		if (other != null)
		{
