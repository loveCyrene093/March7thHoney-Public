...
public sealed class LPFDDGKBAAM : IMessage<LPFDDGKBAAM>, IMessage, IEquatable<LPFDDGKBAAM>, IDeepCloneable<LPFDDGKBAAM>, IBufferMessage
{
	private static readonly MessageParser<LPFDDGKBAAM> _parser = new MessageParser<LPFDDGKBAAM>(() => new LPFDDGKBAAM());
	...
	public static MessageParser<LPFDDGKBAAM> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => LPFDDGKBAAMReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public LPFDDGKBAAM(LPFDDGKBAAM other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public LPFDDGKBAAM Clone()
	{
		return new LPFDDGKBAAM(this);
	}
	...
	{
		return Equals(other as LPFDDGKBAAM);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(LPFDDGKBAAM other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(LPFDDGKBAAM other)
	{
		if (other != null)
		{
