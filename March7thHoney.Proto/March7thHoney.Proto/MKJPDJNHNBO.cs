...
public sealed class MKJPDJNHNBO : IMessage<MKJPDJNHNBO>, IMessage, IEquatable<MKJPDJNHNBO>, IDeepCloneable<MKJPDJNHNBO>, IBufferMessage
{
	private static readonly MessageParser<MKJPDJNHNBO> _parser = new MessageParser<MKJPDJNHNBO>(() => new MKJPDJNHNBO());
	...
	public static MessageParser<MKJPDJNHNBO> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MKJPDJNHNBOReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MKJPDJNHNBO(MKJPDJNHNBO other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MKJPDJNHNBO Clone()
	{
		return new MKJPDJNHNBO(this);
	}
	...
	{
		return Equals(other as MKJPDJNHNBO);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(MKJPDJNHNBO other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(MKJPDJNHNBO other)
	{
		if (other != null)
		{
