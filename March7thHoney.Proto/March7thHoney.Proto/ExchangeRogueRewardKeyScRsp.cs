...
public sealed class ExchangeRogueRewardKeyScRsp : IMessage<ExchangeRogueRewardKeyScRsp>, IMessage, IEquatable<ExchangeRogueRewardKeyScRsp>, IDeepCloneable<ExchangeRogueRewardKeyScRsp>, IBufferMessage
{
	...
	public static MessageParser<ExchangeRogueRewardKeyScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ExchangeRogueRewardKeyScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ExchangeRogueRewardKeyScRsp(ExchangeRogueRewardKeyScRsp other)
		: this()
	{
		count_ = other.count_;
