...
public sealed class AcceptMainMissionScRsp : IMessage<AcceptMainMissionScRsp>, IMessage, IEquatable<AcceptMainMissionScRsp>, IDeepCloneable<AcceptMainMissionScRsp>, IBufferMessage
{
	...
	public static MessageParser<AcceptMainMissionScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => AcceptMainMissionScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public AcceptMainMissionScRsp(AcceptMainMissionScRsp other)
		: this()
	{
