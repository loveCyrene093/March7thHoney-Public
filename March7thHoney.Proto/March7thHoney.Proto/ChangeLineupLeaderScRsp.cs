...
public sealed class ChangeLineupLeaderScRsp : IMessage<ChangeLineupLeaderScRsp>, IMessage, IEquatable<ChangeLineupLeaderScRsp>, IDeepCloneable<ChangeLineupLeaderScRsp>, IBufferMessage
{
	...
	public static MessageParser<ChangeLineupLeaderScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ChangeLineupLeaderScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ChangeLineupLeaderScRsp(ChangeLineupLeaderScRsp other)
		: this()
	{
		slot_ = other.slot_;
