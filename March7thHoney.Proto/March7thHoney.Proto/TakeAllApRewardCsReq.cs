...
public sealed class TakeAllApRewardCsReq : IMessage<TakeAllApRewardCsReq>, IMessage, IEquatable<TakeAllApRewardCsReq>, IDeepCloneable<TakeAllApRewardCsReq>, IBufferMessage
{
	...
	public static MessageParser<TakeAllApRewardCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => TakeAllApRewardCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public TakeAllApRewardCsReq(TakeAllApRewardCsReq other)
		: this()
	{
