...
public sealed class AiPamResponseFeedbackCommentCsReq : IMessage<AiPamResponseFeedbackCommentCsReq>, IMessage, IEquatable<AiPamResponseFeedbackCommentCsReq>, IDeepCloneable<AiPamResponseFeedbackCommentCsReq>, IBufferMessage
{
	private static readonly MessageParser<AiPamResponseFeedbackCommentCsReq> _parser = new MessageParser<AiPamResponseFeedbackCommentCsReq>(() => new AiPamResponseFeedbackCommentCsReq());
	...
	public static MessageParser<AiPamResponseFeedbackCommentCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => AiPamResponseFeedbackCommentCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public AiPamResponseFeedbackCommentCsReq(AiPamResponseFeedbackCommentCsReq other)
		: this()
	{
