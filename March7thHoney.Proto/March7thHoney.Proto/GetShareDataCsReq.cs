...
public sealed class GetShareDataCsReq : IMessage<GetShareDataCsReq>, IMessage, IEquatable<GetShareDataCsReq>, IDeepCloneable<GetShareDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetShareDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetShareDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetShareDataCsReq(GetShareDataCsReq other)
		: this()
	{
