...
public sealed class FCJCCECMHIH : IMessage<FCJCCECMHIH>, IMessage, IEquatable<FCJCCECMHIH>, IDeepCloneable<FCJCCECMHIH>, IBufferMessage
{
	private static readonly MessageParser<FCJCCECMHIH> _parser = new MessageParser<FCJCCECMHIH>(() => new FCJCCECMHIH());
	...
	public const int KPGMBKKOGJGFieldNumber = 5;

	private uint kPGMBKKOGJG_;

	public const int AEHKNGBKPBEFieldNumber = 6;

	private uint aEHKNGBKPBE_;

	public const int HKIOMCOCDNFFieldNumber = 8;
	...
	public static MessageParser<FCJCCECMHIH> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => FCJCCECMHIHReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public FCJCCECMHIH(FCJCCECMHIH other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public FCJCCECMHIH Clone()
	{
		return new FCJCCECMHIH(this);
	}
	...
	{
		return Equals(other as FCJCCECMHIH);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(FCJCCECMHIH other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(FCJCCECMHIH other)
	{
		if (other != null)
		{
