...
public sealed class SwordTrainingRestoreGameCsReq : IMessage<SwordTrainingRestoreGameCsReq>, IMessage, IEquatable<SwordTrainingRestoreGameCsReq>, IDeepCloneable<SwordTrainingRestoreGameCsReq>, IBufferMessage
{
	...
	public static MessageParser<SwordTrainingRestoreGameCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => SwordTrainingRestoreGameCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public SwordTrainingRestoreGameCsReq(SwordTrainingRestoreGameCsReq other)
		: this()
	{
