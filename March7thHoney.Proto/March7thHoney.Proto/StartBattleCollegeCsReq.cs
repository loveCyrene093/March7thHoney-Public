...
public sealed class StartBattleCollegeCsReq : IMessage<StartBattleCollegeCsReq>, IMessage, IEquatable<StartBattleCollegeCsReq>, IDeepCloneable<StartBattleCollegeCsReq>, IBufferMessage
{
	...
	public static MessageParser<StartBattleCollegeCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => StartBattleCollegeCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public StartBattleCollegeCsReq(StartBattleCollegeCsReq other)
		: this()
	{
		id_ = other.id_;
