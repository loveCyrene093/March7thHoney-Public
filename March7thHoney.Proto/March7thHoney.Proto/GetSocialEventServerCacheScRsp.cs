...
public sealed class GetSocialEventServerCacheScRsp : IMessage<GetSocialEventServerCacheScRsp>, IMessage, IEquatable<GetSocialEventServerCacheScRsp>, IDeepCloneable<GetSocialEventServerCacheScRsp>, IBufferMessage
{
	...
	public static MessageParser<GetSocialEventServerCacheScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetSocialEventServerCacheScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetSocialEventServerCacheScRsp(GetSocialEventServerCacheScRsp other)
		: this()
	{
