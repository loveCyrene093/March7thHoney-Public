...
public sealed class EvolveBuildStartStageCsReq : IMessage<EvolveBuildStartStageCsReq>, IMessage, IEquatable<EvolveBuildStartStageCsReq>, IDeepCloneable<EvolveBuildStartStageCsReq>, IBufferMessage
{
	...
	public static MessageParser<EvolveBuildStartStageCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => EvolveBuildStartStageCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EvolveBuildStartStageCsReq(EvolveBuildStartStageCsReq other)
		: this()
	{
