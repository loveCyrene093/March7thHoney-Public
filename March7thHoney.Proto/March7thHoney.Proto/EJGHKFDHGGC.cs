...
public sealed class EJGHKFDHGGC : IMessage<EJGHKFDHGGC>, IMessage, IEquatable<EJGHKFDHGGC>, IDeepCloneable<EJGHKFDHGGC>, IBufferMessage
{
	private static readonly MessageParser<EJGHKFDHGGC> _parser = new MessageParser<EJGHKFDHGGC>(() => new EJGHKFDHGGC());
	...
	public static MessageParser<EJGHKFDHGGC> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => EJGHKFDHGGCReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EJGHKFDHGGC(EJGHKFDHGGC other)
		: this()
	{
