...
public sealed class DifficultyAdjustmentUpdateDataScRsp : IMessage<DifficultyAdjustmentUpdateDataScRsp>, IMessage, IEquatable<DifficultyAdjustmentUpdateDataScRsp>, IDeepCloneable<DifficultyAdjustmentUpdateDataScRsp>, IBufferMessage
{
	...
	private static readonly FieldCodec<LMHOIMLGNGM> _repeated_contentPackageList_codec = FieldCodec.ForMessage(98u, LMHOIMLGNGM.Parser);

	private readonly RepeatedField<LMHOIMLGNGM> contentPackageList_ = new RepeatedField<LMHOIMLGNGM>();

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<DifficultyAdjustmentUpdateDataScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => DifficultyAdjustmentUpdateDataScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RepeatedField<LMHOIMLGNGM> ContentPackageList => contentPackageList_;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public DifficultyAdjustmentUpdateDataScRsp(DifficultyAdjustmentUpdateDataScRsp other)
		: this()
	{
