...
public sealed class RogueArcadeGetInfoCsReq : IMessage<RogueArcadeGetInfoCsReq>, IMessage, IEquatable<RogueArcadeGetInfoCsReq>, IDeepCloneable<RogueArcadeGetInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<RogueArcadeGetInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueArcadeGetInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueArcadeGetInfoCsReq(RogueArcadeGetInfoCsReq other)
		: this()
	{
