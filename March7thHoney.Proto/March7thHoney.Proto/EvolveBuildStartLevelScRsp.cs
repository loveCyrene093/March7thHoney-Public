...
public sealed class EvolveBuildStartLevelScRsp : IMessage<EvolveBuildStartLevelScRsp>, IMessage, IEquatable<EvolveBuildStartLevelScRsp>, IDeepCloneable<EvolveBuildStartLevelScRsp>, IBufferMessage
{
	...
	public static MessageParser<EvolveBuildStartLevelScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => EvolveBuildStartLevelScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EvolveBuildStartLevelScRsp(EvolveBuildStartLevelScRsp other)
		: this()
	{
