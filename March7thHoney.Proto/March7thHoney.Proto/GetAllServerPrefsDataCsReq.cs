...
public sealed class GetAllServerPrefsDataCsReq : IMessage<GetAllServerPrefsDataCsReq>, IMessage, IEquatable<GetAllServerPrefsDataCsReq>, IDeepCloneable<GetAllServerPrefsDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetAllServerPrefsDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetAllServerPrefsDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetAllServerPrefsDataCsReq(GetAllServerPrefsDataCsReq other)
		: this()
	{
