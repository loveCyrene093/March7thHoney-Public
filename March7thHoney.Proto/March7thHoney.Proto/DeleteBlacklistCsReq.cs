...
public sealed class DeleteBlacklistCsReq : IMessage<DeleteBlacklistCsReq>, IMessage, IEquatable<DeleteBlacklistCsReq>, IDeepCloneable<DeleteBlacklistCsReq>, IBufferMessage
{
	...
	public static MessageParser<DeleteBlacklistCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => DeleteBlacklistCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public DeleteBlacklistCsReq(DeleteBlacklistCsReq other)
		: this()
	{
		uid_ = other.uid_;
	...
	{
		return Equals(other as DeleteBlacklistCsReq);
	}
