...
public sealed class ExchangeStaminaCsReq : IMessage<ExchangeStaminaCsReq>, IMessage, IEquatable<ExchangeStaminaCsReq>, IDeepCloneable<ExchangeStaminaCsReq>, IBufferMessage
{
	...
	public static MessageParser<ExchangeStaminaCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ExchangeStaminaCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ExchangeStaminaCsReq(ExchangeStaminaCsReq other)
		: this()
	{
