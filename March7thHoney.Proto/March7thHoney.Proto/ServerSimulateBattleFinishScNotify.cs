...
public sealed class ServerSimulateBattleFinishScNotify : IMessage<ServerSimulateBattleFinishScNotify>, IMessage, IEquatable<ServerSimulateBattleFinishScNotify>, IDeepCloneable<ServerSimulateBattleFinishScNotify>, IBufferMessage
{
	...
	public static MessageParser<ServerSimulateBattleFinishScNotify> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ServerSimulateBattleFinishScNotifyReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ServerSimulateBattleFinishScNotify(ServerSimulateBattleFinishScNotify other)
		: this()
	{
	...
	{
		return Equals(other as ServerSimulateBattleFinishScNotify);
	}
