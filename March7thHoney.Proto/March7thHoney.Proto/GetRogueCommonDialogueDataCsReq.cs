...
public sealed class GetRogueCommonDialogueDataCsReq : IMessage<GetRogueCommonDialogueDataCsReq>, IMessage, IEquatable<GetRogueCommonDialogueDataCsReq>, IDeepCloneable<GetRogueCommonDialogueDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetRogueCommonDialogueDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetRogueCommonDialogueDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetRogueCommonDialogueDataCsReq(GetRogueCommonDialogueDataCsReq other)
		: this()
	{
	...
	{
		return Equals(other as GetRogueCommonDialogueDataCsReq);
	}
