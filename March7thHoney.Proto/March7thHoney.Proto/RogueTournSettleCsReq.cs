...
public sealed class RogueTournSettleCsReq : IMessage<RogueTournSettleCsReq>, IMessage, IEquatable<RogueTournSettleCsReq>, IDeepCloneable<RogueTournSettleCsReq>, IBufferMessage
{
	...
	public static MessageParser<RogueTournSettleCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueTournSettleCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueTournSettleCsReq(RogueTournSettleCsReq other)
		: this()
	{
	...
	{
		return Equals(other as RogueTournSettleCsReq);
	}
