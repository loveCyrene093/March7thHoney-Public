...
public sealed class JLFJKIDDKBG : IMessage<JLFJKIDDKBG>, IMessage, IEquatable<JLFJKIDDKBG>, IDeepCloneable<JLFJKIDDKBG>, IBufferMessage
{
	private static readonly MessageParser<JLFJKIDDKBG> _parser = new MessageParser<JLFJKIDDKBG>(() => new JLFJKIDDKBG());
	...
	public static MessageParser<JLFJKIDDKBG> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => JLFJKIDDKBGReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public JLFJKIDDKBG(JLFJKIDDKBG other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public JLFJKIDDKBG Clone()
	{
		return new JLFJKIDDKBG(this);
	}
	...
	{
		return Equals(other as JLFJKIDDKBG);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(JLFJKIDDKBG other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(JLFJKIDDKBG other)
	{
		if (other != null)
		{
