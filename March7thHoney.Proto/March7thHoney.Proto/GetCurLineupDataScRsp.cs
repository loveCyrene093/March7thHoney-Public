...
public sealed class GetCurLineupDataScRsp : IMessage<GetCurLineupDataScRsp>, IMessage, IEquatable<GetCurLineupDataScRsp>, IDeepCloneable<GetCurLineupDataScRsp>, IBufferMessage
{
	...
	public static MessageParser<GetCurLineupDataScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetCurLineupDataScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetCurLineupDataScRsp(GetCurLineupDataScRsp other)
		: this()
	{
