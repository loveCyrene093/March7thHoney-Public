...
public sealed class SyncAddBlacklistScNotify : IMessage<SyncAddBlacklistScNotify>, IMessage, IEquatable<SyncAddBlacklistScNotify>, IDeepCloneable<SyncAddBlacklistScNotify>, IBufferMessage
{
	...
	public static MessageParser<SyncAddBlacklistScNotify> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => SyncAddBlacklistScNotifyReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public SyncAddBlacklistScNotify(SyncAddBlacklistScNotify other)
		: this()
	{
		uid_ = other.uid_;
