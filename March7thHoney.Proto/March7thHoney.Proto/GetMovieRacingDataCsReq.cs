...
public sealed class GetMovieRacingDataCsReq : IMessage<GetMovieRacingDataCsReq>, IMessage, IEquatable<GetMovieRacingDataCsReq>, IDeepCloneable<GetMovieRacingDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetMovieRacingDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetMovieRacingDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetMovieRacingDataCsReq(GetMovieRacingDataCsReq other)
		: this()
	{
