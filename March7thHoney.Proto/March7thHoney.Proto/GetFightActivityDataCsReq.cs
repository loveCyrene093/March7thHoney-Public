...
public sealed class GetFightActivityDataCsReq : IMessage<GetFightActivityDataCsReq>, IMessage, IEquatable<GetFightActivityDataCsReq>, IDeepCloneable<GetFightActivityDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetFightActivityDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetFightActivityDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetFightActivityDataCsReq(GetFightActivityDataCsReq other)
		: this()
	{
