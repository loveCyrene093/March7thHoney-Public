...
public sealed class MonopolyRollRandomCsReq : IMessage<MonopolyRollRandomCsReq>, IMessage, IEquatable<MonopolyRollRandomCsReq>, IDeepCloneable<MonopolyRollRandomCsReq>, IBufferMessage
{
	...
	public static MessageParser<MonopolyRollRandomCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MonopolyRollRandomCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MonopolyRollRandomCsReq(MonopolyRollRandomCsReq other)
		: this()
	{
