...
public sealed class GetRndOptionCsReq : IMessage<GetRndOptionCsReq>, IMessage, IEquatable<GetRndOptionCsReq>, IDeepCloneable<GetRndOptionCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetRndOptionCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetRndOptionCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetRndOptionCsReq(GetRndOptionCsReq other)
		: this()
	{
		id_ = other.id_;
