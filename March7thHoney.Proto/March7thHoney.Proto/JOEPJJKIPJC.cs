...
public sealed class JOEPJJKIPJC : IMessage<JOEPJJKIPJC>, IMessage, IEquatable<JOEPJJKIPJC>, IDeepCloneable<JOEPJJKIPJC>, IBufferMessage
{
	private static readonly MessageParser<JOEPJJKIPJC> _parser = new MessageParser<JOEPJJKIPJC>(() => new JOEPJJKIPJC());
	...
	public static MessageParser<JOEPJJKIPJC> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => JOEPJJKIPJCReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public JOEPJJKIPJC(JOEPJJKIPJC other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public JOEPJJKIPJC Clone()
	{
		return new JOEPJJKIPJC(this);
	}
	...
	{
		return Equals(other as JOEPJJKIPJC);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(JOEPJJKIPJC other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(JOEPJJKIPJC other)
	{
		if (other != null)
		{
			if (other.Retcode != 0)
