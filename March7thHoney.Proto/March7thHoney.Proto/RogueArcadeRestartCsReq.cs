...
public sealed class RogueArcadeRestartCsReq : IMessage<RogueArcadeRestartCsReq>, IMessage, IEquatable<RogueArcadeRestartCsReq>, IDeepCloneable<RogueArcadeRestartCsReq>, IBufferMessage
{
	...
	public static MessageParser<RogueArcadeRestartCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueArcadeRestartCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueArcadeRestartCsReq(RogueArcadeRestartCsReq other)
		: this()
	{
