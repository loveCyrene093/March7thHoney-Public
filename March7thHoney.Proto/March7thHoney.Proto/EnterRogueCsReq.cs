...
public sealed class EnterRogueCsReq : IMessage<EnterRogueCsReq>, IMessage, IEquatable<EnterRogueCsReq>, IDeepCloneable<EnterRogueCsReq>, IBufferMessage
{
	...
	public static MessageParser<EnterRogueCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => EnterRogueCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EnterRogueCsReq(EnterRogueCsReq other)
		: this()
	{
