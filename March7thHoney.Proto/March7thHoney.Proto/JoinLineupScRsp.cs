...
public sealed class JoinLineupScRsp : IMessage<JoinLineupScRsp>, IMessage, IEquatable<JoinLineupScRsp>, IDeepCloneable<JoinLineupScRsp>, IBufferMessage
{
	...
	public static MessageParser<JoinLineupScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => JoinLineupScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public JoinLineupScRsp(JoinLineupScRsp other)
		: this()
	{
