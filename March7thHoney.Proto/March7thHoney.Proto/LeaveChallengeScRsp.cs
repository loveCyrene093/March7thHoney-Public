...
public sealed class LeaveChallengeScRsp : IMessage<LeaveChallengeScRsp>, IMessage, IEquatable<LeaveChallengeScRsp>, IDeepCloneable<LeaveChallengeScRsp>, IBufferMessage
{
	...
	public static MessageParser<LeaveChallengeScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => LeaveChallengeScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public LeaveChallengeScRsp(LeaveChallengeScRsp other)
		: this()
	{
