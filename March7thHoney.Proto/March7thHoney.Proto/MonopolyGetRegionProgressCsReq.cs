...
public sealed class MonopolyGetRegionProgressCsReq : IMessage<MonopolyGetRegionProgressCsReq>, IMessage, IEquatable<MonopolyGetRegionProgressCsReq>, IDeepCloneable<MonopolyGetRegionProgressCsReq>, IBufferMessage
{
	...
	public static MessageParser<MonopolyGetRegionProgressCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MonopolyGetRegionProgressCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MonopolyGetRegionProgressCsReq(MonopolyGetRegionProgressCsReq other)
		: this()
	{
