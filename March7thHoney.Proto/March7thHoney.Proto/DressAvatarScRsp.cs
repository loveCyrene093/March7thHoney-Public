...
public sealed class DressAvatarScRsp : IMessage<DressAvatarScRsp>, IMessage, IEquatable<DressAvatarScRsp>, IDeepCloneable<DressAvatarScRsp>, IBufferMessage
{
	...
	public static MessageParser<DressAvatarScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => DressAvatarScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public DressAvatarScRsp(DressAvatarScRsp other)
		: this()
	{
