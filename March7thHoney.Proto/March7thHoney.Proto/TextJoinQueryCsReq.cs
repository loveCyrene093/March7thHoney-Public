...
public sealed class TextJoinQueryCsReq : IMessage<TextJoinQueryCsReq>, IMessage, IEquatable<TextJoinQueryCsReq>, IDeepCloneable<TextJoinQueryCsReq>, IBufferMessage
{
	...
	public const int TextJoinIdListFieldNumber = 13;

	private static readonly FieldCodec<uint> _repeated_textJoinIdList_codec = FieldCodec.ForUInt32(106u);

	private readonly RepeatedField<uint> textJoinIdList_ = new RepeatedField<uint>();

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<TextJoinQueryCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => TextJoinQueryCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RepeatedField<uint> TextJoinIdList => textJoinIdList_;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public TextJoinQueryCsReq(TextJoinQueryCsReq other)
		: this()
	{
	...
	public bool Equals(TextJoinQueryCsReq other)
	{
		...
		if (!textJoinIdList_.Equals(other.textJoinIdList_))
		{
			return false;
		}
	...
	{
		int num = 1;
		num ^= textJoinIdList_.GetHashCode();
	...
	{
		int num = 0;
		num += textJoinIdList_.CalculateSize(_repeated_textJoinIdList_codec);
		if (_unknownFields != null)
		{
