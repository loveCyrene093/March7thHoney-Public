...
public sealed class GetMonopolyMbtiReportRewardScRsp : IMessage<GetMonopolyMbtiReportRewardScRsp>, IMessage, IEquatable<GetMonopolyMbtiReportRewardScRsp>, IDeepCloneable<GetMonopolyMbtiReportRewardScRsp>, IBufferMessage
{
	...
	public static MessageParser<GetMonopolyMbtiReportRewardScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetMonopolyMbtiReportRewardScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetMonopolyMbtiReportRewardScRsp(GetMonopolyMbtiReportRewardScRsp other)
		: this()
	{
