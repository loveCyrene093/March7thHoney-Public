...
public sealed class GetJukeboxDataCsReq : IMessage<GetJukeboxDataCsReq>, IMessage, IEquatable<GetJukeboxDataCsReq>, IDeepCloneable<GetJukeboxDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetJukeboxDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetJukeboxDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetJukeboxDataCsReq(GetJukeboxDataCsReq other)
		: this()
	{
