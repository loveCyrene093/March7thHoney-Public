...
public sealed class LKCEBEDHNBJ : IMessage<LKCEBEDHNBJ>, IMessage, IEquatable<LKCEBEDHNBJ>, IDeepCloneable<LKCEBEDHNBJ>, IBufferMessage
{
	private static readonly MessageParser<LKCEBEDHNBJ> _parser = new MessageParser<LKCEBEDHNBJ>(() => new LKCEBEDHNBJ());

	private UnknownFieldSet _unknownFields;

	public const int FAPFKFJIELEFieldNumber = 8;
	...
	public static MessageParser<LKCEBEDHNBJ> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => LKCEBEDHNBJReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public LKCEBEDHNBJ(LKCEBEDHNBJ other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public LKCEBEDHNBJ Clone()
	{
		return new LKCEBEDHNBJ(this);
	}
	...
	{
		return Equals(other as LKCEBEDHNBJ);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(LKCEBEDHNBJ other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(LKCEBEDHNBJ other)
	{
		if (other != null)
		{
