...
public sealed class GetKilledPunkLordMonsterDataCsReq : IMessage<GetKilledPunkLordMonsterDataCsReq>, IMessage, IEquatable<GetKilledPunkLordMonsterDataCsReq>, IDeepCloneable<GetKilledPunkLordMonsterDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetKilledPunkLordMonsterDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetKilledPunkLordMonsterDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetKilledPunkLordMonsterDataCsReq(GetKilledPunkLordMonsterDataCsReq other)
		: this()
	{
