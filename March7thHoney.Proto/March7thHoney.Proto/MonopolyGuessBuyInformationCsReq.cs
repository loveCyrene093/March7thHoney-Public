...
public sealed class MonopolyGuessBuyInformationCsReq : IMessage<MonopolyGuessBuyInformationCsReq>, IMessage, IEquatable<MonopolyGuessBuyInformationCsReq>, IDeepCloneable<MonopolyGuessBuyInformationCsReq>, IBufferMessage
{
	...
	public static MessageParser<MonopolyGuessBuyInformationCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MonopolyGuessBuyInformationCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MonopolyGuessBuyInformationCsReq(MonopolyGuessBuyInformationCsReq other)
		: this()
	{
	...
	{
		return Equals(other as MonopolyGuessBuyInformationCsReq);
	}
