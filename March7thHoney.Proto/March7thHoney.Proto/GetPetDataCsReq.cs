...
public sealed class GetPetDataCsReq : IMessage<GetPetDataCsReq>, IMessage, IEquatable<GetPetDataCsReq>, IDeepCloneable<GetPetDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetPetDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetPetDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetPetDataCsReq(GetPetDataCsReq other)
		: this()
	{
