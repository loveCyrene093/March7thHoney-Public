...
public sealed class GetMonopolyDailyReportCsReq : IMessage<GetMonopolyDailyReportCsReq>, IMessage, IEquatable<GetMonopolyDailyReportCsReq>, IDeepCloneable<GetMonopolyDailyReportCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetMonopolyDailyReportCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetMonopolyDailyReportCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetMonopolyDailyReportCsReq(GetMonopolyDailyReportCsReq other)
		: this()
	{
