...
public sealed class RogueArcadeLeaveCsReq : IMessage<RogueArcadeLeaveCsReq>, IMessage, IEquatable<RogueArcadeLeaveCsReq>, IDeepCloneable<RogueArcadeLeaveCsReq>, IBufferMessage
{
	...
	public static MessageParser<RogueArcadeLeaveCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueArcadeLeaveCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueArcadeLeaveCsReq(RogueArcadeLeaveCsReq other)
		: this()
	{
