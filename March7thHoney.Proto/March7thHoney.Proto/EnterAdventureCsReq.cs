...
public sealed class EnterAdventureCsReq : IMessage<EnterAdventureCsReq>, IMessage, IEquatable<EnterAdventureCsReq>, IDeepCloneable<EnterAdventureCsReq>, IBufferMessage
{
	...
	public static MessageParser<EnterAdventureCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => EnterAdventureCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EnterAdventureCsReq(EnterAdventureCsReq other)
		: this()
	{
		mapId_ = other.mapId_;
