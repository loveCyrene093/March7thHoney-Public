...
public sealed class MuseumRandomEventQueryCsReq : IMessage<MuseumRandomEventQueryCsReq>, IMessage, IEquatable<MuseumRandomEventQueryCsReq>, IDeepCloneable<MuseumRandomEventQueryCsReq>, IBufferMessage
{
	...
	public const int ACBNHJKFFMPFieldNumber = 5;

	private int aCBNHJKFFMP_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<MuseumRandomEventQueryCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MuseumRandomEventQueryCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MuseumRandomEventQueryCsReq(MuseumRandomEventQueryCsReq other)
		: this()
	{
	...
	public int CalculateSize()
	{
		...
		if (ACBNHJKFFMP != 0)
		{
			num += 1 + CodedOutputStream.ComputeInt32Size(ACBNHJKFFMP);
		}
		if (_unknownFields != null)
		{
