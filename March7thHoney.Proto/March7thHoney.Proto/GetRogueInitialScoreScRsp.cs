...
public sealed class GetRogueInitialScoreScRsp : IMessage<GetRogueInitialScoreScRsp>, IMessage, IEquatable<GetRogueInitialScoreScRsp>, IDeepCloneable<GetRogueInitialScoreScRsp>, IBufferMessage
{
	...
	public const int AHBFAAMNKNOFieldNumber = 10;

	private BGKINCFGKGI aHBFAAMNKNO_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<GetRogueInitialScoreScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetRogueInitialScoreScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetRogueInitialScoreScRsp(GetRogueInitialScoreScRsp other)
		: this()
	{
