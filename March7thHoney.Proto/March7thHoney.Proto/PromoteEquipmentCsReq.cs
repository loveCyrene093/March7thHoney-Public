...
public sealed class PromoteEquipmentCsReq : IMessage<PromoteEquipmentCsReq>, IMessage, IEquatable<PromoteEquipmentCsReq>, IDeepCloneable<PromoteEquipmentCsReq>, IBufferMessage
{
	...
	public static MessageParser<PromoteEquipmentCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => PromoteEquipmentCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public PromoteEquipmentCsReq(PromoteEquipmentCsReq other)
		: this()
	{
