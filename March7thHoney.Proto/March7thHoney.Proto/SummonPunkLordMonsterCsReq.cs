...
public sealed class SummonPunkLordMonsterCsReq : IMessage<SummonPunkLordMonsterCsReq>, IMessage, IEquatable<SummonPunkLordMonsterCsReq>, IDeepCloneable<SummonPunkLordMonsterCsReq>, IBufferMessage
{
	...
	public static MessageParser<SummonPunkLordMonsterCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => SummonPunkLordMonsterCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public SummonPunkLordMonsterCsReq(SummonPunkLordMonsterCsReq other)
		: this()
	{
