...
public sealed class ChessRogueNousEnableRogueTalentCsReq : IMessage<ChessRogueNousEnableRogueTalentCsReq>, IMessage, IEquatable<ChessRogueNousEnableRogueTalentCsReq>, IDeepCloneable<ChessRogueNousEnableRogueTalentCsReq>, IBufferMessage
{
	...
	public const int KFJEMIOJLPJFieldNumber = 6;

	private uint kFJEMIOJLPJ_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<ChessRogueNousEnableRogueTalentCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ChessRogueNousEnableRogueTalentCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ChessRogueNousEnableRogueTalentCsReq(ChessRogueNousEnableRogueTalentCsReq other)
		: this()
	{
