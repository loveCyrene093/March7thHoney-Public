...
public sealed class SelectInclinationTextScRsp : IMessage<SelectInclinationTextScRsp>, IMessage, IEquatable<SelectInclinationTextScRsp>, IDeepCloneable<SelectInclinationTextScRsp>, IBufferMessage
{
	...
	public static MessageParser<SelectInclinationTextScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => SelectInclinationTextScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public SelectInclinationTextScRsp(SelectInclinationTextScRsp other)
		: this()
	{
