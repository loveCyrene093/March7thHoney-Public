...
public sealed class ContentPackageTransferScNotify : IMessage<ContentPackageTransferScNotify>, IMessage, IEquatable<ContentPackageTransferScNotify>, IDeepCloneable<ContentPackageTransferScNotify>, IBufferMessage
{
	...
	public static MessageParser<ContentPackageTransferScNotify> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ContentPackageTransferScNotifyReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ContentPackageTransferScNotify(ContentPackageTransferScNotify other)
		: this()
	{
