...
public sealed class GetFriendBattleRecordDetailCsReq : IMessage<GetFriendBattleRecordDetailCsReq>, IMessage, IEquatable<GetFriendBattleRecordDetailCsReq>, IDeepCloneable<GetFriendBattleRecordDetailCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetFriendBattleRecordDetailCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetFriendBattleRecordDetailCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetFriendBattleRecordDetailCsReq(GetFriendBattleRecordDetailCsReq other)
		: this()
	{
		uid_ = other.uid_;
