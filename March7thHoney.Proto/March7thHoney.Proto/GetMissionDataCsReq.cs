...
public sealed class GetMissionDataCsReq : IMessage<GetMissionDataCsReq>, IMessage, IEquatable<GetMissionDataCsReq>, IDeepCloneable<GetMissionDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetMissionDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetMissionDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetMissionDataCsReq(GetMissionDataCsReq other)
		: this()
	{
