...
public sealed class GridFightConsumableUpdateInfo : IMessage<GridFightConsumableUpdateInfo>, IMessage, IEquatable<GridFightConsumableUpdateInfo>, IDeepCloneable<GridFightConsumableUpdateInfo>, IBufferMessage
{
	private static readonly MessageParser<GridFightConsumableUpdateInfo> _parser = new MessageParser<GridFightConsumableUpdateInfo>(() => new GridFightConsumableUpdateInfo());
	...
	public static MessageParser<GridFightConsumableUpdateInfo> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GridFightConsumableUpdateInfoReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GridFightConsumableUpdateInfo(GridFightConsumableUpdateInfo other)
		: this()
	{
	...
	public int CalculateSize()
	{
		...
		if (ItemStackCount != 0)
		{
			num += 1 + CodedOutputStream.ComputeInt32Size(ItemStackCount);
		}
		if (Num != 0)
		{
