...
public sealed class SetRelicBoxTargetCsReq : IMessage<SetRelicBoxTargetCsReq>, IMessage, IEquatable<SetRelicBoxTargetCsReq>, IDeepCloneable<SetRelicBoxTargetCsReq>, IBufferMessage
{
	private static readonly MessageParser<SetRelicBoxTargetCsReq> _parser = new MessageParser<SetRelicBoxTargetCsReq>(() => new SetRelicBoxTargetCsReq());
	...
	public static MessageParser<SetRelicBoxTargetCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => SetRelicBoxTargetCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public SetRelicBoxTargetCsReq(SetRelicBoxTargetCsReq other)
		: this()
	{
