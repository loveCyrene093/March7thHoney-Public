...
public sealed class GetVideoVersionKeyCsReq : IMessage<GetVideoVersionKeyCsReq>, IMessage, IEquatable<GetVideoVersionKeyCsReq>, IDeepCloneable<GetVideoVersionKeyCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetVideoVersionKeyCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetVideoVersionKeyCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetVideoVersionKeyCsReq(GetVideoVersionKeyCsReq other)
		: this()
	{
