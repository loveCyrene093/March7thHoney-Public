...
public sealed class GetPhoneDataCsReq : IMessage<GetPhoneDataCsReq>, IMessage, IEquatable<GetPhoneDataCsReq>, IDeepCloneable<GetPhoneDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetPhoneDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetPhoneDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetPhoneDataCsReq(GetPhoneDataCsReq other)
		: this()
	{
