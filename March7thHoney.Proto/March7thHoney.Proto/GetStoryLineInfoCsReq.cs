...
public sealed class GetStoryLineInfoCsReq : IMessage<GetStoryLineInfoCsReq>, IMessage, IEquatable<GetStoryLineInfoCsReq>, IDeepCloneable<GetStoryLineInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetStoryLineInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetStoryLineInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetStoryLineInfoCsReq(GetStoryLineInfoCsReq other)
		: this()
	{
