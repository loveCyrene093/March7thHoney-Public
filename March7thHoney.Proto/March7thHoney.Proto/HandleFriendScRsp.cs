...
public sealed class HandleFriendScRsp : IMessage<HandleFriendScRsp>, IMessage, IEquatable<HandleFriendScRsp>, IDeepCloneable<HandleFriendScRsp>, IBufferMessage
{
	...
	public static MessageParser<HandleFriendScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => HandleFriendScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public HandleFriendScRsp(HandleFriendScRsp other)
		: this()
	{
