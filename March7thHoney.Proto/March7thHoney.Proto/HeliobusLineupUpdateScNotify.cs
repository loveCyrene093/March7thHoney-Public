...
public sealed class HeliobusLineupUpdateScNotify : IMessage<HeliobusLineupUpdateScNotify>, IMessage, IEquatable<HeliobusLineupUpdateScNotify>, IDeepCloneable<HeliobusLineupUpdateScNotify>, IBufferMessage
{
	...
	public static MessageParser<HeliobusLineupUpdateScNotify> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => HeliobusLineupUpdateScNotifyReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public HeliobusLineupUpdateScNotify(HeliobusLineupUpdateScNotify other)
		: this()
	{
	...
	public void MergeFrom(HeliobusLineupUpdateScNotify other)
	{
		...
		if (other.lineup_ != null)
		{
			if (lineup_ == null)
			{
				Lineup = new HeliobusChallengeLineup();
			}
