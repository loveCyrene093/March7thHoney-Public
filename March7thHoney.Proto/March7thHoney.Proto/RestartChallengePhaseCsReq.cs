...
public sealed class RestartChallengePhaseCsReq : IMessage<RestartChallengePhaseCsReq>, IMessage, IEquatable<RestartChallengePhaseCsReq>, IDeepCloneable<RestartChallengePhaseCsReq>, IBufferMessage
{
	...
	public static MessageParser<RestartChallengePhaseCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RestartChallengePhaseCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RestartChallengePhaseCsReq(RestartChallengePhaseCsReq other)
		: this()
	{
