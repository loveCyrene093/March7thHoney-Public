...
public sealed class GetNpcTakenRewardCsReq : IMessage<GetNpcTakenRewardCsReq>, IMessage, IEquatable<GetNpcTakenRewardCsReq>, IDeepCloneable<GetNpcTakenRewardCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetNpcTakenRewardCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetNpcTakenRewardCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetNpcTakenRewardCsReq(GetNpcTakenRewardCsReq other)
		: this()
	{
		npcId_ = other.npcId_;
