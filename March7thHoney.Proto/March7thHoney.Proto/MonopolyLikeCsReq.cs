...
public sealed class MonopolyLikeCsReq : IMessage<MonopolyLikeCsReq>, IMessage, IEquatable<MonopolyLikeCsReq>, IDeepCloneable<MonopolyLikeCsReq>, IBufferMessage
{
	...
	public static MessageParser<MonopolyLikeCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MonopolyLikeCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MonopolyLikeCsReq(MonopolyLikeCsReq other)
		: this()
	{
