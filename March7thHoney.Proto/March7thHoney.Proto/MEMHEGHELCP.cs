...
public sealed class MEMHEGHELCP : IMessage<MEMHEGHELCP>, IMessage, IEquatable<MEMHEGHELCP>, IDeepCloneable<MEMHEGHELCP>, IBufferMessage
{
	private static readonly MessageParser<MEMHEGHELCP> _parser = new MessageParser<MEMHEGHELCP>(() => new MEMHEGHELCP());
	...
	public static MessageParser<MEMHEGHELCP> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MEMHEGHELCPReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MEMHEGHELCP(MEMHEGHELCP other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MEMHEGHELCP Clone()
	{
		return new MEMHEGHELCP(this);
	}
	...
	{
		return Equals(other as MEMHEGHELCP);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(MEMHEGHELCP other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(MEMHEGHELCP other)
	{
		if (other != null)
		{
