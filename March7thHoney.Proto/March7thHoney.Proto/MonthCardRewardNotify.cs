...
public sealed class MonthCardRewardNotify : IMessage<MonthCardRewardNotify>, IMessage, IEquatable<MonthCardRewardNotify>, IDeepCloneable<MonthCardRewardNotify>, IBufferMessage
{
	...
	public static MessageParser<MonthCardRewardNotify> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MonthCardRewardNotifyReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MonthCardRewardNotify(MonthCardRewardNotify other)
		: this()
	{
