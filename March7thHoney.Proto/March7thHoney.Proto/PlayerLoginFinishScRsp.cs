...
public sealed class PlayerLoginFinishScRsp : IMessage<PlayerLoginFinishScRsp>, IMessage, IEquatable<PlayerLoginFinishScRsp>, IDeepCloneable<PlayerLoginFinishScRsp>, IBufferMessage
{
	...
	public static MessageParser<PlayerLoginFinishScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => PlayerLoginFinishScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public PlayerLoginFinishScRsp(PlayerLoginFinishScRsp other)
		: this()
	{
