...
public sealed class SceneEnterStageScRsp : IMessage<SceneEnterStageScRsp>, IMessage, IEquatable<SceneEnterStageScRsp>, IDeepCloneable<SceneEnterStageScRsp>, IBufferMessage
{
	...
	public static MessageParser<SceneEnterStageScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => SceneEnterStageScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public SceneEnterStageScRsp(SceneEnterStageScRsp other)
		: this()
	{
