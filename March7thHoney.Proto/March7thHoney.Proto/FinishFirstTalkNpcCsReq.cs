...
public sealed class FinishFirstTalkNpcCsReq : IMessage<FinishFirstTalkNpcCsReq>, IMessage, IEquatable<FinishFirstTalkNpcCsReq>, IDeepCloneable<FinishFirstTalkNpcCsReq>, IBufferMessage
{
	...
	public static MessageParser<FinishFirstTalkNpcCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => FinishFirstTalkNpcCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public FinishFirstTalkNpcCsReq(FinishFirstTalkNpcCsReq other)
		: this()
	{
		npcId_ = other.npcId_;
