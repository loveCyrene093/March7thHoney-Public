...
public sealed class ReserveStaminaExchangeScRsp : IMessage<ReserveStaminaExchangeScRsp>, IMessage, IEquatable<ReserveStaminaExchangeScRsp>, IDeepCloneable<ReserveStaminaExchangeScRsp>, IBufferMessage
{
	...
	public static MessageParser<ReserveStaminaExchangeScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ReserveStaminaExchangeScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ReserveStaminaExchangeScRsp(ReserveStaminaExchangeScRsp other)
		: this()
	{
		num_ = other.num_;
