...
public sealed class RogueDoGambleCsReq : IMessage<RogueDoGambleCsReq>, IMessage, IEquatable<RogueDoGambleCsReq>, IDeepCloneable<RogueDoGambleCsReq>, IBufferMessage
{
	...
	public static MessageParser<RogueDoGambleCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueDoGambleCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueDoGambleCsReq(RogueDoGambleCsReq other)
		: this()
	{
