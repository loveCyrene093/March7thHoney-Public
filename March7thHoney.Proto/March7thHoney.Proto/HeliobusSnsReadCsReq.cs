...
public sealed class HeliobusSnsReadCsReq : IMessage<HeliobusSnsReadCsReq>, IMessage, IEquatable<HeliobusSnsReadCsReq>, IDeepCloneable<HeliobusSnsReadCsReq>, IBufferMessage
{
	...
	public const int CDKEDFPEFIJFieldNumber = 3;

	private uint cDKEDFPEFIJ_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<HeliobusSnsReadCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => HeliobusSnsReadCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public HeliobusSnsReadCsReq(HeliobusSnsReadCsReq other)
		: this()
	{
