...
public sealed class BuyBpLevelScRsp : IMessage<BuyBpLevelScRsp>, IMessage, IEquatable<BuyBpLevelScRsp>, IDeepCloneable<BuyBpLevelScRsp>, IBufferMessage
{
	...
	public static MessageParser<BuyBpLevelScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => BuyBpLevelScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public BuyBpLevelScRsp(BuyBpLevelScRsp other)
		: this()
	{
