...
public sealed class TakeAssistRewardScRsp : IMessage<TakeAssistRewardScRsp>, IMessage, IEquatable<TakeAssistRewardScRsp>, IDeepCloneable<TakeAssistRewardScRsp>, IBufferMessage
{
	...
	public const int CADPJMANPCAFieldNumber = 9;

	private static readonly FieldCodec<MBICBKAFGIK> _repeated_cADPJMANPCA_codec = FieldCodec.ForMessage(74u, MBICBKAFGIK.Parser);
	...
	public static MessageParser<TakeAssistRewardScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => TakeAssistRewardScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public TakeAssistRewardScRsp(TakeAssistRewardScRsp other)
		: this()
	{
