...
public sealed class ChessRogueSkipTeachingLevelCsReq : IMessage<ChessRogueSkipTeachingLevelCsReq>, IMessage, IEquatable<ChessRogueSkipTeachingLevelCsReq>, IDeepCloneable<ChessRogueSkipTeachingLevelCsReq>, IBufferMessage
{
	...
	public static MessageParser<ChessRogueSkipTeachingLevelCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ChessRogueSkipTeachingLevelCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ChessRogueSkipTeachingLevelCsReq(ChessRogueSkipTeachingLevelCsReq other)
		: this()
	{
	...
	{
		return Equals(other as ChessRogueSkipTeachingLevelCsReq);
	}
