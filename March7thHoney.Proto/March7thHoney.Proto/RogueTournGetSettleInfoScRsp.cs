...
public sealed class RogueTournGetSettleInfoScRsp : IMessage<RogueTournGetSettleInfoScRsp>, IMessage, IEquatable<RogueTournGetSettleInfoScRsp>, IDeepCloneable<RogueTournGetSettleInfoScRsp>, IBufferMessage
{
	...
	public const int EDKJMPACHNJFieldNumber = 6;

	private ALGJOMFCLKL eDKJMPACHNJ_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<RogueTournGetSettleInfoScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueTournGetSettleInfoScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueTournGetSettleInfoScRsp(RogueTournGetSettleInfoScRsp other)
		: this()
	{
