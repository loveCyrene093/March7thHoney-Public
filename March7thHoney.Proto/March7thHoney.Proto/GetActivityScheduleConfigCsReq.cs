...
public sealed class GetActivityScheduleConfigCsReq : IMessage<GetActivityScheduleConfigCsReq>, IMessage, IEquatable<GetActivityScheduleConfigCsReq>, IDeepCloneable<GetActivityScheduleConfigCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetActivityScheduleConfigCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetActivityScheduleConfigCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetActivityScheduleConfigCsReq(GetActivityScheduleConfigCsReq other)
		: this()
	{
