...
public sealed class EvolveBuildQueryInfoCsReq : IMessage<EvolveBuildQueryInfoCsReq>, IMessage, IEquatable<EvolveBuildQueryInfoCsReq>, IDeepCloneable<EvolveBuildQueryInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<EvolveBuildQueryInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => EvolveBuildQueryInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EvolveBuildQueryInfoCsReq(EvolveBuildQueryInfoCsReq other)
		: this()
	{
	...
	{
		return Equals(other as EvolveBuildQueryInfoCsReq);
	}
