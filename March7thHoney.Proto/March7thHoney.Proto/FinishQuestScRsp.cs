...
public sealed class FinishQuestScRsp : IMessage<FinishQuestScRsp>, IMessage, IEquatable<FinishQuestScRsp>, IDeepCloneable<FinishQuestScRsp>, IBufferMessage
{
	...
	public static MessageParser<FinishQuestScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => FinishQuestScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public FinishQuestScRsp(FinishQuestScRsp other)
		: this()
	{
