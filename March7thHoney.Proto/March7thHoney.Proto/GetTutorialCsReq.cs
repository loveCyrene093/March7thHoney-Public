...
public sealed class GetTutorialCsReq : IMessage<GetTutorialCsReq>, IMessage, IEquatable<GetTutorialCsReq>, IDeepCloneable<GetTutorialCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetTutorialCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetTutorialCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetTutorialCsReq(GetTutorialCsReq other)
		: this()
	{
