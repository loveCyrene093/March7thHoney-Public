...
public sealed class ApplyFriendScRsp : IMessage<ApplyFriendScRsp>, IMessage, IEquatable<ApplyFriendScRsp>, IDeepCloneable<ApplyFriendScRsp>, IBufferMessage
{
	...
	public static MessageParser<ApplyFriendScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ApplyFriendScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ApplyFriendScRsp(ApplyFriendScRsp other)
		: this()
	{
		uid_ = other.uid_;
