...
public sealed class RogueArcadeGetInfoScRsp : IMessage<RogueArcadeGetInfoScRsp>, IMessage, IEquatable<RogueArcadeGetInfoScRsp>, IDeepCloneable<RogueArcadeGetInfoScRsp>, IBufferMessage
{
	...
	public static MessageParser<RogueArcadeGetInfoScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueArcadeGetInfoScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueArcadeGetInfoScRsp(RogueArcadeGetInfoScRsp other)
		: this()
	{
