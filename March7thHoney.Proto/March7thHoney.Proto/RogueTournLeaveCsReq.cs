...
public sealed class RogueTournLeaveCsReq : IMessage<RogueTournLeaveCsReq>, IMessage, IEquatable<RogueTournLeaveCsReq>, IDeepCloneable<RogueTournLeaveCsReq>, IBufferMessage
{
	...
	public static MessageParser<RogueTournLeaveCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueTournLeaveCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueTournLeaveCsReq(RogueTournLeaveCsReq other)
		: this()
	{
	...
	{
		return Equals(other as RogueTournLeaveCsReq);
	}
