...
public sealed class GetBasicInfoCsReq : IMessage<GetBasicInfoCsReq>, IMessage, IEquatable<GetBasicInfoCsReq>, IDeepCloneable<GetBasicInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetBasicInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetBasicInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetBasicInfoCsReq(GetBasicInfoCsReq other)
		: this()
	{
