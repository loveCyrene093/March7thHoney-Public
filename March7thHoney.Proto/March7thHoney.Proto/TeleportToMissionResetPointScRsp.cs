...
public sealed class TeleportToMissionResetPointScRsp : IMessage<TeleportToMissionResetPointScRsp>, IMessage, IEquatable<TeleportToMissionResetPointScRsp>, IDeepCloneable<TeleportToMissionResetPointScRsp>, IBufferMessage
{
	...
	public static MessageParser<TeleportToMissionResetPointScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => TeleportToMissionResetPointScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public TeleportToMissionResetPointScRsp(TeleportToMissionResetPointScRsp other)
		: this()
	{
