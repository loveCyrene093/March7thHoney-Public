...
public sealed class DailyFirstEnterMonopolyActivityCsReq : IMessage<DailyFirstEnterMonopolyActivityCsReq>, IMessage, IEquatable<DailyFirstEnterMonopolyActivityCsReq>, IDeepCloneable<DailyFirstEnterMonopolyActivityCsReq>, IBufferMessage
{
	...
	public static MessageParser<DailyFirstEnterMonopolyActivityCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => DailyFirstEnterMonopolyActivityCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public DailyFirstEnterMonopolyActivityCsReq(DailyFirstEnterMonopolyActivityCsReq other)
		: this()
	{
	...
	{
		return Equals(other as DailyFirstEnterMonopolyActivityCsReq);
	}
