...
public sealed class GetSocialEventServerCacheCsReq : IMessage<GetSocialEventServerCacheCsReq>, IMessage, IEquatable<GetSocialEventServerCacheCsReq>, IDeepCloneable<GetSocialEventServerCacheCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetSocialEventServerCacheCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetSocialEventServerCacheCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetSocialEventServerCacheCsReq(GetSocialEventServerCacheCsReq other)
		: this()
	{
	...
	{
		return Equals(other as GetSocialEventServerCacheCsReq);
	}
