...
public sealed class RogueTournLeaveScRsp : IMessage<RogueTournLeaveScRsp>, IMessage, IEquatable<RogueTournLeaveScRsp>, IDeepCloneable<RogueTournLeaveScRsp>, IBufferMessage
{
	...
	public static MessageParser<RogueTournLeaveScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueTournLeaveScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueTournLeaveScRsp(RogueTournLeaveScRsp other)
		: this()
	{
