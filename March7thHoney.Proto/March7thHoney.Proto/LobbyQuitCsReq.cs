...
public sealed class LobbyQuitCsReq : IMessage<LobbyQuitCsReq>, IMessage, IEquatable<LobbyQuitCsReq>, IDeepCloneable<LobbyQuitCsReq>, IBufferMessage
{
	...
	public static MessageParser<LobbyQuitCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => LobbyQuitCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public LobbyQuitCsReq(LobbyQuitCsReq other)
		: this()
	{
