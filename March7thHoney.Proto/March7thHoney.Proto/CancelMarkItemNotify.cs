...
public sealed class CancelMarkItemNotify : IMessage<CancelMarkItemNotify>, IMessage, IEquatable<CancelMarkItemNotify>, IDeepCloneable<CancelMarkItemNotify>, IBufferMessage
{
	...
	public static MessageParser<CancelMarkItemNotify> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => CancelMarkItemNotifyReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public CancelMarkItemNotify(CancelMarkItemNotify other)
		: this()
	{
