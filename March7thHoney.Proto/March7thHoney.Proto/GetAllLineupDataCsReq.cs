...
public sealed class GetAllLineupDataCsReq : IMessage<GetAllLineupDataCsReq>, IMessage, IEquatable<GetAllLineupDataCsReq>, IDeepCloneable<GetAllLineupDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetAllLineupDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetAllLineupDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetAllLineupDataCsReq(GetAllLineupDataCsReq other)
		: this()
	{
