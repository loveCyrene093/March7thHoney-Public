...
public sealed class StartTrackPhotoStageCsReq : IMessage<StartTrackPhotoStageCsReq>, IMessage, IEquatable<StartTrackPhotoStageCsReq>, IDeepCloneable<StartTrackPhotoStageCsReq>, IBufferMessage
{
	...
	public const int LCHAHECJPOIFieldNumber = 12;

	private bool lCHAHECJPOI_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<StartTrackPhotoStageCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => StartTrackPhotoStageCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public StartTrackPhotoStageCsReq(StartTrackPhotoStageCsReq other)
		: this()
	{
