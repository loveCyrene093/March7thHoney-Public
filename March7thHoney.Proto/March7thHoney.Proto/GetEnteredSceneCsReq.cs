...
public sealed class GetEnteredSceneCsReq : IMessage<GetEnteredSceneCsReq>, IMessage, IEquatable<GetEnteredSceneCsReq>, IDeepCloneable<GetEnteredSceneCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetEnteredSceneCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetEnteredSceneCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetEnteredSceneCsReq(GetEnteredSceneCsReq other)
		: this()
	{
