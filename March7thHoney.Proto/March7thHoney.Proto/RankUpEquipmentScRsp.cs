...
public sealed class RankUpEquipmentScRsp : IMessage<RankUpEquipmentScRsp>, IMessage, IEquatable<RankUpEquipmentScRsp>, IDeepCloneable<RankUpEquipmentScRsp>, IBufferMessage
{
	...
	public static MessageParser<RankUpEquipmentScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RankUpEquipmentScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RankUpEquipmentScRsp(RankUpEquipmentScRsp other)
		: this()
	{
