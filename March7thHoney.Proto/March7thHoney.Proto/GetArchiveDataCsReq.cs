...
public sealed class GetArchiveDataCsReq : IMessage<GetArchiveDataCsReq>, IMessage, IEquatable<GetArchiveDataCsReq>, IDeepCloneable<GetArchiveDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetArchiveDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetArchiveDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetArchiveDataCsReq(GetArchiveDataCsReq other)
		: this()
	{
