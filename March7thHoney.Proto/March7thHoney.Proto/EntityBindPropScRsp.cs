...
public sealed class EntityBindPropScRsp : IMessage<EntityBindPropScRsp>, IMessage, IEquatable<EntityBindPropScRsp>, IDeepCloneable<EntityBindPropScRsp>, IBufferMessage
{
	...
	public static MessageParser<EntityBindPropScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => EntityBindPropScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EntityBindPropScRsp(EntityBindPropScRsp other)
		: this()
	{
