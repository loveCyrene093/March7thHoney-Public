...
public sealed class GetMbtiReportCsReq : IMessage<GetMbtiReportCsReq>, IMessage, IEquatable<GetMbtiReportCsReq>, IDeepCloneable<GetMbtiReportCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetMbtiReportCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetMbtiReportCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetMbtiReportCsReq(GetMbtiReportCsReq other)
		: this()
	{
	...
	{
		return Equals(other as GetMbtiReportCsReq);
	}
