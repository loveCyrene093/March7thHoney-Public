...
public sealed class GetNpcStatusCsReq : IMessage<GetNpcStatusCsReq>, IMessage, IEquatable<GetNpcStatusCsReq>, IDeepCloneable<GetNpcStatusCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetNpcStatusCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetNpcStatusCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetNpcStatusCsReq(GetNpcStatusCsReq other)
		: this()
	{
