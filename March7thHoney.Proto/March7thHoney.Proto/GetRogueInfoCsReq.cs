...
public sealed class GetRogueInfoCsReq : IMessage<GetRogueInfoCsReq>, IMessage, IEquatable<GetRogueInfoCsReq>, IDeepCloneable<GetRogueInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetRogueInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetRogueInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetRogueInfoCsReq(GetRogueInfoCsReq other)
		: this()
	{
