...
public sealed class RogueTournEnterCsReq : IMessage<RogueTournEnterCsReq>, IMessage, IEquatable<RogueTournEnterCsReq>, IDeepCloneable<RogueTournEnterCsReq>, IBufferMessage
{
	...
	public static MessageParser<RogueTournEnterCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueTournEnterCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueTournEnterCsReq(RogueTournEnterCsReq other)
		: this()
	{
