...
public sealed class MonopolyClickMbtiReportCsReq : IMessage<MonopolyClickMbtiReportCsReq>, IMessage, IEquatable<MonopolyClickMbtiReportCsReq>, IDeepCloneable<MonopolyClickMbtiReportCsReq>, IBufferMessage
{
	...
	public static MessageParser<MonopolyClickMbtiReportCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MonopolyClickMbtiReportCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MonopolyClickMbtiReportCsReq(MonopolyClickMbtiReportCsReq other)
		: this()
	{
	...
	{
		return Equals(other as MonopolyClickMbtiReportCsReq);
	}
