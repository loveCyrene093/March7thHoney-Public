...
public sealed class GetLoginActivityCsReq : IMessage<GetLoginActivityCsReq>, IMessage, IEquatable<GetLoginActivityCsReq>, IDeepCloneable<GetLoginActivityCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetLoginActivityCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetLoginActivityCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetLoginActivityCsReq(GetLoginActivityCsReq other)
		: this()
	{
