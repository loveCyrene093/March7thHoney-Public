...
public sealed class ExchangeRogueRewardKeyCsReq : IMessage<ExchangeRogueRewardKeyCsReq>, IMessage, IEquatable<ExchangeRogueRewardKeyCsReq>, IDeepCloneable<ExchangeRogueRewardKeyCsReq>, IBufferMessage
{
	...
	public static MessageParser<ExchangeRogueRewardKeyCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ExchangeRogueRewardKeyCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ExchangeRogueRewardKeyCsReq(ExchangeRogueRewardKeyCsReq other)
		: this()
	{
		count_ = other.count_;
