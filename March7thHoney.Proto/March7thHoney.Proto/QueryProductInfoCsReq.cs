...
public sealed class QueryProductInfoCsReq : IMessage<QueryProductInfoCsReq>, IMessage, IEquatable<QueryProductInfoCsReq>, IDeepCloneable<QueryProductInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<QueryProductInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => QueryProductInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QueryProductInfoCsReq(QueryProductInfoCsReq other)
		: this()
	{
