...
public sealed class GetRogueScoreRewardInfoCsReq : IMessage<GetRogueScoreRewardInfoCsReq>, IMessage, IEquatable<GetRogueScoreRewardInfoCsReq>, IDeepCloneable<GetRogueScoreRewardInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetRogueScoreRewardInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetRogueScoreRewardInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetRogueScoreRewardInfoCsReq(GetRogueScoreRewardInfoCsReq other)
		: this()
	{
	...
	{
		return Equals(other as GetRogueScoreRewardInfoCsReq);
	}
