...
public sealed class GetAllSaveRaidCsReq : IMessage<GetAllSaveRaidCsReq>, IMessage, IEquatable<GetAllSaveRaidCsReq>, IDeepCloneable<GetAllSaveRaidCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetAllSaveRaidCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetAllSaveRaidCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetAllSaveRaidCsReq(GetAllSaveRaidCsReq other)
		: this()
	{
