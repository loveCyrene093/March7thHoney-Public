...
public sealed class RogueMagicLeaveCsReq : IMessage<RogueMagicLeaveCsReq>, IMessage, IEquatable<RogueMagicLeaveCsReq>, IDeepCloneable<RogueMagicLeaveCsReq>, IBufferMessage
{
	...
	public static MessageParser<RogueMagicLeaveCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueMagicLeaveCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueMagicLeaveCsReq(RogueMagicLeaveCsReq other)
		: this()
	{
