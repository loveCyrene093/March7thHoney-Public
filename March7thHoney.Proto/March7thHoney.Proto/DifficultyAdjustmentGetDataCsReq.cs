...
public sealed class DifficultyAdjustmentGetDataCsReq : IMessage<DifficultyAdjustmentGetDataCsReq>, IMessage, IEquatable<DifficultyAdjustmentGetDataCsReq>, IDeepCloneable<DifficultyAdjustmentGetDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<DifficultyAdjustmentGetDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => DifficultyAdjustmentGetDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public DifficultyAdjustmentGetDataCsReq(DifficultyAdjustmentGetDataCsReq other)
		: this()
	{
