...
public sealed class GetQuestDataCsReq : IMessage<GetQuestDataCsReq>, IMessage, IEquatable<GetQuestDataCsReq>, IDeepCloneable<GetQuestDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetQuestDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetQuestDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetQuestDataCsReq(GetQuestDataCsReq other)
		: this()
	{
