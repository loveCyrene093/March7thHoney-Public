...
public sealed class ChallengeStoryStatistics : IMessage<ChallengeStoryStatistics>, IMessage, IEquatable<ChallengeStoryStatistics>, IDeepCloneable<ChallengeStoryStatistics>, IBufferMessage
{
	...
	public const int NCEGEKNLJCEFieldNumber = 5;

	private PLJJECPCMJD nCEGEKNLJCE_;
	...
	public static MessageParser<ChallengeStoryStatistics> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ChallengeStoryStatisticsReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public PLJJECPCMJD NCEGEKNLJCE
	{
		get
		{
			return nCEGEKNLJCE_;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ChallengeStoryStatistics(ChallengeStoryStatistics other)
		: this()
	{
