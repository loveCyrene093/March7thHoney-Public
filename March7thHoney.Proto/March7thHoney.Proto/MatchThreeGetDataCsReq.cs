...
public sealed class MatchThreeGetDataCsReq : IMessage<MatchThreeGetDataCsReq>, IMessage, IEquatable<MatchThreeGetDataCsReq>, IDeepCloneable<MatchThreeGetDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<MatchThreeGetDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MatchThreeGetDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MatchThreeGetDataCsReq(MatchThreeGetDataCsReq other)
		: this()
	{
	...
	{
		return Equals(other as MatchThreeGetDataCsReq);
	}
