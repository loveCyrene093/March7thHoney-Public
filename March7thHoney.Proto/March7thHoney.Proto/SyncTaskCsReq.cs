...
public sealed class SyncTaskCsReq : IMessage<SyncTaskCsReq>, IMessage, IEquatable<SyncTaskCsReq>, IDeepCloneable<SyncTaskCsReq>, IBufferMessage
{
	...
	public static MessageParser<SyncTaskCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => SyncTaskCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public SyncTaskCsReq(SyncTaskCsReq other)
		: this()
	{
		key_ = other.key_;
	...
	{
		return Equals(other as SyncTaskCsReq);
	}
