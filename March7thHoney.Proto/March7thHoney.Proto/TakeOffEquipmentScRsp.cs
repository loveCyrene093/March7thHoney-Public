...
public sealed class TakeOffEquipmentScRsp : IMessage<TakeOffEquipmentScRsp>, IMessage, IEquatable<TakeOffEquipmentScRsp>, IDeepCloneable<TakeOffEquipmentScRsp>, IBufferMessage
{
	...
	public static MessageParser<TakeOffEquipmentScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => TakeOffEquipmentScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public TakeOffEquipmentScRsp(TakeOffEquipmentScRsp other)
		: this()
	{
