...
public sealed class BattleLogReportCsReq : IMessage<BattleLogReportCsReq>, IMessage, IEquatable<BattleLogReportCsReq>, IDeepCloneable<BattleLogReportCsReq>, IBufferMessage
{
	...
	public static MessageParser<BattleLogReportCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => BattleLogReportCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public BattleLogReportCsReq(BattleLogReportCsReq other)
		: this()
	{
	...
	{
		return Equals(other as BattleLogReportCsReq);
	}
