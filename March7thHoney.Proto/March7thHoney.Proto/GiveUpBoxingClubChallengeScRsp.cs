...
public sealed class GiveUpBoxingClubChallengeScRsp : IMessage<GiveUpBoxingClubChallengeScRsp>, IMessage, IEquatable<GiveUpBoxingClubChallengeScRsp>, IDeepCloneable<GiveUpBoxingClubChallengeScRsp>, IBufferMessage
{
	...
	public static MessageParser<GiveUpBoxingClubChallengeScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GiveUpBoxingClubChallengeScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GiveUpBoxingClubChallengeScRsp(GiveUpBoxingClubChallengeScRsp other)
		: this()
	{
