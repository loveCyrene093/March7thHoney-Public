...
public sealed class RogueMagicEnableTalentScRsp : IMessage<RogueMagicEnableTalentScRsp>, IMessage, IEquatable<RogueMagicEnableTalentScRsp>, IDeepCloneable<RogueMagicEnableTalentScRsp>, IBufferMessage
{
	...
	public const int CLLGHDCNPOIFieldNumber = 12;

	private KJAGLIIDBGP cLLGHDCNPOI_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<RogueMagicEnableTalentScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueMagicEnableTalentScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueMagicEnableTalentScRsp(RogueMagicEnableTalentScRsp other)
		: this()
	{
