...
public sealed class LogisticsDetonateStarSkiffCsReq : IMessage<LogisticsDetonateStarSkiffCsReq>, IMessage, IEquatable<LogisticsDetonateStarSkiffCsReq>, IDeepCloneable<LogisticsDetonateStarSkiffCsReq>, IBufferMessage
{
	...
	public static MessageParser<LogisticsDetonateStarSkiffCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => LogisticsDetonateStarSkiffCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public LogisticsDetonateStarSkiffCsReq(LogisticsDetonateStarSkiffCsReq other)
		: this()
	{
