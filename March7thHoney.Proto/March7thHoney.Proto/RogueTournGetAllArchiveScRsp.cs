...
public sealed class RogueTournGetAllArchiveScRsp : IMessage<RogueTournGetAllArchiveScRsp>, IMessage, IEquatable<RogueTournGetAllArchiveScRsp>, IDeepCloneable<RogueTournGetAllArchiveScRsp>, IBufferMessage
{
	...
	public const int KGKIDDOPHEOFieldNumber = 2;

	private static readonly FieldCodec<OJKAHCEKDGN> _repeated_kGKIDDOPHEO_codec = FieldCodec.ForMessage(18u, OJKAHCEKDGN.Parser);

	private readonly RepeatedField<OJKAHCEKDGN> kGKIDDOPHEO_ = new RepeatedField<OJKAHCEKDGN>();
	...
	public static MessageParser<RogueTournGetAllArchiveScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueTournGetAllArchiveScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RepeatedField<OJKAHCEKDGN> KGKIDDOPHEO => kGKIDDOPHEO_;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueTournGetAllArchiveScRsp(RogueTournGetAllArchiveScRsp other)
		: this()
	{
