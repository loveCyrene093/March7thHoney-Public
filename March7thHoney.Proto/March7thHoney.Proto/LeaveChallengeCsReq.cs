...
public sealed class LeaveChallengeCsReq : IMessage<LeaveChallengeCsReq>, IMessage, IEquatable<LeaveChallengeCsReq>, IDeepCloneable<LeaveChallengeCsReq>, IBufferMessage
{
	...
	public static MessageParser<LeaveChallengeCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => LeaveChallengeCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public LeaveChallengeCsReq(LeaveChallengeCsReq other)
		: this()
	{
