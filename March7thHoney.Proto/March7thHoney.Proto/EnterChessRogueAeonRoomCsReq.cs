...
public sealed class EnterChessRogueAeonRoomCsReq : IMessage<EnterChessRogueAeonRoomCsReq>, IMessage, IEquatable<EnterChessRogueAeonRoomCsReq>, IDeepCloneable<EnterChessRogueAeonRoomCsReq>, IBufferMessage
{
	...
	public static MessageParser<EnterChessRogueAeonRoomCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => EnterChessRogueAeonRoomCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EnterChessRogueAeonRoomCsReq(EnterChessRogueAeonRoomCsReq other)
		: this()
	{
	...
	{
		return Equals(other as EnterChessRogueAeonRoomCsReq);
	}
