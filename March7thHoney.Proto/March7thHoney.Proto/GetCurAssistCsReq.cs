...
public sealed class GetCurAssistCsReq : IMessage<GetCurAssistCsReq>, IMessage, IEquatable<GetCurAssistCsReq>, IDeepCloneable<GetCurAssistCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetCurAssistCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetCurAssistCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetCurAssistCsReq(GetCurAssistCsReq other)
		: this()
	{
	...
	{
		return Equals(other as GetCurAssistCsReq);
	}
