...
public sealed class MonopolyGetRafflePoolInfoCsReq : IMessage<MonopolyGetRafflePoolInfoCsReq>, IMessage, IEquatable<MonopolyGetRafflePoolInfoCsReq>, IDeepCloneable<MonopolyGetRafflePoolInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<MonopolyGetRafflePoolInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MonopolyGetRafflePoolInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MonopolyGetRafflePoolInfoCsReq(MonopolyGetRafflePoolInfoCsReq other)
		: this()
	{
	...
	{
		return Equals(other as MonopolyGetRafflePoolInfoCsReq);
	}
