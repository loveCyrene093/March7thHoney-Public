...
public sealed class GetFriendDevelopmentInfoCsReq : IMessage<GetFriendDevelopmentInfoCsReq>, IMessage, IEquatable<GetFriendDevelopmentInfoCsReq>, IDeepCloneable<GetFriendDevelopmentInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetFriendDevelopmentInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetFriendDevelopmentInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetFriendDevelopmentInfoCsReq(GetFriendDevelopmentInfoCsReq other)
		: this()
	{
		uid_ = other.uid_;
