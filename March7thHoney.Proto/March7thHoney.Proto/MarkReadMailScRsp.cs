...
public sealed class MarkReadMailScRsp : IMessage<MarkReadMailScRsp>, IMessage, IEquatable<MarkReadMailScRsp>, IDeepCloneable<MarkReadMailScRsp>, IBufferMessage
{
	...
	public static MessageParser<MarkReadMailScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MarkReadMailScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MarkReadMailScRsp(MarkReadMailScRsp other)
		: this()
	{
		id_ = other.id_;
