...
public sealed class ChessRogueQueryCsReq : IMessage<ChessRogueQueryCsReq>, IMessage, IEquatable<ChessRogueQueryCsReq>, IDeepCloneable<ChessRogueQueryCsReq>, IBufferMessage
{
	...
	public static MessageParser<ChessRogueQueryCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ChessRogueQueryCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ChessRogueQueryCsReq(ChessRogueQueryCsReq other)
		: this()
	{
	...
	{
		return Equals(other as ChessRogueQueryCsReq);
	}
