...
public sealed class CancelMatchCsReq : IMessage<CancelMatchCsReq>, IMessage, IEquatable<CancelMatchCsReq>, IDeepCloneable<CancelMatchCsReq>, IBufferMessage
{
	...
	public static MessageParser<CancelMatchCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => CancelMatchCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public CancelMatchCsReq(CancelMatchCsReq other)
		: this()
	{
