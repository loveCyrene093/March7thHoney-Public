...
public sealed class ExchangeHcoinScRsp : IMessage<ExchangeHcoinScRsp>, IMessage, IEquatable<ExchangeHcoinScRsp>, IDeepCloneable<ExchangeHcoinScRsp>, IBufferMessage
{
	...
	public static MessageParser<ExchangeHcoinScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ExchangeHcoinScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ExchangeHcoinScRsp(ExchangeHcoinScRsp other)
		: this()
	{
		num_ = other.num_;
