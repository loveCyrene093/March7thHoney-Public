...
public sealed class GOEOJEFKKMK : IMessage<GOEOJEFKKMK>, IMessage, IEquatable<GOEOJEFKKMK>, IDeepCloneable<GOEOJEFKKMK>, IBufferMessage
{
	private static readonly MessageParser<GOEOJEFKKMK> _parser = new MessageParser<GOEOJEFKKMK>(() => new GOEOJEFKKMK());
	...
	public static MessageParser<GOEOJEFKKMK> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GOEOJEFKKMKReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GOEOJEFKKMK(GOEOJEFKKMK other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GOEOJEFKKMK Clone()
	{
		return new GOEOJEFKKMK(this);
	}
	...
	{
		return Equals(other as GOEOJEFKKMK);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(GOEOJEFKKMK other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(GOEOJEFKKMK other)
	{
		if (other != null)
		{
