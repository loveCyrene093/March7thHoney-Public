...
public sealed class ChessRogueConfirmRollCsReq : IMessage<ChessRogueConfirmRollCsReq>, IMessage, IEquatable<ChessRogueConfirmRollCsReq>, IDeepCloneable<ChessRogueConfirmRollCsReq>, IBufferMessage
{
	...
	public const int BGPBIMDCBBLFieldNumber = 2;

	private uint bGPBIMDCBBL_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<ChessRogueConfirmRollCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ChessRogueConfirmRollCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ChessRogueConfirmRollCsReq(ChessRogueConfirmRollCsReq other)
		: this()
	{
