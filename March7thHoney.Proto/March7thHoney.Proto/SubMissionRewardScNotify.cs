...
public sealed class SubMissionRewardScNotify : IMessage<SubMissionRewardScNotify>, IMessage, IEquatable<SubMissionRewardScNotify>, IDeepCloneable<SubMissionRewardScNotify>, IBufferMessage
{
	...
	public static MessageParser<SubMissionRewardScNotify> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => SubMissionRewardScNotifyReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public SubMissionRewardScNotify(SubMissionRewardScNotify other)
		: this()
	{
