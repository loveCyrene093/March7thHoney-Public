...
public sealed class GetSummonActivityDataCsReq : IMessage<GetSummonActivityDataCsReq>, IMessage, IEquatable<GetSummonActivityDataCsReq>, IDeepCloneable<GetSummonActivityDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetSummonActivityDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetSummonActivityDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetSummonActivityDataCsReq(GetSummonActivityDataCsReq other)
		: this()
	{
