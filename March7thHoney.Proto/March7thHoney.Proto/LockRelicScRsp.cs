...
public sealed class LockRelicScRsp : IMessage<LockRelicScRsp>, IMessage, IEquatable<LockRelicScRsp>, IDeepCloneable<LockRelicScRsp>, IBufferMessage
{
	...
	public static MessageParser<LockRelicScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => LockRelicScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public LockRelicScRsp(LockRelicScRsp other)
		: this()
	{
