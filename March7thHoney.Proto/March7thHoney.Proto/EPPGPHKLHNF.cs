...
public sealed class EPPGPHKLHNF : IMessage<EPPGPHKLHNF>, IMessage, IEquatable<EPPGPHKLHNF>, IDeepCloneable<EPPGPHKLHNF>, IBufferMessage
{
	private static readonly MessageParser<EPPGPHKLHNF> _parser = new MessageParser<EPPGPHKLHNF>(() => new EPPGPHKLHNF());
	...
	public static MessageParser<EPPGPHKLHNF> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => EPPGPHKLHNFReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EPPGPHKLHNF(EPPGPHKLHNF other)
		: this()
	{
