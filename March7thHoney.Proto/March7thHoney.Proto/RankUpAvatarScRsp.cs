...
public sealed class RankUpAvatarScRsp : IMessage<RankUpAvatarScRsp>, IMessage, IEquatable<RankUpAvatarScRsp>, IDeepCloneable<RankUpAvatarScRsp>, IBufferMessage
{
	...
	public static MessageParser<RankUpAvatarScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RankUpAvatarScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RankUpAvatarScRsp(RankUpAvatarScRsp other)
		: this()
	{
