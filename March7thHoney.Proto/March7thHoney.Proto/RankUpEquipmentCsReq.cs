...
public sealed class RankUpEquipmentCsReq : IMessage<RankUpEquipmentCsReq>, IMessage, IEquatable<RankUpEquipmentCsReq>, IDeepCloneable<RankUpEquipmentCsReq>, IBufferMessage
{
	...
	public static MessageParser<RankUpEquipmentCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RankUpEquipmentCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RankUpEquipmentCsReq(RankUpEquipmentCsReq other)
		: this()
	{
