...
public sealed class GetAssistHistoryCsReq : IMessage<GetAssistHistoryCsReq>, IMessage, IEquatable<GetAssistHistoryCsReq>, IDeepCloneable<GetAssistHistoryCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetAssistHistoryCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetAssistHistoryCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetAssistHistoryCsReq(GetAssistHistoryCsReq other)
		: this()
	{
	...
	{
		return Equals(other as GetAssistHistoryCsReq);
	}
