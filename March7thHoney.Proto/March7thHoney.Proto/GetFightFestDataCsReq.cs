...
public sealed class GetFightFestDataCsReq : IMessage<GetFightFestDataCsReq>, IMessage, IEquatable<GetFightFestDataCsReq>, IDeepCloneable<GetFightFestDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetFightFestDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetFightFestDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetFightFestDataCsReq(GetFightFestDataCsReq other)
		: this()
	{
