...
public sealed class AvatarExpUpScRsp : IMessage<AvatarExpUpScRsp>, IMessage, IEquatable<AvatarExpUpScRsp>, IDeepCloneable<AvatarExpUpScRsp>, IBufferMessage
{
	...
	private static readonly FieldCodec<PileItem> _repeated_returnItemList_codec = FieldCodec.ForMessage(50u, PileItem.Parser);
	...
	public static MessageParser<AvatarExpUpScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => AvatarExpUpScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public AvatarExpUpScRsp(AvatarExpUpScRsp other)
		: this()
	{
