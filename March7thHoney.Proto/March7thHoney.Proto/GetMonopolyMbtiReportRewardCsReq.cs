...
public sealed class GetMonopolyMbtiReportRewardCsReq : IMessage<GetMonopolyMbtiReportRewardCsReq>, IMessage, IEquatable<GetMonopolyMbtiReportRewardCsReq>, IDeepCloneable<GetMonopolyMbtiReportRewardCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetMonopolyMbtiReportRewardCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetMonopolyMbtiReportRewardCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetMonopolyMbtiReportRewardCsReq(GetMonopolyMbtiReportRewardCsReq other)
		: this()
	{
	...
	{
		return Equals(other as GetMonopolyMbtiReportRewardCsReq);
	}
