...
public sealed class GetTelevisionActivityDataCsReq : IMessage<GetTelevisionActivityDataCsReq>, IMessage, IEquatable<GetTelevisionActivityDataCsReq>, IDeepCloneable<GetTelevisionActivityDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetTelevisionActivityDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetTelevisionActivityDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetTelevisionActivityDataCsReq(GetTelevisionActivityDataCsReq other)
		: this()
	{
