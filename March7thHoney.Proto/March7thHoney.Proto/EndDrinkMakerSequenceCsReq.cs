...
public sealed class EndDrinkMakerSequenceCsReq : IMessage<EndDrinkMakerSequenceCsReq>, IMessage, IEquatable<EndDrinkMakerSequenceCsReq>, IDeepCloneable<EndDrinkMakerSequenceCsReq>, IBufferMessage
{
	...
	public static MessageParser<EndDrinkMakerSequenceCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => EndDrinkMakerSequenceCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EndDrinkMakerSequenceCsReq(EndDrinkMakerSequenceCsReq other)
		: this()
	{
