...
public sealed class MonopolyCheatDiceScRsp : IMessage<MonopolyCheatDiceScRsp>, IMessage, IEquatable<MonopolyCheatDiceScRsp>, IDeepCloneable<MonopolyCheatDiceScRsp>, IBufferMessage
{
	...
	public const int MFHKGPJJGBNFieldNumber = 5;

	private uint mFHKGPJJGBN_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<MonopolyCheatDiceScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MonopolyCheatDiceScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MonopolyCheatDiceScRsp(MonopolyCheatDiceScRsp other)
		: this()
	{
