...
public sealed class BuyNpcStuffScRsp : IMessage<BuyNpcStuffScRsp>, IMessage, IEquatable<BuyNpcStuffScRsp>, IDeepCloneable<BuyNpcStuffScRsp>, IBufferMessage
{
	...
	public static MessageParser<BuyNpcStuffScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => BuyNpcStuffScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public BuyNpcStuffScRsp(BuyNpcStuffScRsp other)
		: this()
	{
