...
public sealed class GetChessRogueStoryInfoCsReq : IMessage<GetChessRogueStoryInfoCsReq>, IMessage, IEquatable<GetChessRogueStoryInfoCsReq>, IDeepCloneable<GetChessRogueStoryInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetChessRogueStoryInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetChessRogueStoryInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetChessRogueStoryInfoCsReq(GetChessRogueStoryInfoCsReq other)
		: this()
	{
	...
	{
		return Equals(other as GetChessRogueStoryInfoCsReq);
	}
