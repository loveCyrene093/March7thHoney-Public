...
public sealed class EPLFOKKDFLB : IMessage<EPLFOKKDFLB>, IMessage, IEquatable<EPLFOKKDFLB>, IDeepCloneable<EPLFOKKDFLB>, IBufferMessage
{
	private static readonly MessageParser<EPLFOKKDFLB> _parser = new MessageParser<EPLFOKKDFLB>(() => new EPLFOKKDFLB());
	...
	public static MessageParser<EPLFOKKDFLB> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => EPLFOKKDFLBReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EPLFOKKDFLB(EPLFOKKDFLB other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EPLFOKKDFLB Clone()
	{
		return new EPLFOKKDFLB(this);
	}
	...
	{
		return Equals(other as EPLFOKKDFLB);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(EPLFOKKDFLB other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(EPLFOKKDFLB other)
	{
		if (other != null)
		{
