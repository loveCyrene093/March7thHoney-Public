...
public sealed class RogueTournLeaveRogueCocoonSceneCsReq : IMessage<RogueTournLeaveRogueCocoonSceneCsReq>, IMessage, IEquatable<RogueTournLeaveRogueCocoonSceneCsReq>, IDeepCloneable<RogueTournLeaveRogueCocoonSceneCsReq>, IBufferMessage
{
	...
	public static MessageParser<RogueTournLeaveRogueCocoonSceneCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueTournLeaveRogueCocoonSceneCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueTournLeaveRogueCocoonSceneCsReq(RogueTournLeaveRogueCocoonSceneCsReq other)
		: this()
	{
	...
	{
		return Equals(other as RogueTournLeaveRogueCocoonSceneCsReq);
	}
