...
public sealed class PlayerLogoutCsReq : IMessage<PlayerLogoutCsReq>, IMessage, IEquatable<PlayerLogoutCsReq>, IDeepCloneable<PlayerLogoutCsReq>, IBufferMessage
{
	...
	public static MessageParser<PlayerLogoutCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => PlayerLogoutCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public PlayerLogoutCsReq(PlayerLogoutCsReq other)
		: this()
	{
