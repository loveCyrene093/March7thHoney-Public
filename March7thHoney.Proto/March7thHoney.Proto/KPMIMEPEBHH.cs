...
public sealed class KPMIMEPEBHH : IMessage<KPMIMEPEBHH>, IMessage, IEquatable<KPMIMEPEBHH>, IDeepCloneable<KPMIMEPEBHH>, IBufferMessage
{
	private static readonly MessageParser<KPMIMEPEBHH> _parser = new MessageParser<KPMIMEPEBHH>(() => new KPMIMEPEBHH());
	...
	public static MessageParser<KPMIMEPEBHH> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => KPMIMEPEBHHReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public KPMIMEPEBHH(KPMIMEPEBHH other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public KPMIMEPEBHH Clone()
	{
		return new KPMIMEPEBHH(this);
	}
	...
	{
		return Equals(other as KPMIMEPEBHH);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(KPMIMEPEBHH other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(KPMIMEPEBHH other)
	{
		if (other != null)
		{
