...
public sealed class UnlockTutorialScRsp : IMessage<UnlockTutorialScRsp>, IMessage, IEquatable<UnlockTutorialScRsp>, IDeepCloneable<UnlockTutorialScRsp>, IBufferMessage
{
	...
	public const int TutorialFieldNumber = 14;

	private Tutorial tutorial_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<UnlockTutorialScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => UnlockTutorialScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public UnlockTutorialScRsp(UnlockTutorialScRsp other)
		: this()
	{
	...
	public bool Equals(UnlockTutorialScRsp other)
	{
		...
		if (!object.Equals(Tutorial, other.Tutorial))
		{
			return false;
		}
	...
	public int CalculateSize()
	{
		...
		if (tutorial_ != null)
		{
			num += 1 + CodedOutputStream.ComputeMessageSize(Tutorial);
		}
		if (_unknownFields != null)
		{
