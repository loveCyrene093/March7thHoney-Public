...
public sealed class GetMonopolyInfoCsReq : IMessage<GetMonopolyInfoCsReq>, IMessage, IEquatable<GetMonopolyInfoCsReq>, IDeepCloneable<GetMonopolyInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetMonopolyInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetMonopolyInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetMonopolyInfoCsReq(GetMonopolyInfoCsReq other)
		: this()
	{
	...
	{
		return Equals(other as GetMonopolyInfoCsReq);
	}
