...
public sealed class MonopolyGuessChooseCsReq : IMessage<MonopolyGuessChooseCsReq>, IMessage, IEquatable<MonopolyGuessChooseCsReq>, IDeepCloneable<MonopolyGuessChooseCsReq>, IBufferMessage
{
	...
	public const int ILIPGAECPPCFieldNumber = 6;

	private uint iLIPGAECPPC_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<MonopolyGuessChooseCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MonopolyGuessChooseCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MonopolyGuessChooseCsReq(MonopolyGuessChooseCsReq other)
		: this()
	{
