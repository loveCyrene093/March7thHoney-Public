...
public sealed class HLOKAOLLHMP : IMessage<HLOKAOLLHMP>, IMessage, IEquatable<HLOKAOLLHMP>, IDeepCloneable<HLOKAOLLHMP>, IBufferMessage
{
	private static readonly MessageParser<HLOKAOLLHMP> _parser = new MessageParser<HLOKAOLLHMP>(() => new HLOKAOLLHMP());
	...
	public const int ACPBOHCHHKGFieldNumber = 5;

	private static readonly FieldCodec<uint> _repeated_aCPBOHCHHKG_codec = FieldCodec.ForUInt32(42u);

	private readonly RepeatedField<uint> aCPBOHCHHKG_ = new RepeatedField<uint>();

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<HLOKAOLLHMP> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => HLOKAOLLHMPReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public HLOKAOLLHMP(HLOKAOLLHMP other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public HLOKAOLLHMP Clone()
	{
		return new HLOKAOLLHMP(this);
	}
	...
	{
		return Equals(other as HLOKAOLLHMP);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(HLOKAOLLHMP other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(HLOKAOLLHMP other)
	{
		if (other != null)
		{
