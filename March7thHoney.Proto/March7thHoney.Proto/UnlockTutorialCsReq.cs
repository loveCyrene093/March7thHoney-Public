...
public sealed class UnlockTutorialCsReq : IMessage<UnlockTutorialCsReq>, IMessage, IEquatable<UnlockTutorialCsReq>, IDeepCloneable<UnlockTutorialCsReq>, IBufferMessage
{
	...
	public const int TutorialIdFieldNumber = 15;

	private uint tutorialId_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<UnlockTutorialCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => UnlockTutorialCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public UnlockTutorialCsReq(UnlockTutorialCsReq other)
		: this()
	{
