...
public sealed class RogueModifierDelNotify : IMessage<RogueModifierDelNotify>, IMessage, IEquatable<RogueModifierDelNotify>, IDeepCloneable<RogueModifierDelNotify>, IBufferMessage
{
	...
	public const int PIMNEEFDAGEFieldNumber = 2;

	private ulong pIMNEEFDAGE_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<RogueModifierDelNotify> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueModifierDelNotifyReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueModifierDelNotify(RogueModifierDelNotify other)
		: this()
	{
