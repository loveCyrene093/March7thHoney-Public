...
public sealed class GetDailyActiveInfoCsReq : IMessage<GetDailyActiveInfoCsReq>, IMessage, IEquatable<GetDailyActiveInfoCsReq>, IDeepCloneable<GetDailyActiveInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetDailyActiveInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetDailyActiveInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetDailyActiveInfoCsReq(GetDailyActiveInfoCsReq other)
		: this()
	{
