...
public sealed class TakeRogueScoreRewardScRsp : IMessage<TakeRogueScoreRewardScRsp>, IMessage, IEquatable<TakeRogueScoreRewardScRsp>, IDeepCloneable<TakeRogueScoreRewardScRsp>, IBufferMessage
{
	...
	public static MessageParser<TakeRogueScoreRewardScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => TakeRogueScoreRewardScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public TakeRogueScoreRewardScRsp(TakeRogueScoreRewardScRsp other)
		: this()
	{
