...
public sealed class PrestigeLevelUpCsReq : IMessage<PrestigeLevelUpCsReq>, IMessage, IEquatable<PrestigeLevelUpCsReq>, IDeepCloneable<PrestigeLevelUpCsReq>, IBufferMessage
{
	...
	public static MessageParser<PrestigeLevelUpCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => PrestigeLevelUpCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public PrestigeLevelUpCsReq(PrestigeLevelUpCsReq other)
		: this()
	{
