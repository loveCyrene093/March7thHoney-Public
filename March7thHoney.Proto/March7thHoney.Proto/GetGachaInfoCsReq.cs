...
public sealed class GetGachaInfoCsReq : IMessage<GetGachaInfoCsReq>, IMessage, IEquatable<GetGachaInfoCsReq>, IDeepCloneable<GetGachaInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetGachaInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetGachaInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetGachaInfoCsReq(GetGachaInfoCsReq other)
		: this()
	{
