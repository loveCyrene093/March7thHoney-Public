...
public sealed class GetCurSceneInfoCsReq : IMessage<GetCurSceneInfoCsReq>, IMessage, IEquatable<GetCurSceneInfoCsReq>, IDeepCloneable<GetCurSceneInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetCurSceneInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetCurSceneInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetCurSceneInfoCsReq(GetCurSceneInfoCsReq other)
		: this()
	{
