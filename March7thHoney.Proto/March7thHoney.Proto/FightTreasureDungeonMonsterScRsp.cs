...
public sealed class FightTreasureDungeonMonsterScRsp : IMessage<FightTreasureDungeonMonsterScRsp>, IMessage, IEquatable<FightTreasureDungeonMonsterScRsp>, IDeepCloneable<FightTreasureDungeonMonsterScRsp>, IBufferMessage
{
	...
	public static MessageParser<FightTreasureDungeonMonsterScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => FightTreasureDungeonMonsterScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public FightTreasureDungeonMonsterScRsp(FightTreasureDungeonMonsterScRsp other)
		: this()
	{
