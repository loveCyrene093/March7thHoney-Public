...
public sealed class TravelBrochureRemovePasterCsReq : IMessage<TravelBrochureRemovePasterCsReq>, IMessage, IEquatable<TravelBrochureRemovePasterCsReq>, IDeepCloneable<TravelBrochureRemovePasterCsReq>, IBufferMessage
{
	...
	public static MessageParser<TravelBrochureRemovePasterCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => TravelBrochureRemovePasterCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public TravelBrochureRemovePasterCsReq(TravelBrochureRemovePasterCsReq other)
		: this()
	{
