...
public sealed class EENMIGNAPKH : IMessage<EENMIGNAPKH>, IMessage, IEquatable<EENMIGNAPKH>, IDeepCloneable<EENMIGNAPKH>, IBufferMessage
{
	private static readonly MessageParser<EENMIGNAPKH> _parser = new MessageParser<EENMIGNAPKH>(() => new EENMIGNAPKH());
	...
	public static MessageParser<EENMIGNAPKH> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => EENMIGNAPKHReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EENMIGNAPKH(EENMIGNAPKH other)
		: this()
	{
