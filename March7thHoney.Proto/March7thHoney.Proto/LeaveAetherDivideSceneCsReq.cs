...
public sealed class LeaveAetherDivideSceneCsReq : IMessage<LeaveAetherDivideSceneCsReq>, IMessage, IEquatable<LeaveAetherDivideSceneCsReq>, IDeepCloneable<LeaveAetherDivideSceneCsReq>, IBufferMessage
{
	...
	public static MessageParser<LeaveAetherDivideSceneCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => LeaveAetherDivideSceneCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public LeaveAetherDivideSceneCsReq(LeaveAetherDivideSceneCsReq other)
		: this()
	{
