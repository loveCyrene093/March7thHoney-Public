...
public sealed class OEMNHGMPMPD : IMessage<OEMNHGMPMPD>, IMessage, IEquatable<OEMNHGMPMPD>, IDeepCloneable<OEMNHGMPMPD>, IBufferMessage
{
	private static readonly MessageParser<OEMNHGMPMPD> _parser = new MessageParser<OEMNHGMPMPD>(() => new OEMNHGMPMPD());
	...
	public static MessageParser<OEMNHGMPMPD> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => OEMNHGMPMPDReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public OEMNHGMPMPD(OEMNHGMPMPD other)
		: this()
	{
