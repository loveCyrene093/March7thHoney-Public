...
public sealed class LockEquipmentScRsp : IMessage<LockEquipmentScRsp>, IMessage, IEquatable<LockEquipmentScRsp>, IDeepCloneable<LockEquipmentScRsp>, IBufferMessage
{
	...
	public static MessageParser<LockEquipmentScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => LockEquipmentScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public LockEquipmentScRsp(LockEquipmentScRsp other)
		: this()
	{
