...
public sealed class ChessRogueQuitCsReq : IMessage<ChessRogueQuitCsReq>, IMessage, IEquatable<ChessRogueQuitCsReq>, IDeepCloneable<ChessRogueQuitCsReq>, IBufferMessage
{
	...
	public static MessageParser<ChessRogueQuitCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ChessRogueQuitCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ChessRogueQuitCsReq(ChessRogueQuitCsReq other)
		: this()
	{
	...
	{
		return Equals(other as ChessRogueQuitCsReq);
	}
