...
public sealed class SpaceZooDataCsReq : IMessage<SpaceZooDataCsReq>, IMessage, IEquatable<SpaceZooDataCsReq>, IDeepCloneable<SpaceZooDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<SpaceZooDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => SpaceZooDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public SpaceZooDataCsReq(SpaceZooDataCsReq other)
		: this()
	{
