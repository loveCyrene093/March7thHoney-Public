...
public sealed class RogueTournGetAllArchiveCsReq : IMessage<RogueTournGetAllArchiveCsReq>, IMessage, IEquatable<RogueTournGetAllArchiveCsReq>, IDeepCloneable<RogueTournGetAllArchiveCsReq>, IBufferMessage
{
	...
	public static MessageParser<RogueTournGetAllArchiveCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueTournGetAllArchiveCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueTournGetAllArchiveCsReq(RogueTournGetAllArchiveCsReq other)
		: this()
	{
	...
	{
		return Equals(other as RogueTournGetAllArchiveCsReq);
	}
