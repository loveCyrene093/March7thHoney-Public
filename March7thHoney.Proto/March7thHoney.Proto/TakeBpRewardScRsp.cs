...
public sealed class TakeBpRewardScRsp : IMessage<TakeBpRewardScRsp>, IMessage, IEquatable<TakeBpRewardScRsp>, IDeepCloneable<TakeBpRewardScRsp>, IBufferMessage
{
	...
	public static MessageParser<TakeBpRewardScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => TakeBpRewardScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public TakeBpRewardScRsp(TakeBpRewardScRsp other)
		: this()
	{
