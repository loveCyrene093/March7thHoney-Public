...
public sealed class ExpUpRelicScRsp : IMessage<ExpUpRelicScRsp>, IMessage, IEquatable<ExpUpRelicScRsp>, IDeepCloneable<ExpUpRelicScRsp>, IBufferMessage
{
	...
	private static readonly FieldCodec<PileItem> _repeated_returnItemList_codec = FieldCodec.ForMessage(82u, PileItem.Parser);
	...
	public static MessageParser<ExpUpRelicScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ExpUpRelicScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ExpUpRelicScRsp(ExpUpRelicScRsp other)
		: this()
	{
