...
public sealed class GetRogueEndlessActivityDataCsReq : IMessage<GetRogueEndlessActivityDataCsReq>, IMessage, IEquatable<GetRogueEndlessActivityDataCsReq>, IDeepCloneable<GetRogueEndlessActivityDataCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetRogueEndlessActivityDataCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetRogueEndlessActivityDataCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetRogueEndlessActivityDataCsReq(GetRogueEndlessActivityDataCsReq other)
		: this()
	{
