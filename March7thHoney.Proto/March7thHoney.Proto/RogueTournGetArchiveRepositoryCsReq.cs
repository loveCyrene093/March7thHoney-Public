...
public sealed class RogueTournGetArchiveRepositoryCsReq : IMessage<RogueTournGetArchiveRepositoryCsReq>, IMessage, IEquatable<RogueTournGetArchiveRepositoryCsReq>, IDeepCloneable<RogueTournGetArchiveRepositoryCsReq>, IBufferMessage
{
	...
	public static MessageParser<RogueTournGetArchiveRepositoryCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueTournGetArchiveRepositoryCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueTournGetArchiveRepositoryCsReq(RogueTournGetArchiveRepositoryCsReq other)
		: this()
	{
	...
	{
		return Equals(other as RogueTournGetArchiveRepositoryCsReq);
	}
