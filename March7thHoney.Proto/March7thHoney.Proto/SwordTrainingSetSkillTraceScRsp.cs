...
public sealed class SwordTrainingSetSkillTraceScRsp : IMessage<SwordTrainingSetSkillTraceScRsp>, IMessage, IEquatable<SwordTrainingSetSkillTraceScRsp>, IDeepCloneable<SwordTrainingSetSkillTraceScRsp>, IBufferMessage
{
	...
	public static MessageParser<SwordTrainingSetSkillTraceScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => SwordTrainingSetSkillTraceScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public SwordTrainingSetSkillTraceScRsp(SwordTrainingSetSkillTraceScRsp other)
		: this()
	{
