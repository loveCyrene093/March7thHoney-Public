...
public sealed class MonopolyRollDiceCsReq : IMessage<MonopolyRollDiceCsReq>, IMessage, IEquatable<MonopolyRollDiceCsReq>, IDeepCloneable<MonopolyRollDiceCsReq>, IBufferMessage
{
	...
	public static MessageParser<MonopolyRollDiceCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => MonopolyRollDiceCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public MonopolyRollDiceCsReq(MonopolyRollDiceCsReq other)
		: this()
	{
	...
	{
		return Equals(other as MonopolyRollDiceCsReq);
	}
