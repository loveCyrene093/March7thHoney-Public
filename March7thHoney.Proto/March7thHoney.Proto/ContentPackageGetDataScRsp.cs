...
public sealed class ContentPackageGetDataScRsp : IMessage<ContentPackageGetDataScRsp>, IMessage, IEquatable<ContentPackageGetDataScRsp>, IDeepCloneable<ContentPackageGetDataScRsp>, IBufferMessage
{
	...
	public static MessageParser<ContentPackageGetDataScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ContentPackageGetDataScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ContentPackageGetDataScRsp(ContentPackageGetDataScRsp other)
		: this()
	{
