...
public sealed class TakeAllRewardScRsp : IMessage<TakeAllRewardScRsp>, IMessage, IEquatable<TakeAllRewardScRsp>, IDeepCloneable<TakeAllRewardScRsp>, IBufferMessage
{
	...
	public static MessageParser<TakeAllRewardScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => TakeAllRewardScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public TakeAllRewardScRsp(TakeAllRewardScRsp other)
		: this()
	{
