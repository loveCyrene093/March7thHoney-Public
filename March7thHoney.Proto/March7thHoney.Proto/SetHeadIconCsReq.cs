...
public sealed class SetHeadIconCsReq : IMessage<SetHeadIconCsReq>, IMessage, IEquatable<SetHeadIconCsReq>, IDeepCloneable<SetHeadIconCsReq>, IBufferMessage
{
	...
	public static MessageParser<SetHeadIconCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => SetHeadIconCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public SetHeadIconCsReq(SetHeadIconCsReq other)
		: this()
	{
		id_ = other.id_;
