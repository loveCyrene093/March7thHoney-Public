...
public sealed class GetRogueBuffEnhanceInfoScRsp : IMessage<GetRogueBuffEnhanceInfoScRsp>, IMessage, IEquatable<GetRogueBuffEnhanceInfoScRsp>, IDeepCloneable<GetRogueBuffEnhanceInfoScRsp>, IBufferMessage
{
	...
	public const int FGLJOKILKHGFieldNumber = 13;

	private DAGBCJIHJBM fGLJOKILKHG_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<GetRogueBuffEnhanceInfoScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetRogueBuffEnhanceInfoScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetRogueBuffEnhanceInfoScRsp(GetRogueBuffEnhanceInfoScRsp other)
		: this()
	{
