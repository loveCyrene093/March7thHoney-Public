...
public sealed class RestartChallengePhaseScRsp : IMessage<RestartChallengePhaseScRsp>, IMessage, IEquatable<RestartChallengePhaseScRsp>, IDeepCloneable<RestartChallengePhaseScRsp>, IBufferMessage
{
	...
	public static MessageParser<RestartChallengePhaseScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RestartChallengePhaseScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RestartChallengePhaseScRsp(RestartChallengePhaseScRsp other)
		: this()
	{
