...
public sealed class GridFightPortalServerDataUpdate : IMessage<GridFightPortalServerDataUpdate>, IMessage, IEquatable<GridFightPortalServerDataUpdate>, IDeepCloneable<GridFightPortalServerDataUpdate>, IBufferMessage
{
	private static readonly MessageParser<GridFightPortalServerDataUpdate> _parser = new MessageParser<GridFightPortalServerDataUpdate>(() => new GridFightPortalServerDataUpdate());
	...
	private static readonly FieldCodec<uint> _repeated_pEOFPPOFIGI_codec = FieldCodec.ForUInt32(122u);

	private readonly RepeatedField<uint> pEOFPPOFIGI_ = new RepeatedField<uint>();

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<GridFightPortalServerDataUpdate> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GridFightPortalServerDataUpdateReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GridFightPortalServerDataUpdate(GridFightPortalServerDataUpdate other)
		: this()
	{
