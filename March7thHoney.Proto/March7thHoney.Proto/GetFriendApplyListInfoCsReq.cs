...
public sealed class GetFriendApplyListInfoCsReq : IMessage<GetFriendApplyListInfoCsReq>, IMessage, IEquatable<GetFriendApplyListInfoCsReq>, IDeepCloneable<GetFriendApplyListInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetFriendApplyListInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetFriendApplyListInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetFriendApplyListInfoCsReq(GetFriendApplyListInfoCsReq other)
		: this()
	{
	...
	{
		return Equals(other as GetFriendApplyListInfoCsReq);
	}
