...
public sealed class GetCrossInfoCsReq : IMessage<GetCrossInfoCsReq>, IMessage, IEquatable<GetCrossInfoCsReq>, IDeepCloneable<GetCrossInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetCrossInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetCrossInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetCrossInfoCsReq(GetCrossInfoCsReq other)
		: this()
	{
