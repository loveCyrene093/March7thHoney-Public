...
public sealed class LobbyGetInfoCsReq : IMessage<LobbyGetInfoCsReq>, IMessage, IEquatable<LobbyGetInfoCsReq>, IDeepCloneable<LobbyGetInfoCsReq>, IBufferMessage
{
	...
	public static MessageParser<LobbyGetInfoCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => LobbyGetInfoCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public LobbyGetInfoCsReq(LobbyGetInfoCsReq other)
		: this()
	{
