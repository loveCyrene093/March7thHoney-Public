...
public sealed class TravelBrochurePageResetScRsp : IMessage<TravelBrochurePageResetScRsp>, IMessage, IEquatable<TravelBrochurePageResetScRsp>, IDeepCloneable<TravelBrochurePageResetScRsp>, IBufferMessage
{
	...
	public const int MHMDIDKNCIHFieldNumber = 15;

	private PBPIOFGODHC mHMDIDKNCIH_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<TravelBrochurePageResetScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => TravelBrochurePageResetScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public TravelBrochurePageResetScRsp(TravelBrochurePageResetScRsp other)
		: this()
	{
