...
public sealed class RaidCollectionEnterNextRaidScRsp : IMessage<RaidCollectionEnterNextRaidScRsp>, IMessage, IEquatable<RaidCollectionEnterNextRaidScRsp>, IDeepCloneable<RaidCollectionEnterNextRaidScRsp>, IBufferMessage
{
	...
	public static MessageParser<RaidCollectionEnterNextRaidScRsp> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RaidCollectionEnterNextRaidScRspReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RaidCollectionEnterNextRaidScRsp(RaidCollectionEnterNextRaidScRsp other)
		: this()
	{
