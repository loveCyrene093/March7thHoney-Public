...
public sealed class RogueMagicReviveAvatarCsReq : IMessage<RogueMagicReviveAvatarCsReq>, IMessage, IEquatable<RogueMagicReviveAvatarCsReq>, IDeepCloneable<RogueMagicReviveAvatarCsReq>, IBufferMessage
{
	...
	private static readonly FieldCodec<uint> _repeated_baseAvatarIdList_codec = FieldCodec.ForUInt32(42u);

	private readonly RepeatedField<uint> baseAvatarIdList_ = new RepeatedField<uint>();

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<RogueMagicReviveAvatarCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => RogueMagicReviveAvatarCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RogueMagicReviveAvatarCsReq(RogueMagicReviveAvatarCsReq other)
		: this()
	{
