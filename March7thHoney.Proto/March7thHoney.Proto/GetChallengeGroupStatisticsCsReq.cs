...
public sealed class GetChallengeGroupStatisticsCsReq : IMessage<GetChallengeGroupStatisticsCsReq>, IMessage, IEquatable<GetChallengeGroupStatisticsCsReq>, IDeepCloneable<GetChallengeGroupStatisticsCsReq>, IBufferMessage
{
	...
	public static MessageParser<GetChallengeGroupStatisticsCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GetChallengeGroupStatisticsCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GetChallengeGroupStatisticsCsReq(GetChallengeGroupStatisticsCsReq other)
		: this()
	{
