...
public sealed class ChessRogueEnterCsReq : IMessage<ChessRogueEnterCsReq>, IMessage, IEquatable<ChessRogueEnterCsReq>, IDeepCloneable<ChessRogueEnterCsReq>, IBufferMessage
{
	...
	public static MessageParser<ChessRogueEnterCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ChessRogueEnterCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ChessRogueEnterCsReq(ChessRogueEnterCsReq other)
		: this()
	{
		id_ = other.id_;
