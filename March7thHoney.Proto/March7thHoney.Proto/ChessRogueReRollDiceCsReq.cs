...
public sealed class ChessRogueReRollDiceCsReq : IMessage<ChessRogueReRollDiceCsReq>, IMessage, IEquatable<ChessRogueReRollDiceCsReq>, IDeepCloneable<ChessRogueReRollDiceCsReq>, IBufferMessage
{
	...
	public const int BGPBIMDCBBLFieldNumber = 4;

	private uint bGPBIMDCBBL_;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageParser<ChessRogueReRollDiceCsReq> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ChessRogueReRollDiceCsReqReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ChessRogueReRollDiceCsReq(ChessRogueReRollDiceCsReq other)
		: this()
	{
