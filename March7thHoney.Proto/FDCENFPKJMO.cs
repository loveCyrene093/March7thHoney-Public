...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from FDCENFPKJMO.proto</summary>
  public static partial class FDCENFPKJMOReflection {

    #region Descriptor
    /// <summary>File descriptor for FDCENFPKJMO.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "DOOBFDLPMNB" field.</summary>
    ...
    /// <summary>Field number for the "DPAFELPDGIN" field.</summary>
    ...
    /// <summary>Field number for the "OMKBLLOAJPO" field.</summary>
    ...
    /// <summary>Field number for the "NGDDLKDLLAL" field.</summary>
    ...
    /// <summary>Field number for the "PPIFOCGJDMD" field.</summary>
