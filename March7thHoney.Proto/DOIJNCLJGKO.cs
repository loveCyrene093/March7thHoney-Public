...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from DOIJNCLJGKO.proto</summary>
  public static partial class DOIJNCLJGKOReflection {

    #region Descriptor
    /// <summary>File descriptor for DOIJNCLJGKO.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "PIMNEEFDAGE" field.</summary>
    ...
    /// <summary>Field number for the "IMPOEHIOCBC" field.</summary>
    ...
    /// <summary>Field number for the "FJNNJNHACAB" field.</summary>
    ...
    /// <summary>Field number for the "AGPGDEPJAJM" field.</summary>
    ...
    /// <summary>Field number for the "ANGMBDBAOIH" field.</summary>
