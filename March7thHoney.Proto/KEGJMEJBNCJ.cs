...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from KEGJMEJBNCJ.proto</summary>
  public static partial class KEGJMEJBNCJReflection {

    #region Descriptor
    /// <summary>File descriptor for KEGJMEJBNCJ.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "NALLICMEEDI" field.</summary>
    ...
    /// <summary>Field number for the "OEPPLIKECOD" field.</summary>
    ...
    /// <summary>Field number for the "KFEDJDCELPK" field.</summary>
    ...
    /// <summary>Field number for the "LJFLPNPJHLM" field.</summary>
