...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from CBJAEJAFCKG.proto</summary>
  public static partial class CBJAEJAFCKGReflection {

    #region Descriptor
    /// <summary>File descriptor for CBJAEJAFCKG.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "OKOBGFHGIJB" field.</summary>
    ...
    /// <summary>Field number for the "ECBILPPLFII" field.</summary>
    ...
    /// <summary>Field number for the "DEFDJJPLBPG" field.</summary>
    ...
    /// <summary>Field number for the "FBDKDEBJFGB" field.</summary>
    ...
    /// <summary>Field number for the "HFPGMBAKBMB" field.</summary>
    ...
    /// <summary>Field number for the "DOJNIHGIDKE" field.</summary>
