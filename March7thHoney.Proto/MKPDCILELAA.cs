...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from MKPDCILELAA.proto</summary>
  public static partial class MKPDCILELAAReflection {

    #region Descriptor
    /// <summary>File descriptor for MKPDCILELAA.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "MDFOADMKJDL" field.</summary>
    ...
    /// <summary>Field number for the "PDAIGDFNPPN" field.</summary>
    ...
    /// <summary>Field number for the "AOMDBDNMBFC" field.</summary>
