...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from MEGIHBEMOAB.proto</summary>
  public static partial class MEGIHBEMOABReflection {

    #region Descriptor
    /// <summary>File descriptor for MEGIHBEMOAB.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "IBEBJMMCIDH" field.</summary>
    ...
    /// <summary>Field number for the "FNKKIDJPKIH" field.</summary>
    ...
    /// <summary>Field number for the "DMMNCNGGPHL" field.</summary>
    ...
    /// <summary>Field number for the "AFOLIFFCDHJ" field.</summary>
