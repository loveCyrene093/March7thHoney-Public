...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from JMIIFOMFOGO.proto</summary>
  public static partial class JMIIFOMFOGOReflection {

    #region Descriptor
    /// <summary>File descriptor for JMIIFOMFOGO.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "EDIGFNFPBKA" field.</summary>
    ...
    /// <summary>Field number for the "GGLOCPJMEHI" field.</summary>
    ...
    /// <summary>Field number for the "ICOALGKANLB" field.</summary>
    ...
    /// <summary>Field number for the "AEFEMMIPOAF" field.</summary>
    ...
    /// <summary>Field number for the "AMKFKDCFMIM" field.</summary>
    ...
    /// <summary>Field number for the "GLEENOKNGCI" field.</summary>
    ...
    /// <summary>Field number for the "DCBKJOCEFNF" field.</summary>
