...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from COKHGIMNLEK.proto</summary>
  public static partial class COKHGIMNLEKReflection {

    #region Descriptor
    /// <summary>File descriptor for COKHGIMNLEK.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "LKBGIEHLDLK" field.</summary>
    ...
    /// <summary>Field number for the "GGFJFKKJPDF" field.</summary>
    ...
    /// <summary>Field number for the "NKCHPOBJFAP" field.</summary>
    ...
    /// <summary>Field number for the "BGOEKCKEKIL" field.</summary>
    ...
    /// <summary>Field number for the "KKEEHBAKODI" field.</summary>
