...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from BKABOBIHOCN.proto</summary>
  public static partial class BKABOBIHOCNReflection {

    #region Descriptor
    /// <summary>File descriptor for BKABOBIHOCN.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "KDLLCFMLMND" field.</summary>
    ...
    /// <summary>Field number for the "AFGNLDIMBGB" field.</summary>
    ...
    /// <summary>Field number for the "PHOPBJFMNDC" field.</summary>
