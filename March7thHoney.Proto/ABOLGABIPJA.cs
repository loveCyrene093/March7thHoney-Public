...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from ABOLGABIPJA.proto</summary>
  public static partial class ABOLGABIPJAReflection {

    #region Descriptor
    /// <summary>File descriptor for ABOLGABIPJA.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "MLOFNLCKNBL" field.</summary>
    ...
    /// <summary>Field number for the "LDEBCMJBCLD" field.</summary>
    ...
    /// <summary>Field number for the "NHDDHMGGKBO" field.</summary>
    ...
    /// <summary>Field number for the "HDHJEFFIPOL" field.</summary>
    ...
    /// <summary>Field number for the "NGCFMHKACDO" field.</summary>
    ...
    /// <summary>Field number for the "AJKHDLNMBMP" field.</summary>
    ...
    /// <summary>Field number for the "IGJOBFGJAMI" field.</summary>
    ...
    /// <summary>Field number for the "EBABMGKJIAF" field.</summary>
    ...
    /// <summary>Field number for the "JEBNJPNCPMP" field.</summary>
    ...
    /// <summary>Field number for the "HKEHIIPBDHA" field.</summary>
    ...
    /// <summary>Field number for the "FLMEHIPGBJN" field.</summary>
    ...
    /// <summary>Field number for the "EMHMHACKBOI" field.</summary>
    ...
    /// <summary>Field number for the "DDALNHLOGJK" field.</summary>
    ...
    /// <summary>Field number for the "LHHMLLFGFLI" field.</summary>
    ...
    /// <summary>Field number for the "DAMFMNKHFIH" field.</summary>
