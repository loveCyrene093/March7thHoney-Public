...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from FFFKFKHHEOG.proto</summary>
  public static partial class FFFKFKHHEOGReflection {

    #region Descriptor
    /// <summary>File descriptor for FFFKFKHHEOG.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "ACKIBGGBFMO" field.</summary>
    ...
    /// <summary>Field number for the "KLFPGJNLFKG" field.</summary>
    ...
    /// <summary>Field number for the "GBCPGOAFEBC" field.</summary>
