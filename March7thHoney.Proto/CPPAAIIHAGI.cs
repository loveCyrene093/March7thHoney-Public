...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from CPPAAIIHAGI.proto</summary>
  public static partial class CPPAAIIHAGIReflection {

    #region Descriptor
    /// <summary>File descriptor for CPPAAIIHAGI.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "LDLOHFLEOMG" field.</summary>
    ...
    /// <summary>Field number for the "DDPKJKHEDLH" field.</summary>
    ...
    /// <summary>Field number for the "GJGKIANENIP" field.</summary>
    ...
    /// <summary>Field number for the "MOEFPFOJEDI" field.</summary>
    ...
    /// <summary>Field number for the "JNBGEFJPKCC" field.</summary>
