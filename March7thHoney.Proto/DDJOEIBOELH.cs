...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from DDJOEIBOELH.proto</summary>
  public static partial class DDJOEIBOELHReflection {

    #region Descriptor
    /// <summary>File descriptor for DDJOEIBOELH.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "KLOLLDJJAOA" field.</summary>
    ...
    /// <summary>Field number for the "DGBANFMAKMA" field.</summary>
    ...
    /// <summary>Field number for the "GCPNCEDAMAB" field.</summary>
    ...
    /// <summary>Field number for the "MNNDMPBFPJE" field.</summary>
    ...
    /// <summary>Field number for the "IJEEJNBNGOM" field.</summary>
    ...
    /// <summary>Field number for the "GNDEPOKFHPE" field.</summary>
    ...
    /// <summary>Field number for the "BDLAMBNOGBH" field.</summary>
    ...
    /// <summary>Field number for the "BKJNCIFKAGD" field.</summary>
    ...
    /// <summary>Enum of possible cases for the "NKCBIECFIGK" oneof.</summary>
