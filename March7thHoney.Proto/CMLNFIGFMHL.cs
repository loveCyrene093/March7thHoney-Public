...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from CMLNFIGFMHL.proto</summary>
  public static partial class CMLNFIGFMHLReflection {

    #region Descriptor
    /// <summary>File descriptor for CMLNFIGFMHL.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "ODKFCCOHAFM" field.</summary>
    ...
    /// <summary>Field number for the "KFMAEGNNJDL" field.</summary>
    ...
    /// <summary>Field number for the "IHJGLGCLANM" field.</summary>
