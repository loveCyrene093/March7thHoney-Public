...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from GOFFIDNICKJ.proto</summary>
  public static partial class GOFFIDNICKJReflection {

    #region Descriptor
    /// <summary>File descriptor for GOFFIDNICKJ.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "GJCJHPEKODC" field.</summary>
    ...
    /// <summary>Field number for the "BLALLLNKHAC" field.</summary>
    ...
    /// <summary>Field number for the "JNKMJMABPMP" field.</summary>
