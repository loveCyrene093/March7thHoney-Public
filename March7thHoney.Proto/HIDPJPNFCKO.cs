...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from HIDPJPNFCKO.proto</summary>
  public static partial class HIDPJPNFCKOReflection {

    #region Descriptor
    /// <summary>File descriptor for HIDPJPNFCKO.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "MMKJKGMIEAP" field.</summary>
    ...
    /// <summary>Field number for the "JFOAGNILNKK" field.</summary>
    ...
    /// <summary>Field number for the "NFILAOLPOKE" field.</summary>
    ...
    /// <summary>Field number for the "PJHDKDAFHJD" field.</summary>
