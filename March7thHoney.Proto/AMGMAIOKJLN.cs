...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from AMGMAIOKJLN.proto</summary>
  public static partial class AMGMAIOKJLNReflection {

    #region Descriptor
    /// <summary>File descriptor for AMGMAIOKJLN.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "OIAECFMLPHK" field.</summary>
    ...
    /// <summary>Field number for the "FOMNFHJCDOC" field.</summary>
    ...
    /// <summary>Field number for the "BFAMFABBCIO" field.</summary>
