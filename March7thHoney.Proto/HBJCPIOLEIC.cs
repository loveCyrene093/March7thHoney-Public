...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from HBJCPIOLEIC.proto</summary>
  public static partial class HBJCPIOLEICReflection {

    #region Descriptor
    /// <summary>File descriptor for HBJCPIOLEIC.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "DFMBOIDDHNM" field.</summary>
    ...
    /// <summary>Field number for the "KJKFCLDDBKM" field.</summary>
    ...
    /// <summary>Field number for the "LCEBFBHALHA" field.</summary>
    ...
    /// <summary>Field number for the "FEACMLLOAFB" field.</summary>
    ...
    /// <summary>Enum of possible cases for the "HDOEFOCHLDA" oneof.</summary>
