...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from KPNDMCHCBPI.proto</summary>
  public static partial class KPNDMCHCBPIReflection {

    #region Descriptor
    /// <summary>File descriptor for KPNDMCHCBPI.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "CINMPHLJDEM" field.</summary>
    ...
    /// <summary>Field number for the "POINEKIEFPE" field.</summary>
    ...
    /// <summary>Field number for the "DPBEENBPDIP" field.</summary>
    ...
    /// <summary>Field number for the "BJADHCOFLGI" field.</summary>
    ...
    /// <summary>Field number for the "OAIBCCNAAHF" field.</summary>
    ...
    /// <summary>Field number for the "DONOJAEMJDB" field.</summary>
