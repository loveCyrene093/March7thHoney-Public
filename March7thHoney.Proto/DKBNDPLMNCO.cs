...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from DKBNDPLMNCO.proto</summary>
  public static partial class DKBNDPLMNCOReflection {

    #region Descriptor
    /// <summary>File descriptor for DKBNDPLMNCO.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JPONLDDDEMI" field.</summary>
    ...
    /// <summary>Field number for the "BEPKBMGKCGB" field.</summary>
    ...
    /// <summary>Field number for the "CODOFDEHJCJ" field.</summary>
    ...
    /// <summary>Field number for the "FKFHMMHBIKC" field.</summary>
    ...
    /// <summary>Field number for the "OEDMCLBPADG" field.</summary>
    ...
    /// <summary>Field number for the "CPJDHFJOIAL" field.</summary>
