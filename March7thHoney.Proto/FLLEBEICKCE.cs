...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from FLLEBEICKCE.proto</summary>
  public static partial class FLLEBEICKCEReflection {

    #region Descriptor
    /// <summary>File descriptor for FLLEBEICKCE.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "NAJCPOPJGLB" field.</summary>
    ...
    /// <summary>Field number for the "MLLGEOINJOG" field.</summary>
    ...
    /// <summary>Field number for the "LLHJAGGEGOK" field.</summary>
    ...
    /// <summary>Field number for the "PNCNGMFBAND" field.</summary>
    ...
    /// <summary>Field number for the "DDGEOOLHAPG" field.</summary>
    ...
    /// <summary>Field number for the "ELEBGNHEIML" field.</summary>
