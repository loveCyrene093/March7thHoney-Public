...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from MLDEDCCOHBF.proto</summary>
  public static partial class MLDEDCCOHBFReflection {

    #region Descriptor
    /// <summary>File descriptor for MLDEDCCOHBF.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "HAEEJBFFKGF" field.</summary>
    ...
    /// <summary>Field number for the "FHKINAKGBBK" field.</summary>
    ...
    /// <summary>Field number for the "OFNDICJJCIO" field.</summary>
    ...
    /// <summary>Field number for the "PHPFBNJOONP" field.</summary>
