...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from MJEDAOPDIPM.proto</summary>
  public static partial class MJEDAOPDIPMReflection {

    #region Descriptor
    /// <summary>File descriptor for MJEDAOPDIPM.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "BKKDHHEDLAJ" field.</summary>
    ...
    /// <summary>Field number for the "PCLHLNCJPHL" field.</summary>
    ...
    /// <summary>Field number for the "EJKPCFEPAEC" field.</summary>
