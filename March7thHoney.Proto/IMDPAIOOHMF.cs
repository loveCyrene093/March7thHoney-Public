...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from IMDPAIOOHMF.proto</summary>
  public static partial class IMDPAIOOHMFReflection {

    #region Descriptor
    /// <summary>File descriptor for IMDPAIOOHMF.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "LCPIODCLNHL" field.</summary>
    ...
    /// <summary>Field number for the "AFCAOBEBOMH" field.</summary>
    ...
    /// <summary>Field number for the "FPLDAKNALKL" field.</summary>
    ...
    /// <summary>Field number for the "PGIHGNOLIOI" field.</summary>
