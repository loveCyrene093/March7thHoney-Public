...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from KKNDEDPDFFL.proto</summary>
  public static partial class KKNDEDPDFFLReflection {

    #region Descriptor
    /// <summary>File descriptor for KKNDEDPDFFL.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "LCDALEEEDJJ" field.</summary>
    ...
    /// <summary>Field number for the "CAGMJCAPAAL" field.</summary>
    ...
    /// <summary>Field number for the "OCEKFIEFMJD" field.</summary>
    ...
    /// <summary>Field number for the "BKCLBLBGEMK" field.</summary>
    ...
    /// <summary>Field number for the "JPFKOBEAJOG" field.</summary>
    ...
    /// <summary>Field number for the "BDHGHALJJHC" field.</summary>
    ...
    /// <summary>Field number for the "DNNHCNCKJCM" field.</summary>
    ...
    /// <summary>Field number for the "BJIBAOBEAJJ" field.</summary>
    ...
    /// <summary>Field number for the "IPGLGFPMANL" field.</summary>
    ...
    /// <summary>Field number for the "GOEOGCJDACN" field.</summary>
    ...
    /// <summary>Field number for the "GODBPOHKDOH" field.</summary>
    ...
    /// <summary>Field number for the "NMEFGMICHON" field.</summary>
    ...
    /// <summary>Field number for the "BFEDHCOIOPN" field.</summary>
    ...
    /// <summary>Field number for the "JOBDOFHGGLN" field.</summary>
    ...
    /// <summary>Field number for the "PPCAPBMKGAC" field.</summary>
    ...
    /// <summary>Field number for the "GEEFOKFBPDK" field.</summary>
