...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from HMEDBGAMMPN.proto</summary>
  public static partial class HMEDBGAMMPNReflection {

    #region Descriptor
    /// <summary>File descriptor for HMEDBGAMMPN.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "BOLEHILKKAO" field.</summary>
    ...
    /// <summary>Field number for the "OKONFGOPOOK" field.</summary>
    ...
    /// <summary>Field number for the "MGCPIPCGILO" field.</summary>
