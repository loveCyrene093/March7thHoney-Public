...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from ECNCEKBIDPB.proto</summary>
  public static partial class ECNCEKBIDPBReflection {

    #region Descriptor
    /// <summary>File descriptor for ECNCEKBIDPB.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "BOINMJJEBBE" field.</summary>
    ...
    /// <summary>Field number for the "LENCLJPKDAO" field.</summary>
    ...
    /// <summary>Field number for the "CELHCDABFCL" field.</summary>
