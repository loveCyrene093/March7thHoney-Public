...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from MIGJFGJMCGO.proto</summary>
  public static partial class MIGJFGJMCGOReflection {

    #region Descriptor
    /// <summary>File descriptor for MIGJFGJMCGO.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "KFINACEFCNJ" field.</summary>
    ...
    /// <summary>Field number for the "COIHNJCHNMJ" field.</summary>
    ...
    /// <summary>Field number for the "IIKAMPCHBLN" field.</summary>
    ...
    /// <summary>Field number for the "MEPKKFLKPGM" field.</summary>
    ...
    /// <summary>Field number for the "KPKHJJAHHEM" field.</summary>
