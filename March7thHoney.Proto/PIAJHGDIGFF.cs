...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from PIAJHGDIGFF.proto</summary>
  public static partial class PIAJHGDIGFFReflection {

    #region Descriptor
    /// <summary>File descriptor for PIAJHGDIGFF.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "EGNDJGKKJHO" field.</summary>
    ...
    /// <summary>Field number for the "KCDOLIAAECN" field.</summary>
    ...
    /// <summary>Field number for the "LDIACAGJKJM" field.</summary>
    ...
    /// <summary>Field number for the "MNEBDMJGLEJ" field.</summary>
    ...
    /// <summary>Field number for the "KDGMBIMPKEH" field.</summary>
    ...
    /// <summary>Field number for the "PPFFBGBMLPC" field.</summary>
    ...
    /// <summary>Field number for the "BLLJFKDJKEN" field.</summary>
    ...
    /// <summary>Field number for the "PEMLOLMLOJO" field.</summary>
