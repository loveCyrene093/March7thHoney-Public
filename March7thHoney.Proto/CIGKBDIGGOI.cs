...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from CIGKBDIGGOI.proto</summary>
  public static partial class CIGKBDIGGOIReflection {

    #region Descriptor
    /// <summary>File descriptor for CIGKBDIGGOI.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "GFBCMJMINGK" field.</summary>
    ...
    /// <summary>Field number for the "IEMIMDJFMBF" field.</summary>
    ...
    /// <summary>Field number for the "NPCCGNLNKNP" field.</summary>
    ...
    /// <summary>Field number for the "KLADGKBMNHN" field.</summary>
    ...
    /// <summary>Field number for the "DGFGFAKNCKH" field.</summary>
