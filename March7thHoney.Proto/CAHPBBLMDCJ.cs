...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from CAHPBBLMDCJ.proto</summary>
  public static partial class CAHPBBLMDCJReflection {

    #region Descriptor
    /// <summary>File descriptor for CAHPBBLMDCJ.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "HCPBKALKGGL" field.</summary>
    ...
    /// <summary>Field number for the "CELNCPCPMHA" field.</summary>
    ...
    /// <summary>Field number for the "BJBABGBGGIN" field.</summary>
    ...
    /// <summary>Field number for the "JJGLBPGNJML" field.</summary>
    ...
    /// <summary>Field number for the "GBMBBLNEGCI" field.</summary>
    ...
    /// <summary>Field number for the "IEAKHDKAKDM" field.</summary>
