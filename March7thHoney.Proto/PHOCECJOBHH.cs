...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from PHOCECJOBHH.proto</summary>
  public static partial class PHOCECJOBHHReflection {

    #region Descriptor
    /// <summary>File descriptor for PHOCECJOBHH.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "DAECKFGAKLF" field.</summary>
    ...
    /// <summary>Field number for the "OAOJAEPJFFO" field.</summary>
    ...
    /// <summary>Field number for the "GCMNADAKONJ" field.</summary>
    ...
    /// <summary>Field number for the "GGHCFMOLDNI" field.</summary>
    ...
    /// <summary>Field number for the "PDBNGNABDJI" field.</summary>
    ...
    /// <summary>Field number for the "MHDJJDNHILK" field.</summary>
