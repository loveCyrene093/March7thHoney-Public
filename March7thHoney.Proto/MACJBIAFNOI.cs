...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from MACJBIAFNOI.proto</summary>
  public static partial class MACJBIAFNOIReflection {

    #region Descriptor
    /// <summary>File descriptor for MACJBIAFNOI.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "GNGKNDCKKKC" field.</summary>
    ...
    /// <summary>Field number for the "NALBEFMOKIB" field.</summary>
    ...
    /// <summary>Field number for the "DCBBKFFHHDL" field.</summary>
    ...
    /// <summary>Field number for the "JCBGHAODNDD" field.</summary>
    ...
    /// <summary>Field number for the "MEKPIHJKJBL" field.</summary>
