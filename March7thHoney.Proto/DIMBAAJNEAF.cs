...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from DIMBAAJNEAF.proto</summary>
  public static partial class DIMBAAJNEAFReflection {

    #region Descriptor
    /// <summary>File descriptor for DIMBAAJNEAF.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "ALLCAPABHAH" field.</summary>
    ...
    /// <summary>Field number for the "EJPLDKFEMDM" field.</summary>
    ...
    /// <summary>Field number for the "CHPHBCOKCEO" field.</summary>
    ...
    /// <summary>Field number for the "KFAMJJGHJOO" field.</summary>
