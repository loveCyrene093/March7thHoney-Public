...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from OJFDEKIPPJF.proto</summary>
  public static partial class OJFDEKIPPJFReflection {

    #region Descriptor
    /// <summary>File descriptor for OJFDEKIPPJF.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "FKKLHIHEEFM" field.</summary>
    ...
    /// <summary>Field number for the "AIFKKCDBHJG" field.</summary>
    ...
    /// <summary>Field number for the "HKBFAINCKHI" field.</summary>
    ...
    /// <summary>Field number for the "EEEJLCLGAGC" field.</summary>
