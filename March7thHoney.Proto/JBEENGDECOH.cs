...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from JBEENGDECOH.proto</summary>
  public static partial class JBEENGDECOHReflection {

    #region Descriptor
    /// <summary>File descriptor for JBEENGDECOH.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "AHHJHHOPHPJ" field.</summary>
    ...
    /// <summary>Field number for the "JCFEPOKIFPD" field.</summary>
    ...
    /// <summary>Field number for the "BBHMFANKCAO" field.</summary>
    ...
    /// <summary>Field number for the "BKDINONLAHD" field.</summary>
    ...
    /// <summary>Field number for the "CBJIFCGANIK" field.</summary>
    ...
    /// <summary>Field number for the "IEHKDAJNALE" field.</summary>
