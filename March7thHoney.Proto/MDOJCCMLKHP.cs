...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from MDOJCCMLKHP.proto</summary>
  public static partial class MDOJCCMLKHPReflection {

    #region Descriptor
    /// <summary>File descriptor for MDOJCCMLKHP.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "AIPBFEOFNDO" field.</summary>
    ...
    /// <summary>Field number for the "ECIAGLJNPMM" field.</summary>
    ...
    /// <summary>Field number for the "GLEMHECLMGP" field.</summary>
    ...
    /// <summary>Field number for the "JHBIKCPLFFJ" field.</summary>
    ...
    /// <summary>Field number for the "BCDHOFNMPNG" field.</summary>
    ...
    /// <summary>Field number for the "HGNFPBMEAAD" field.</summary>
    ...
    /// <summary>Enum of possible cases for the "MOBGECPCNKJ" oneof.</summary>
