...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from PKNBPAHCIMJ.proto</summary>
  public static partial class PKNBPAHCIMJReflection {

    #region Descriptor
    /// <summary>File descriptor for PKNBPAHCIMJ.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "COKGOPBMLPP" field.</summary>
    ...
    /// <summary>Field number for the "HNENKAHDBKM" field.</summary>
    ...
    /// <summary>Field number for the "PPOGPOJJELJ" field.</summary>
    ...
    /// <summary>Field number for the "GLIONEELOJH" field.</summary>
