...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from NFIKPFBPOMF.proto</summary>
  public static partial class NFIKPFBPOMFReflection {

    #region Descriptor
    /// <summary>File descriptor for NFIKPFBPOMF.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "ACCLBAGKGEL" field.</summary>
    ...
    /// <summary>Field number for the "KEDAEABLGAB" field.</summary>
    ...
    /// <summary>Field number for the "ECIJEKJAMPK" field.</summary>
