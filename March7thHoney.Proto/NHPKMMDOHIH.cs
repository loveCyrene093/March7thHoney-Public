...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from NHPKMMDOHIH.proto</summary>
  public static partial class NHPKMMDOHIHReflection {

    #region Descriptor
    /// <summary>File descriptor for NHPKMMDOHIH.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "OFABEGPJBJP" field.</summary>
    ...
    /// <summary>Field number for the "AAFLJGPKCDH" field.</summary>
    ...
    /// <summary>Field number for the "OMGGDMMLBJL" field.</summary>
    ...
    /// <summary>Field number for the "NCGEJEEOMFC" field.</summary>
    ...
    /// <summary>Field number for the "JDDMHMCHNNN" field.</summary>
