...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from BBHPOJJLFEC.proto</summary>
  public static partial class BBHPOJJLFECReflection {

    #region Descriptor
    /// <summary>File descriptor for BBHPOJJLFEC.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "AKAGAAMOJCF" field.</summary>
    ...
    /// <summary>Field number for the "BHLABMIODGO" field.</summary>
    ...
    /// <summary>Field number for the "JGAIPHCIJHB" field.</summary>
    ...
    /// <summary>Field number for the "IEAILOCMKNN" field.</summary>
