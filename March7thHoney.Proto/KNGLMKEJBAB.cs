...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from KNGLMKEJBAB.proto</summary>
  public static partial class KNGLMKEJBABReflection {

    #region Descriptor
    /// <summary>File descriptor for KNGLMKEJBAB.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "MGNHPGHMADG" field.</summary>
    ...
    /// <summary>Field number for the "NDAECAPOPAI" field.</summary>
    ...
    /// <summary>Field number for the "JHPHHBJIICK" field.</summary>
    ...
    /// <summary>Field number for the "NOJEAOJHDAL" field.</summary>
    ...
    /// <summary>Field number for the "JBGBALEFMHH" field.</summary>
    ...
    /// <summary>Field number for the "IILMEIAMDNC" field.</summary>
    ...
    /// <summary>Field number for the "PCKJPEEGDGB" field.</summary>
