...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from HMNAPNOMPME.proto</summary>
  public static partial class HMNAPNOMPMEReflection {

    #region Descriptor
    /// <summary>File descriptor for HMNAPNOMPME.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "DBPOEMNBMPA" field.</summary>
    ...
    /// <summary>Field number for the "GJFMAFINMOI" field.</summary>
    ...
    /// <summary>Field number for the "AEDFGHHBCJH" field.</summary>
    ...
    /// <summary>Field number for the "DOKNFOLKNKO" field.</summary>
    ...
    /// <summary>Field number for the "IFFDGDJPANJ" field.</summary>
    ...
    /// <summary>Field number for the "EOFCECPMHLC" field.</summary>
    ...
    /// <summary>Field number for the "IHKDGCFCEHM" field.</summary>
    ...
    /// <summary>Field number for the "IJEKHBFIEDA" field.</summary>
    ...
    /// <summary>Field number for the "AMGOEIALMIA" field.</summary>
    ...
    /// <summary>Field number for the "NCNHCAFKJOI" field.</summary>
    ...
    /// <summary>Field number for the "FAOCEDDHADJ" field.</summary>
