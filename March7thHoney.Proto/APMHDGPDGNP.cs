...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from APMHDGPDGNP.proto</summary>
  public static partial class APMHDGPDGNPReflection {

    #region Descriptor
    /// <summary>File descriptor for APMHDGPDGNP.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "LPHOAIJFPNP" field.</summary>
    ...
    /// <summary>Field number for the "KFPBACEHAMH" field.</summary>
    ...
    /// <summary>Field number for the "OPDJKKPPPOD" field.</summary>
    ...
    /// <summary>Field number for the "CIMGCEEGDCF" field.</summary>
