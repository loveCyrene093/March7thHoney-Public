...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from ICOMMCAJDLI.proto</summary>
  public static partial class ICOMMCAJDLIReflection {

    #region Descriptor
    /// <summary>File descriptor for ICOMMCAJDLI.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "HMEFIMKFJJB" field.</summary>
    ...
    /// <summary>Field number for the "EFCEICPLOPB" field.</summary>
    ...
    /// <summary>Field number for the "NIJGCFPHOOA" field.</summary>
    ...
    /// <summary>Field number for the "EAFMEDAPBCD" field.</summary>
    ...
    /// <summary>Field number for the "KACLNCHFJBN" field.</summary>
    ...
    /// <summary>Field number for the "OICGDJIFDHH" field.</summary>
    ...
    /// <summary>Field number for the "EDOFNCKDIDF" field.</summary>
    ...
    /// <summary>Field number for the "KNNLHEMFKBN" field.</summary>
    ...
    /// <summary>Field number for the "HONKIOJGMDM" field.</summary>
    ...
    /// <summary>Field number for the "NGDIFOLBLBB" field.</summary>
    ...
    /// <summary>Field number for the "EGLOMNOCOAJ" field.</summary>
    ...
    /// <summary>Field number for the "HEOJMIMGHFN" field.</summary>
    ...
    /// <summary>Field number for the "MKMKIGKMPFP" field.</summary>
    ...
    /// <summary>Field number for the "PLOHJJJFNNJ" field.</summary>
    ...
    /// <summary>Field number for the "AGNHFMGIIAO" field.</summary>
    ...
    /// <summary>Field number for the "PFBBHAMOAGB" field.</summary>
    ...
    /// <summary>Field number for the "EBALDNBOHDC" field.</summary>
    ...
    /// <summary>Field number for the "MLHAOGMNPCJ" field.</summary>
    ...
    /// <summary>Field number for the "JLLBHEPLKKP" field.</summary>
    ...
    /// <summary>Field number for the "ABFIDIHJLHE" field.</summary>
    ...
    /// <summary>Field number for the "FIDLIKNIJAK" field.</summary>
    ...
    /// <summary>Field number for the "KIOBOCMOONH" field.</summary>
    ...
    /// <summary>Field number for the "CLOLHIIJMPH" field.</summary>
    ...
    /// <summary>Field number for the "KMKGHJJIJCN" field.</summary>
    ...
    /// <summary>Field number for the "BCFEJAFMNPF" field.</summary>
    ...
    /// <summary>Field number for the "PFMBIGOLHBL" field.</summary>
    ...
    /// <summary>Field number for the "OIEIBBIIAMI" field.</summary>
    ...
    /// <summary>Field number for the "ALLPJKHDLIB" field.</summary>
    ...
    /// <summary>Field number for the "ODIOMDIDJIK" field.</summary>
    ...
    /// <summary>Field number for the "FOABDDDDFBP" field.</summary>
    ...
    /// <summary>Field number for the "NALNNBECBPA" field.</summary>
    ...
    /// <summary>Field number for the "CDJLDNEDADG" field.</summary>
