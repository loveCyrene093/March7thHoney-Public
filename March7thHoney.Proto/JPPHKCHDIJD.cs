...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from JPPHKCHDIJD.proto</summary>
  public static partial class JPPHKCHDIJDReflection {

    #region Descriptor
    /// <summary>File descriptor for JPPHKCHDIJD.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "GHKJBPIFBAI" field.</summary>
    ...
    /// <summary>Field number for the "NBACGGOFONN" field.</summary>
    ...
    /// <summary>Field number for the "NMLAEMLKBKJ" field.</summary>
