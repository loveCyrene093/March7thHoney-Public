...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from CAIODCNEMHO.proto</summary>
  public static partial class CAIODCNEMHOReflection {

    #region Descriptor
    /// <summary>File descriptor for CAIODCNEMHO.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "IGNNGJMEBHK" field.</summary>
    ...
    /// <summary>Field number for the "DKHKBBMPCIC" field.</summary>
    ...
    /// <summary>Field number for the "HEFFMGAIKMN" field.</summary>
    ...
    /// <summary>Field number for the "AEBKEMDACBM" field.</summary>
    ...
    /// <summary>Field number for the "JFLIGNCAAEJ" field.</summary>
    ...
    /// <summary>Field number for the "AIHNKPOGCFI" field.</summary>
    ...
    /// <summary>Field number for the "IHOONGPLLHJ" field.</summary>
    ...
    /// <summary>Field number for the "IDAPPIBPHHH" field.</summary>
