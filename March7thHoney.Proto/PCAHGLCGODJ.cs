...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from PCAHGLCGODJ.proto</summary>
  public static partial class PCAHGLCGODJReflection {

    #region Descriptor
    /// <summary>File descriptor for PCAHGLCGODJ.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "DCBJNILFBAG" field.</summary>
    ...
    /// <summary>Field number for the "AFPPABBGPKF" field.</summary>
    ...
    /// <summary>Field number for the "DBLKCEDDHIP" field.</summary>
    ...
    /// <summary>Field number for the "LJAPNDAOEEO" field.</summary>
