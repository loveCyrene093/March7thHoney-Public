...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from ENEGIFOKGKL.proto</summary>
  public static partial class ENEGIFOKGKLReflection {

    #region Descriptor
    /// <summary>File descriptor for ENEGIFOKGKL.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "HEIONPDIFNM" field.</summary>
    ...
    /// <summary>Field number for the "HFDIFFBCOGJ" field.</summary>
    ...
    /// <summary>Field number for the "IGECGPFLGBA" field.</summary>
