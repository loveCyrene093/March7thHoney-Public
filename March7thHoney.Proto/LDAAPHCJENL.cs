...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from LDAAPHCJENL.proto</summary>
  public static partial class LDAAPHCJENLReflection {

    #region Descriptor
    /// <summary>File descriptor for LDAAPHCJENL.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "AINGHHOBEHP" field.</summary>
    ...
    /// <summary>Field number for the "DKECAGGAFHD" field.</summary>
    ...
    /// <summary>Field number for the "LKMEDHCBDHK" field.</summary>
