...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from PCHJABAFADH.proto</summary>
  public static partial class PCHJABAFADHReflection {

    #region Descriptor
    /// <summary>File descriptor for PCHJABAFADH.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "ONBLFPHLGNB" field.</summary>
    ...
    /// <summary>Field number for the "NOCOJNOPNJG" field.</summary>
    ...
    /// <summary>Field number for the "PFFIJEHMDHE" field.</summary>
    ...
    /// <summary>Field number for the "IEKICNFCCEP" field.</summary>
    ...
    /// <summary>Field number for the "DPEMFGABBAB" field.</summary>
    ...
    /// <summary>Enum of possible cases for the "MBLKGBAGBKB" oneof.</summary>
