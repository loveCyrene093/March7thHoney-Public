...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from PBNLKJIEFPM.proto</summary>
  public static partial class PBNLKJIEFPMReflection {

    #region Descriptor
    /// <summary>File descriptor for PBNLKJIEFPM.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "INFKCHMNNKJ" field.</summary>
    ...
    /// <summary>Field number for the "INAAOHKEOOE" field.</summary>
    ...
    /// <summary>Field number for the "NOOHOEOCPKE" field.</summary>
