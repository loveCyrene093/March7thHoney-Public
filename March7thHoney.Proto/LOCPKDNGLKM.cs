...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from LOCPKDNGLKM.proto</summary>
  public static partial class LOCPKDNGLKMReflection {

    #region Descriptor
    /// <summary>File descriptor for LOCPKDNGLKM.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "BPMCGKKJGPF" field.</summary>
    ...
    /// <summary>Field number for the "BNFCAAPABCF" field.</summary>
    ...
    /// <summary>Field number for the "FHOLBJGOPGI" field.</summary>
    ...
    /// <summary>Field number for the "DLHLPNLIBAF" field.</summary>
    ...
    /// <summary>Field number for the "ODIACLIKIFP" field.</summary>
    ...
    /// <summary>Field number for the "FLMFHDHFIOJ" field.</summary>
