...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from OMBGOODFIHB.proto</summary>
  public static partial class OMBGOODFIHBReflection {

    #region Descriptor
    /// <summary>File descriptor for OMBGOODFIHB.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "IFLLEKANDCB" field.</summary>
    ...
    /// <summary>Field number for the "EOOKCILKKNB" field.</summary>
    ...
    /// <summary>Field number for the "DHNEEIMLKEJ" field.</summary>
