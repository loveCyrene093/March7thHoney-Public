...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from PGKNFMANPNI.proto</summary>
  public static partial class PGKNFMANPNIReflection {

    #region Descriptor
    /// <summary>File descriptor for PGKNFMANPNI.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "OBOJOIHDCGK" field.</summary>
    ...
    /// <summary>Field number for the "PMMDFFFNFIO" field.</summary>
    ...
    /// <summary>Field number for the "LHENDOOGBCK" field.</summary>
