...
namespace March7thHoney.Proto {
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "NDGMCJHKNIN" field.</summary>
    ...
    /// <summary>Field number for the "DNOIFMMLJDN" field.</summary>
    ...
    /// <summary>Field number for the "GLIFNMBMMBL" field.</summary>
    ...
    /// <summary>Field number for the "LDEDGOOKHFL" field.</summary>
