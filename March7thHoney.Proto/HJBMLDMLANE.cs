...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from HJBMLDMLANE.proto</summary>
  public static partial class HJBMLDMLANEReflection {

    #region Descriptor
    /// <summary>File descriptor for HJBMLDMLANE.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JKLFMOHICMO" field.</summary>
    ...
    /// <summary>Field number for the "EAOFJFAFAHO" field.</summary>
    ...
    /// <summary>Field number for the "DADDPJDAHBN" field.</summary>
    ...
    /// <summary>Field number for the "GJLHKNGLIKB" field.</summary>
    ...
    /// <summary>Field number for the "FFLFIIOMALC" field.</summary>
