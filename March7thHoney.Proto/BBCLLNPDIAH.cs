...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from BBCLLNPDIAH.proto</summary>
  public static partial class BBCLLNPDIAHReflection {

    #region Descriptor
    /// <summary>File descriptor for BBCLLNPDIAH.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "HICPAMOIFOE" field.</summary>
    ...
    /// <summary>Field number for the "BOLMNNMPMNF" field.</summary>
    ...
    /// <summary>Field number for the "KAAGHAPGLCP" field.</summary>
    ...
    /// <summary>Field number for the "ODACHADOJCB" field.</summary>
