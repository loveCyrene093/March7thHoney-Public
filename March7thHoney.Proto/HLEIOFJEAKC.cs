...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from HLEIOFJEAKC.proto</summary>
  public static partial class HLEIOFJEAKCReflection {

    #region Descriptor
    /// <summary>File descriptor for HLEIOFJEAKC.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "HEGNHNFNIOO" field.</summary>
    ...
    /// <summary>Field number for the "IIFLBJNMNBO" field.</summary>
    ...
    /// <summary>Field number for the "HKCEJCNILFD" field.</summary>
    ...
    /// <summary>Field number for the "KHOIDDHNNGO" field.</summary>
    ...
    /// <summary>Field number for the "CPFOCLCFFJF" field.</summary>
    ...
    /// <summary>Field number for the "APDFLLLJABB" field.</summary>
