...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from OKPICJKFILN.proto</summary>
  public static partial class OKPICJKFILNReflection {

    #region Descriptor
    /// <summary>File descriptor for OKPICJKFILN.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "MMBIMPGOGBK" field.</summary>
    ...
    /// <summary>Field number for the "EJMNPLGFFJI" field.</summary>
    ...
    /// <summary>Field number for the "MGFMDOJFDFG" field.</summary>
    ...
    /// <summary>Field number for the "PEJIFFPBLOP" field.</summary>
