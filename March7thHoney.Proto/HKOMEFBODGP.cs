...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from HKOMEFBODGP.proto</summary>
  public static partial class HKOMEFBODGPReflection {

    #region Descriptor
    /// <summary>File descriptor for HKOMEFBODGP.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "FDJMJOKGOMF" field.</summary>
    ...
    /// <summary>Field number for the "IECNCJCANOC" field.</summary>
    ...
    /// <summary>Field number for the "OPLJDFOOMGF" field.</summary>
    ...
    /// <summary>Field number for the "NKGIGKEBODG" field.</summary>
