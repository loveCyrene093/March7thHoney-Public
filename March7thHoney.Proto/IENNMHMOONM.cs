...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from IENNMHMOONM.proto</summary>
  public static partial class IENNMHMOONMReflection {

    #region Descriptor
    /// <summary>File descriptor for IENNMHMOONM.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "NKFDBEHPNLG" field.</summary>
    ...
    /// <summary>Field number for the "JJFNMAIPDEB" field.</summary>
    ...
    /// <summary>Field number for the "KINIKFCKGDF" field.</summary>
