...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from GDKPBDAAKBH.proto</summary>
  public static partial class GDKPBDAAKBHReflection {

    #region Descriptor
    /// <summary>File descriptor for GDKPBDAAKBH.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "MPJPBLLCMHK" field.</summary>
    ...
    /// <summary>Field number for the "DGGAIEANNBJ" field.</summary>
    ...
    /// <summary>Field number for the "IGFHEGBCGBH" field.</summary>
    ...
    /// <summary>Field number for the "FELAADBOAKD" field.</summary>
    ...
    /// <summary>Field number for the "DPEJNGNBHDM" field.</summary>
    ...
    /// <summary>Field number for the "DHFGLLAIFHP" field.</summary>
