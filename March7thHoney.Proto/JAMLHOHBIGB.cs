...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from JAMLHOHBIGB.proto</summary>
  public static partial class JAMLHOHBIGBReflection {

    #region Descriptor
    /// <summary>File descriptor for JAMLHOHBIGB.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "PFJAJKBEPDC" field.</summary>
    ...
    /// <summary>Field number for the "IIPDAIEBIHA" field.</summary>
    ...
    /// <summary>Field number for the "DEMGBJCJGNO" field.</summary>
    ...
    /// <summary>Field number for the "BAEPNAABADN" field.</summary>
    ...
    /// <summary>Field number for the "MHFHODDBOPM" field.</summary>
    ...
    /// <summary>Field number for the "KPCKLNCPPAJ" field.</summary>
    ...
    /// <summary>Field number for the "INFEPNIEPND" field.</summary>
    ...
    /// <summary>Field number for the "BMAJMLOFCKH" field.</summary>
