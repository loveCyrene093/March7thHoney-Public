...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from LLFONBIODFK.proto</summary>
  public static partial class LLFONBIODFKReflection {

    #region Descriptor
    /// <summary>File descriptor for LLFONBIODFK.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "ICHMKFMAIBB" field.</summary>
    ...
    /// <summary>Field number for the "OMFKIFADFOC" field.</summary>
    ...
    /// <summary>Field number for the "JMIKPCPIFCD" field.</summary>
    ...
    /// <summary>Field number for the "BEEMJECDMGB" field.</summary>
    ...
    /// <summary>Field number for the "LNOPKMMELCC" field.</summary>
    ...
    /// <summary>Field number for the "IHONDJOAPBM" field.</summary>
    ...
    /// <summary>Field number for the "JKPGACLKEEC" field.</summary>
    ...
    /// <summary>Field number for the "IIAJPADOLMC" field.</summary>
    ...
    /// <summary>Field number for the "BIODAJLLINO" field.</summary>
