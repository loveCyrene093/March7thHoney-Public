...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from HHIAOANDGAL.proto</summary>
  public static partial class HHIAOANDGALReflection {

    #region Descriptor
    /// <summary>File descriptor for HHIAOANDGAL.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "AJLIIMNDPGL" field.</summary>
    ...
    /// <summary>Field number for the "LAMIOKFJMEF" field.</summary>
    ...
    /// <summary>Field number for the "OLDMKNAIDEL" field.</summary>
