...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from NMBGLKALLBM.proto</summary>
  public static partial class NMBGLKALLBMReflection {

    #region Descriptor
    /// <summary>File descriptor for NMBGLKALLBM.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "LMLFOELDMJD" field.</summary>
    ...
    /// <summary>Field number for the "NIIKHEBEDIG" field.</summary>
    ...
    /// <summary>Field number for the "FMPNNHDPGKD" field.</summary>
    ...
    /// <summary>Field number for the "EKFCLEJNGKE" field.</summary>
    ...
    /// <summary>Field number for the "HEOEKAPBNIE" field.</summary>
    ...
    /// <summary>Field number for the "MEKLIBAPGON" field.</summary>
