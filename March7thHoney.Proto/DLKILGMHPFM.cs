...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from DLKILGMHPFM.proto</summary>
  public static partial class DLKILGMHPFMReflection {

    #region Descriptor
    /// <summary>File descriptor for DLKILGMHPFM.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JHKFKLEGDDO" field.</summary>
    ...
    /// <summary>Field number for the "BCBGCPLEJIO" field.</summary>
    ...
    /// <summary>Field number for the "DMHDJGEBLBM" field.</summary>
    ...
    /// <summary>Field number for the "OHLGEEHPHJL" field.</summary>
    ...
    /// <summary>Field number for the "JEKPBICCDEL" field.</summary>
    ...
    /// <summary>Field number for the "GEDEBJHLGGA" field.</summary>
    ...
    /// <summary>Field number for the "KEIJOPOJGIP" field.</summary>
    ...
    /// <summary>Field number for the "LEOLGONCDKO" field.</summary>
    ...
    /// <summary>Field number for the "FDHBFNANLAH" field.</summary>
