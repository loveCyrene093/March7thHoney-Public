...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from LOHKFKOOEIH.proto</summary>
  public static partial class LOHKFKOOEIHReflection {

    #region Descriptor
    /// <summary>File descriptor for LOHKFKOOEIH.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "NPJIENCGJAH" field.</summary>
    ...
    /// <summary>Field number for the "IFMAEILKJHL" field.</summary>
    ...
    /// <summary>Field number for the "INFGMLPIKEE" field.</summary>
    ...
    /// <summary>Field number for the "NGDMNDEJFJC" field.</summary>
    ...
    /// <summary>Field number for the "JJMCABHIHJB" field.</summary>
    ...
    /// <summary>Field number for the "NLCCLJKBBNJ" field.</summary>
    ...
    /// <summary>Field number for the "PKJKKIOBEOI" field.</summary>
    ...
    /// <summary>Field number for the "EHALEONHDLG" field.</summary>
    ...
    /// <summary>Field number for the "EJCAKDILHPA" field.</summary>
