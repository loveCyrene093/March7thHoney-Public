...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from KAAEBONPKEP.proto</summary>
  public static partial class KAAEBONPKEPReflection {

    #region Descriptor
    /// <summary>File descriptor for KAAEBONPKEP.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JCCOOAEPGED" field.</summary>
    ...
    /// <summary>Field number for the "ENKBFGBBHKP" field.</summary>
    ...
    /// <summary>Field number for the "NHGHEBJCCCO" field.</summary>
