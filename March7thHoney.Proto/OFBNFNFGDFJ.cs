...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from OFBNFNFGDFJ.proto</summary>
  public static partial class OFBNFNFGDFJReflection {

    #region Descriptor
    /// <summary>File descriptor for OFBNFNFGDFJ.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "IDFELNMBDBJ" field.</summary>
    ...
    /// <summary>Field number for the "DGPFGADEBMD" field.</summary>
    ...
    /// <summary>Field number for the "PGINLOFKCMD" field.</summary>
    ...
    /// <summary>Field number for the "DPCBMJGBMGP" field.</summary>
