...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from DLFOGJGCCGP.proto</summary>
  public static partial class DLFOGJGCCGPReflection {

    #region Descriptor
    /// <summary>File descriptor for DLFOGJGCCGP.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "AKGICOFNHON" field.</summary>
    ...
    /// <summary>Field number for the "IAONGEDPLIC" field.</summary>
    ...
    /// <summary>Field number for the "BFIBIHLBLHF" field.</summary>
    ...
    /// <summary>Field number for the "BOLCAEPIHJH" field.</summary>
    ...
    /// <summary>Field number for the "HBEGBPFIJJM" field.</summary>
    ...
    /// <summary>Field number for the "HFOKNODFIJI" field.</summary>
    ...
    /// <summary>Field number for the "ILEMMKPGPND" field.</summary>
