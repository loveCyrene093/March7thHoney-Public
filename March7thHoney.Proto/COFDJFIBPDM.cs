...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from COFDJFIBPDM.proto</summary>
  public static partial class COFDJFIBPDMReflection {

    #region Descriptor
    /// <summary>File descriptor for COFDJFIBPDM.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "BPHAEFAJJKO" field.</summary>
    ...
    /// <summary>Field number for the "GBHJGILIJMP" field.</summary>
    ...
    /// <summary>Field number for the "BPFCEJKNCDP" field.</summary>
