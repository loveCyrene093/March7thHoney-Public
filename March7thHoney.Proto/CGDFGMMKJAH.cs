...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from CGDFGMMKJAH.proto</summary>
  public static partial class CGDFGMMKJAHReflection {

    #region Descriptor
    /// <summary>File descriptor for CGDFGMMKJAH.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JHCMEALPDEB" field.</summary>
    ...
    /// <summary>Field number for the "GFGGMLNLGCA" field.</summary>
    ...
    /// <summary>Field number for the "LHJEJEPGKFH" field.</summary>
    ...
    /// <summary>Field number for the "HKFHEOMPPLJ" field.</summary>
    ...
    /// <summary>Field number for the "OCFJLOCIFBN" field.</summary>
    ...
    /// <summary>Field number for the "KKNNBAGFFGL" field.</summary>
