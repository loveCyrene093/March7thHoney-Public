...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from KPBGMOCCMLA.proto</summary>
  public static partial class KPBGMOCCMLAReflection {

    #region Descriptor
    /// <summary>File descriptor for KPBGMOCCMLA.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "DCKEEAKEOLC" field.</summary>
    ...
    /// <summary>Field number for the "NLBGEBPPDJO" field.</summary>
    ...
    /// <summary>Field number for the "NPHLEPECMAH" field.</summary>
    ...
    /// <summary>Field number for the "MGIHLOHMOJC" field.</summary>
    ...
    /// <summary>Field number for the "JDFDJACPCKC" field.</summary>
    ...
    /// <summary>Field number for the "EOPNFAAPPIO" field.</summary>
    ...
    /// <summary>Field number for the "OPDAJBALNEK" field.</summary>
    ...
    /// <summary>Field number for the "OJPCGMHCEBN" field.</summary>
    ...
    /// <summary>Field number for the "AHAAPPCDLFF" field.</summary>
    ...
    /// <summary>Field number for the "MGMPPOJIGBC" field.</summary>
    ...
    /// <summary>Field number for the "ADMJNJKCDFN" field.</summary>
