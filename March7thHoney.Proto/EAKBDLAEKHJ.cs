...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from EAKBDLAEKHJ.proto</summary>
  public static partial class EAKBDLAEKHJReflection {

    #region Descriptor
    /// <summary>File descriptor for EAKBDLAEKHJ.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "AAIKDELNAKE" field.</summary>
    ...
    /// <summary>Field number for the "LJEIDELEADD" field.</summary>
    ...
    /// <summary>Field number for the "HCPJCIIGMPG" field.</summary>
    ...
    /// <summary>Field number for the "PMNEGOPJOIB" field.</summary>
