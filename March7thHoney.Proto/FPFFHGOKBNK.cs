...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from FPFFHGOKBNK.proto</summary>
  public static partial class FPFFHGOKBNKReflection {

    #region Descriptor
    /// <summary>File descriptor for FPFFHGOKBNK.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "EKDHCCEFJGA" field.</summary>
    ...
    /// <summary>Field number for the "JPKDNCPELDM" field.</summary>
    ...
    /// <summary>Field number for the "PHJCDHKFNPJ" field.</summary>
