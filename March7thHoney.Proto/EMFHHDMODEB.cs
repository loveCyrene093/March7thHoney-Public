...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from EMFHHDMODEB.proto</summary>
  public static partial class EMFHHDMODEBReflection {

    #region Descriptor
    /// <summary>File descriptor for EMFHHDMODEB.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "EAADBOCJNAE" field.</summary>
    ...
    /// <summary>Field number for the "BGPBLOFCPMG" field.</summary>
    ...
    /// <summary>Field number for the "KJDGGNNFGGP" field.</summary>
    ...
    /// <summary>Field number for the "IGFEAHIKKPE" field.</summary>
    ...
    /// <summary>Field number for the "NEMFNMIPNAO" field.</summary>
