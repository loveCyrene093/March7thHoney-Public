...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from ANIOMKDCOEP.proto</summary>
  public static partial class ANIOMKDCOEPReflection {

    #region Descriptor
    /// <summary>File descriptor for ANIOMKDCOEP.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "BDMNHFNKMDA" field.</summary>
    ...
    /// <summary>Field number for the "EBKLPKNANLN" field.</summary>
    ...
    /// <summary>Field number for the "FDMEFIIJLCK" field.</summary>
    ...
    /// <summary>Field number for the "AAABOOFAFLJ" field.</summary>
