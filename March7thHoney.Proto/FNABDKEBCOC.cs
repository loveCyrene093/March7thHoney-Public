...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from FNABDKEBCOC.proto</summary>
  public static partial class FNABDKEBCOCReflection {

    #region Descriptor
    /// <summary>File descriptor for FNABDKEBCOC.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "OOPCHIHIIFE" field.</summary>
    ...
    /// <summary>Field number for the "ALCBHJEMCPC" field.</summary>
    ...
    /// <summary>Field number for the "ODHJKLKICFL" field.</summary>
    ...
    /// <summary>Field number for the "JHKMLGJKIIM" field.</summary>
    ...
    /// <summary>Field number for the "GFDDBPAEAOI" field.</summary>
