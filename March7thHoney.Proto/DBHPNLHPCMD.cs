...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from DBHPNLHPCMD.proto</summary>
  public static partial class DBHPNLHPCMDReflection {

    #region Descriptor
    /// <summary>File descriptor for DBHPNLHPCMD.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "HNCDMHIDIJL" field.</summary>
    ...
    /// <summary>Field number for the "ILCHDGKODPE" field.</summary>
    ...
    /// <summary>Field number for the "APHJPJBIMFB" field.</summary>
    ...
    /// <summary>Field number for the "FKEGAIHNODE" field.</summary>
    ...
    /// <summary>Field number for the "NFGFPMEKPHN" field.</summary>
