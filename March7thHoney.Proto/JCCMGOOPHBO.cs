...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from JCCMGOOPHBO.proto</summary>
  public static partial class JCCMGOOPHBOReflection {

    #region Descriptor
    /// <summary>File descriptor for JCCMGOOPHBO.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "HDGHCOJICEG" field.</summary>
    ...
    /// <summary>Field number for the "MLPGGIPCNGF" field.</summary>
    ...
    /// <summary>Field number for the "DEKNGNHLFNI" field.</summary>
