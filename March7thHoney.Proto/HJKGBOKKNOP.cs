...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from HJKGBOKKNOP.proto</summary>
  public static partial class HJKGBOKKNOPReflection {

    #region Descriptor
    /// <summary>File descriptor for HJKGBOKKNOP.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "MCHAFKKFEDK" field.</summary>
    ...
    /// <summary>Field number for the "EJALOMHNGCJ" field.</summary>
    ...
    /// <summary>Field number for the "KOOHHHAOBEO" field.</summary>
    ...
    /// <summary>Field number for the "OPIDHKEKPKB" field.</summary>
    ...
    /// <summary>Field number for the "GJMAPDBGEPA" field.</summary>
    ...
    /// <summary>Field number for the "NICEPKDHFDE" field.</summary>
    ...
    /// <summary>Field number for the "MMINJCFNADK" field.</summary>
    ...
    /// <summary>Field number for the "JMCGDOCIKGB" field.</summary>
    ...
    /// <summary>Field number for the "CHPFCFGNCAG" field.</summary>
    ...
    /// <summary>Field number for the "MDHOHBHBGNC" field.</summary>
    ...
    /// <summary>Field number for the "OJAPMNAPIFG" field.</summary>
    ...
    /// <summary>Field number for the "LDMEEJCCKIH" field.</summary>
