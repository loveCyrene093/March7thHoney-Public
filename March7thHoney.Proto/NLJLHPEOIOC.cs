...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from NLJLHPEOIOC.proto</summary>
  public static partial class NLJLHPEOIOCReflection {

    #region Descriptor
    /// <summary>File descriptor for NLJLHPEOIOC.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "FCLBGGPJGCE" field.</summary>
    ...
    /// <summary>Field number for the "HAAAPFLGNBM" field.</summary>
    ...
    /// <summary>Field number for the "HNOFDLBBHHF" field.</summary>
    ...
    /// <summary>Field number for the "LKCCKBKNKBP" field.</summary>
    ...
    /// <summary>Field number for the "HJKAPBEMEOO" field.</summary>
