...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from CMHAMBKCJBK.proto</summary>
  public static partial class CMHAMBKCJBKReflection {

    #region Descriptor
    /// <summary>File descriptor for CMHAMBKCJBK.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JDPANINJAEC" field.</summary>
    ...
    /// <summary>Field number for the "MMFPEGPHOEC" field.</summary>
    ...
    /// <summary>Field number for the "DHNCNLFMOLI" field.</summary>
