...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from NBBCCKMKJNE.proto</summary>
  public static partial class NBBCCKMKJNEReflection {

    #region Descriptor
    /// <summary>File descriptor for NBBCCKMKJNE.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "OPIBBDHMCGO" field.</summary>
    ...
    /// <summary>Field number for the "DHNDLHLNMJB" field.</summary>
    ...
    /// <summary>Field number for the "FJGCNBDBMMG" field.</summary>
    ...
    /// <summary>Field number for the "BKAANCLCOAH" field.</summary>
    ...
    /// <summary>Field number for the "LBPBGNJFAIO" field.</summary>
    ...
    /// <summary>Field number for the "CHDNOCOLLHJ" field.</summary>
    ...
    /// <summary>Field number for the "IACHBBGOHLH" field.</summary>
    ...
    /// <summary>Field number for the "PHHLMDICENJ" field.</summary>
    ...
    /// <summary>Field number for the "CHODEHNFCLJ" field.</summary>
    ...
    /// <summary>Field number for the "PLIJJNGPEIM" field.</summary>
    ...
    /// <summary>Field number for the "CBKNDPBFBJL" field.</summary>
    ...
    /// <summary>Field number for the "IMKAOJLJIDK" field.</summary>
    ...
    /// <summary>Field number for the "LFBBONLCFPH" field.</summary>
    ...
    /// <summary>Field number for the "LMPNJDMGOBB" field.</summary>
    ...
    /// <summary>Field number for the "GENOMEOLOJB" field.</summary>
    ...
    /// <summary>Field number for the "OLDBJILBGLD" field.</summary>
    ...
    /// <summary>Field number for the "OOPMDDKLNKP" field.</summary>
    ...
    /// <summary>Field number for the "DNGGPHPOHHD" field.</summary>
    ...
    /// <summary>Field number for the "DKIACFLBEKD" field.</summary>
    ...
    /// <summary>Field number for the "FCBFCDAGFOA" field.</summary>
