...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from NAKIGLPGKBA.proto</summary>
  public static partial class NAKIGLPGKBAReflection {

    #region Descriptor
    /// <summary>File descriptor for NAKIGLPGKBA.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "EHNCLFLKMFA" field.</summary>
    ...
    /// <summary>Field number for the "EOOIGCCKGFB" field.</summary>
    ...
    /// <summary>Field number for the "GKBENCDFCEJ" field.</summary>
    ...
    /// <summary>Field number for the "CKIHBDKDOEJ" field.</summary>
    ...
    /// <summary>Field number for the "PPEPAPCEPCM" field.</summary>
    ...
    /// <summary>Field number for the "MFNIOBKFBKF" field.</summary>
