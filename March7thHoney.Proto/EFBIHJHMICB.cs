...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from EFBIHJHMICB.proto</summary>
  public static partial class EFBIHJHMICBReflection {

    #region Descriptor
    /// <summary>File descriptor for EFBIHJHMICB.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "DBOJCHBAHCI" field.</summary>
    ...
    /// <summary>Field number for the "FECOBCLAAMA" field.</summary>
    ...
    /// <summary>Field number for the "CMBPMIHGHAK" field.</summary>
    ...
    /// <summary>Field number for the "NBFJKDONMDF" field.</summary>
