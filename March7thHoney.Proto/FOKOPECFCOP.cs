...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from FOKOPECFCOP.proto</summary>
  public static partial class FOKOPECFCOPReflection {

    #region Descriptor
    /// <summary>File descriptor for FOKOPECFCOP.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "ENNGNAMEBJC" field.</summary>
    ...
    /// <summary>Field number for the "KDFMIFKALKH" field.</summary>
    ...
    /// <summary>Field number for the "GPONHJHHMBB" field.</summary>
