...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from OPGJPLKHLKJ.proto</summary>
  public static partial class OPGJPLKHLKJReflection {

    #region Descriptor
    /// <summary>File descriptor for OPGJPLKHLKJ.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "DJJNGGFBAOG" field.</summary>
    ...
    /// <summary>Field number for the "PPGOFLDJPIO" field.</summary>
    ...
    /// <summary>Field number for the "FJBFCPBLNLE" field.</summary>
    ...
    /// <summary>Field number for the "BEDKAHEBGCC" field.</summary>
    ...
    /// <summary>Field number for the "IOJKDGCFCGG" field.</summary>
    ...
    /// <summary>Field number for the "GLDAEMLKJJH" field.</summary>
    ...
    /// <summary>Field number for the "ADCJOJMPNPH" field.</summary>
    ...
    /// <summary>Field number for the "HLJPCIDLCKA" field.</summary>
    ...
    /// <summary>Field number for the "GDOHPMLEMAE" field.</summary>
    ...
    /// <summary>Field number for the "GHIBGEBPOCG" field.</summary>
    ...
    /// <summary>Field number for the "ADAPELOIGCI" field.</summary>
    ...
    /// <summary>Field number for the "GBLEFAMKILB" field.</summary>
