...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from BPJDOEMBNMD.proto</summary>
  public static partial class BPJDOEMBNMDReflection {

    #region Descriptor
    /// <summary>File descriptor for BPJDOEMBNMD.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JAKFADADNON" field.</summary>
    ...
    /// <summary>Field number for the "FHECFHDHFJC" field.</summary>
    ...
    /// <summary>Field number for the "JBBACLLCFON" field.</summary>
    ...
    /// <summary>Enum of possible cases for the "FLBCMACPHMJ" oneof.</summary>
