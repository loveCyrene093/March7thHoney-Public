...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from NCHLAEEOBIF.proto</summary>
  public static partial class NCHLAEEOBIFReflection {

    #region Descriptor
    /// <summary>File descriptor for NCHLAEEOBIF.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JAAHELCLHMI" field.</summary>
    ...
    /// <summary>Field number for the "GMDHPHLIMAG" field.</summary>
    ...
    /// <summary>Field number for the "EBFBLMKIOAI" field.</summary>
    ...
    /// <summary>Field number for the "BFNPCJOMGFL" field.</summary>
    ...
    /// <summary>Field number for the "IAAAADCLFLF" field.</summary>
    ...
    /// <summary>Field number for the "EMGENIILJMC" field.</summary>
    ...
    /// <summary>Field number for the "OGODDOIGOJE" field.</summary>
    ...
    /// <summary>Field number for the "JPGFLKDLOOP" field.</summary>
    ...
    /// <summary>Field number for the "OPBCCIBECMI" field.</summary>
