...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from CEDGNIIEIMC.proto</summary>
  public static partial class CEDGNIIEIMCReflection {

    #region Descriptor
    /// <summary>File descriptor for CEDGNIIEIMC.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "PCGJFIFLKOO" field.</summary>
    ...
    /// <summary>Field number for the "JNKBKOCJCKJ" field.</summary>
    ...
    /// <summary>Field number for the "FFEACPDFAJH" field.</summary>
    ...
    /// <summary>Field number for the "GBMBMFFNKEH" field.</summary>
    ...
    /// <summary>Field number for the "CEOFDMCJAPJ" field.</summary>
