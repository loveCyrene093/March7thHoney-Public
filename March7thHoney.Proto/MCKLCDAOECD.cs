...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from MCKLCDAOECD.proto</summary>
  public static partial class MCKLCDAOECDReflection {

    #region Descriptor
    /// <summary>File descriptor for MCKLCDAOECD.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "KHCJONFAPMK" field.</summary>
    ...
    /// <summary>Field number for the "FJIKIPDJOPK" field.</summary>
    ...
    /// <summary>Field number for the "JIODDAHNMEL" field.</summary>
    ...
    /// <summary>Field number for the "BPDJGGBGMMM" field.</summary>
    ...
    /// <summary>Field number for the "JOOCDKJFDBA" field.</summary>
    ...
    /// <summary>Field number for the "PCCOGCPBFLL" field.</summary>
    ...
    /// <summary>Field number for the "CKHIFLBFFLC" field.</summary>
