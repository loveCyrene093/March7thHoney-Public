...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from CGOENENKKCG.proto</summary>
  public static partial class CGOENENKKCGReflection {

    #region Descriptor
    /// <summary>File descriptor for CGOENENKKCG.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "OFAOIMCDHPN" field.</summary>
    ...
    /// <summary>Field number for the "LMHACIOCIHE" field.</summary>
    ...
    /// <summary>Field number for the "AMKNINAOAHB" field.</summary>
    ...
    /// <summary>Field number for the "IAKFBGEHOFN" field.</summary>
    ...
    /// <summary>Field number for the "OGNANLCFNPD" field.</summary>
    ...
    /// <summary>Field number for the "DONHDAPCJNN" field.</summary>
    ...
    /// <summary>Enum of possible cases for the "GIBNHMDHIJK" oneof.</summary>
