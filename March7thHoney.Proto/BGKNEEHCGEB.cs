...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from BGKNEEHCGEB.proto</summary>
  public static partial class BGKNEEHCGEBReflection {

    #region Descriptor
    /// <summary>File descriptor for BGKNEEHCGEB.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JHLGEDGMPGE" field.</summary>
    ...
    /// <summary>Field number for the "MGFOHPHEHAP" field.</summary>
    ...
    /// <summary>Field number for the "CCMLPIEILEG" field.</summary>
