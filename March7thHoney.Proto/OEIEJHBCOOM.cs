...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from OEIEJHBCOOM.proto</summary>
  public static partial class OEIEJHBCOOMReflection {

    #region Descriptor
    /// <summary>File descriptor for OEIEJHBCOOM.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "MBOEFLAHLEM" field.</summary>
    ...
    /// <summary>Field number for the "PAPOKACIPPJ" field.</summary>
    ...
    /// <summary>Field number for the "DGOMHDMJHEK" field.</summary>
    ...
    /// <summary>Field number for the "IPLLMNPANID" field.</summary>
