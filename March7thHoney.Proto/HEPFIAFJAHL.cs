...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from HEPFIAFJAHL.proto</summary>
  public static partial class HEPFIAFJAHLReflection {

    #region Descriptor
    /// <summary>File descriptor for HEPFIAFJAHL.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "DJBLFGFDNCA" field.</summary>
    ...
    /// <summary>Field number for the "BNAMECLCJAK" field.</summary>
    ...
    /// <summary>Field number for the "DOGFDDNCFOP" field.</summary>
