...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from NCBLOBPPIBD.proto</summary>
  public static partial class NCBLOBPPIBDReflection {

    #region Descriptor
    /// <summary>File descriptor for NCBLOBPPIBD.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "BEKCHIMDNJG" field.</summary>
    ...
    /// <summary>Field number for the "MMIIINJDLAM" field.</summary>
    ...
    /// <summary>Field number for the "CKJECOHKCLL" field.</summary>
    ...
    /// <summary>Field number for the "GEPGGGDKBNK" field.</summary>
    ...
    /// <summary>Field number for the "GLCOINHKHMM" field.</summary>
    ...
    /// <summary>Field number for the "EAPLGIOFDDG" field.</summary>
