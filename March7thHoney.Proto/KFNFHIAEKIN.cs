...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from KFNFHIAEKIN.proto</summary>
  public static partial class KFNFHIAEKINReflection {

    #region Descriptor
    /// <summary>File descriptor for KFNFHIAEKIN.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "FPOIEFHOHIN" field.</summary>
    ...
    /// <summary>Field number for the "NEBPANIDIMG" field.</summary>
    ...
    /// <summary>Field number for the "EFGGDDEALGM" field.</summary>
    ...
    /// <summary>Field number for the "AKABDDGNLCP" field.</summary>
