...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from IBFOFJCOAFF.proto</summary>
  public static partial class IBFOFJCOAFFReflection {

    #region Descriptor
    /// <summary>File descriptor for IBFOFJCOAFF.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "PEFLHKMBOCM" field.</summary>
    ...
    /// <summary>Field number for the "AAOGKKKEIIL" field.</summary>
    ...
    /// <summary>Field number for the "HAHHPFOLAIG" field.</summary>
    ...
    /// <summary>Field number for the "MEHBFKDFGNF" field.</summary>
    ...
    /// <summary>Field number for the "CGIPDJCNFLJ" field.</summary>
    ...
    /// <summary>Field number for the "FJNPLPNIFBA" field.</summary>
