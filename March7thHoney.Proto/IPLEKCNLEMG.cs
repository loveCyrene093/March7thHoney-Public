...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from IPLEKCNLEMG.proto</summary>
  public static partial class IPLEKCNLEMGReflection {

    #region Descriptor
    /// <summary>File descriptor for IPLEKCNLEMG.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "KPOOFBPGMLN" field.</summary>
    ...
    /// <summary>Field number for the "IBOPJGBFCJI" field.</summary>
    ...
    /// <summary>Field number for the "PNHOEDHBGNM" field.</summary>
    ...
    /// <summary>Field number for the "FIKFMPBHIHM" field.</summary>
