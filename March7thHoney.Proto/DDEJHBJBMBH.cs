...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from DDEJHBJBMBH.proto</summary>
  public static partial class DDEJHBJBMBHReflection {

    #region Descriptor
    /// <summary>File descriptor for DDEJHBJBMBH.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "LOHJDJICMFJ" field.</summary>
    ...
    /// <summary>Field number for the "KOLOCKHJEDK" field.</summary>
    ...
    /// <summary>Field number for the "DOCEBPCDLJK" field.</summary>
    ...
    /// <summary>Field number for the "LEFOJLCJEEJ" field.</summary>
    ...
    /// <summary>Field number for the "FCHPJKAIBHB" field.</summary>
