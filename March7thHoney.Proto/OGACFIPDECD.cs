...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from OGACFIPDECD.proto</summary>
  public static partial class OGACFIPDECDReflection {

    #region Descriptor
    /// <summary>File descriptor for OGACFIPDECD.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JMNOPLMHJLE" field.</summary>
    ...
    /// <summary>Field number for the "ALJIBCCDHPJ" field.</summary>
    ...
    /// <summary>Field number for the "ODMBJOHLADG" field.</summary>
