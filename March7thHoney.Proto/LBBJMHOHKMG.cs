...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from LBBJMHOHKMG.proto</summary>
  public static partial class LBBJMHOHKMGReflection {

    #region Descriptor
    /// <summary>File descriptor for LBBJMHOHKMG.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "HJLIECDFDLJ" field.</summary>
    ...
    /// <summary>Field number for the "MBMICCJEBJB" field.</summary>
    ...
    /// <summary>Field number for the "IFDBIMBMFGO" field.</summary>
    ...
    /// <summary>Field number for the "EAEGHDGJHGB" field.</summary>
    ...
    /// <summary>Field number for the "MNMPDJADEFP" field.</summary>
    ...
    /// <summary>Field number for the "LCCPLPKPPJL" field.</summary>
    ...
    /// <summary>Field number for the "EJGPPEFEGMK" field.</summary>
    ...
    /// <summary>Field number for the "GKMJLEKGBPN" field.</summary>
    ...
    /// <summary>Field number for the "OEDLCAKBFDK" field.</summary>
    ...
    /// <summary>Field number for the "LCGOAPAHENH" field.</summary>
    ...
    /// <summary>Field number for the "PCPOHHAHCCJ" field.</summary>
    ...
    /// <summary>Field number for the "JFGBLMMFODF" field.</summary>
    ...
    /// <summary>Field number for the "MBCEAEPNPOO" field.</summary>
    ...
    /// <summary>Field number for the "KMLAKHPCFFE" field.</summary>
    ...
    /// <summary>Field number for the "NICGPEENIPC" field.</summary>
    ...
    /// <summary>Field number for the "BBNAINMBBEI" field.</summary>
    ...
    /// <summary>Field number for the "EOEAOHIIKBB" field.</summary>
    ...
    /// <summary>Field number for the "GOKIIDCGHJK" field.</summary>
