...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from PLIEEDKHGNN.proto</summary>
  public static partial class PLIEEDKHGNNReflection {

    #region Descriptor
    /// <summary>File descriptor for PLIEEDKHGNN.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "DGLIPLAHMBF" field.</summary>
    ...
    /// <summary>Field number for the "CAJCAGNBGEK" field.</summary>
    ...
    /// <summary>Field number for the "HCAFCGKLKFD" field.</summary>
    ...
    /// <summary>Field number for the "ADDEMHFJJAH" field.</summary>
    ...
    /// <summary>Field number for the "JLDPAIPAMNB" field.</summary>
    ...
    /// <summary>Field number for the "BMGEBFHHCOD" field.</summary>
