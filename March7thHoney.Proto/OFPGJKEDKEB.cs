...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from OFPGJKEDKEB.proto</summary>
  public static partial class OFPGJKEDKEBReflection {

    #region Descriptor
    /// <summary>File descriptor for OFPGJKEDKEB.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "ANLLMAPBJFN" field.</summary>
    ...
    /// <summary>Field number for the "DJGAPFPHFII" field.</summary>
    ...
    /// <summary>Field number for the "MBOGNPKAMIF" field.</summary>
    ...
    /// <summary>Field number for the "BDPHIHBLJON" field.</summary>
