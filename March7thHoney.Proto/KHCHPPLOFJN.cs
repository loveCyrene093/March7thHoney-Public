...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from KHCHPPLOFJN.proto</summary>
  public static partial class KHCHPPLOFJNReflection {

    #region Descriptor
    /// <summary>File descriptor for KHCHPPLOFJN.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "ANLBKEJPHFK" field.</summary>
    ...
    /// <summary>Field number for the "PIHGDHAKLCB" field.</summary>
    ...
    /// <summary>Enum of possible cases for the "EPIIJJCAKIE" oneof.</summary>
