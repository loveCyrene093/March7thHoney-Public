...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from EDGGKGPFLNP.proto</summary>
  public static partial class EDGGKGPFLNPReflection {

    #region Descriptor
    /// <summary>File descriptor for EDGGKGPFLNP.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "KOPHOHJFCCK" field.</summary>
    ...
    /// <summary>Field number for the "JLCEEEBNEOL" field.</summary>
    ...
    /// <summary>Field number for the "MJGMDMFHKBI" field.</summary>
    ...
    /// <summary>Field number for the "NFJKKKJIIPF" field.</summary>
    ...
    /// <summary>Field number for the "HGIJNGPMCDH" field.</summary>
