...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from OGEOMDJIAGI.proto</summary>
  public static partial class OGEOMDJIAGIReflection {

    #region Descriptor
    /// <summary>File descriptor for OGEOMDJIAGI.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "PIDIGFGKAMK" field.</summary>
    ...
    /// <summary>Field number for the "ANBBPPHBCJH" field.</summary>
    ...
    /// <summary>Field number for the "LFKBMDHKPFI" field.</summary>
    ...
    /// <summary>Field number for the "OIHHKOJFHFG" field.</summary>
    ...
    /// <summary>Field number for the "OOPPKDAFFDG" field.</summary>
    ...
    /// <summary>Field number for the "BBDOCJGAEEJ" field.</summary>
    ...
    /// <summary>Field number for the "HDCAEIKAPND" field.</summary>
    ...
    /// <summary>Field number for the "FMOJNJIFKEN" field.</summary>
