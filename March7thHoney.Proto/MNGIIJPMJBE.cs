...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from MNGIIJPMJBE.proto</summary>
  public static partial class MNGIIJPMJBEReflection {

    #region Descriptor
    /// <summary>File descriptor for MNGIIJPMJBE.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JAAMMNLMJCG" field.</summary>
    ...
    /// <summary>Field number for the "EAKBDLKIEFC" field.</summary>
    ...
    /// <summary>Field number for the "FFIOFGADINM" field.</summary>
