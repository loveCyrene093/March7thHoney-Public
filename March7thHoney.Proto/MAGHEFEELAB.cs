...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from MAGHEFEELAB.proto</summary>
  public static partial class MAGHEFEELABReflection {

    #region Descriptor
    /// <summary>File descriptor for MAGHEFEELAB.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "EJOMFAHEMNH" field.</summary>
    ...
    /// <summary>Field number for the "ADKBEOPNBIO" field.</summary>
    ...
    /// <summary>Field number for the "GFNCKBGNLNC" field.</summary>
    ...
    /// <summary>Field number for the "ECCGJDMOGAN" field.</summary>
