...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from OOMINGEFPAF.proto</summary>
  public static partial class OOMINGEFPAFReflection {

    #region Descriptor
    /// <summary>File descriptor for OOMINGEFPAF.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "PAAJDLBBIKG" field.</summary>
    ...
    /// <summary>Field number for the "IGIEHEOCMJL" field.</summary>
    ...
    /// <summary>Field number for the "BKNPPAEOLJH" field.</summary>
    ...
    /// <summary>Field number for the "NGBACICAAPO" field.</summary>
    ...
    /// <summary>Field number for the "JJOGGBIOIKB" field.</summary>
    ...
    /// <summary>Field number for the "PILPAGJEENB" field.</summary>
    ...
    /// <summary>Field number for the "BKMEDGFOMKF" field.</summary>
