...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from KLMKLDONEJG.proto</summary>
  public static partial class KLMKLDONEJGReflection {

    #region Descriptor
    /// <summary>File descriptor for KLMKLDONEJG.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "IHPGCAAAGBC" field.</summary>
    ...
    /// <summary>Field number for the "GIKABEMCFAO" field.</summary>
    ...
    /// <summary>Field number for the "KHDKNKLJGOJ" field.</summary>
