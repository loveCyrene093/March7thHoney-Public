...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from FEDEIOIJJJC.proto</summary>
  public static partial class FEDEIOIJJJCReflection {

    #region Descriptor
    /// <summary>File descriptor for FEDEIOIJJJC.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "PJCIONEPINE" field.</summary>
    ...
    /// <summary>Field number for the "EDMBIKHBICG" field.</summary>
    ...
    /// <summary>Field number for the "KPNEPNELPNH" field.</summary>
    ...
    /// <summary>Field number for the "NLBKDNKGBCK" field.</summary>
    ...
    /// <summary>Field number for the "CEIMNDJFDJD" field.</summary>
    ...
    /// <summary>Field number for the "EFJLGEAAHEK" field.</summary>
    ...
    /// <summary>Field number for the "ELGFFACNECK" field.</summary>
