...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from PMCGOFCMHHA.proto</summary>
  public static partial class PMCGOFCMHHAReflection {

    #region Descriptor
    /// <summary>File descriptor for PMCGOFCMHHA.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "BFLHMIDIFKF" field.</summary>
    ...
    /// <summary>Field number for the "MMOJOECDMIL" field.</summary>
    ...
    /// <summary>Field number for the "EPAINHHNBLO" field.</summary>
    ...
    /// <summary>Field number for the "GIJOAADKDIN" field.</summary>
