...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from JCEEENOLDIF.proto</summary>
  public static partial class JCEEENOLDIFReflection {

    #region Descriptor
    /// <summary>File descriptor for JCEEENOLDIF.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "CMAPCGGABJI" field.</summary>
    ...
    /// <summary>Field number for the "GHAIGLAHMHO" field.</summary>
    ...
    /// <summary>Field number for the "PNIDNOGHMBH" field.</summary>
    ...
    /// <summary>Field number for the "HAFFDDDPFGA" field.</summary>
