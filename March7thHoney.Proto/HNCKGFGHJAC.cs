...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from HNCKGFGHJAC.proto</summary>
  public static partial class HNCKGFGHJACReflection {

    #region Descriptor
    /// <summary>File descriptor for HNCKGFGHJAC.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JHADMBDCPEO" field.</summary>
    ...
    /// <summary>Field number for the "MELANHHFEMK" field.</summary>
    ...
    /// <summary>Field number for the "PDEAIMNIAPI" field.</summary>
