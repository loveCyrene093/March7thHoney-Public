...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from IDHCKCDAEBA.proto</summary>
  public static partial class IDHCKCDAEBAReflection {

    #region Descriptor
    /// <summary>File descriptor for IDHCKCDAEBA.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "OIJDLFINILC" field.</summary>
    ...
    /// <summary>Field number for the "CGMGJOGIMGH" field.</summary>
    ...
    /// <summary>Field number for the "INHKPNNKMNJ" field.</summary>
