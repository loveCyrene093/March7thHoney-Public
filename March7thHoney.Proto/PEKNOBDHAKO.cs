...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from PEKNOBDHAKO.proto</summary>
  public static partial class PEKNOBDHAKOReflection {

    #region Descriptor
    /// <summary>File descriptor for PEKNOBDHAKO.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "MGMFENIOPHO" field.</summary>
    ...
    /// <summary>Field number for the "MHNBGKJLDGB" field.</summary>
    ...
    /// <summary>Field number for the "NCCNKHELPKL" field.</summary>
    ...
    /// <summary>Field number for the "IFHGNHGAPIN" field.</summary>
    ...
    /// <summary>Field number for the "NAOKLIALCEN" field.</summary>
    ...
    /// <summary>Field number for the "KFPKHHAOGPP" field.</summary>
    ...
    /// <summary>Field number for the "IIHECADEHNG" field.</summary>
    ...
    /// <summary>Enum of possible cases for the "MFKJOHBNBJA" oneof.</summary>
