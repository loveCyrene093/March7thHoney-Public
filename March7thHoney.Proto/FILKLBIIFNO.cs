...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from FILKLBIIFNO.proto</summary>
  public static partial class FILKLBIIFNOReflection {

    #region Descriptor
    /// <summary>File descriptor for FILKLBIIFNO.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "IPMGLMJFGNP" field.</summary>
    ...
    /// <summary>Field number for the "FCLMNMMGCMJ" field.</summary>
    ...
    /// <summary>Field number for the "IJPDHNCJBOK" field.</summary>
