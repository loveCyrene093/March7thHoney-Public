...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from BBPCCHGJCPF.proto</summary>
  public static partial class BBPCCHGJCPFReflection {

    #region Descriptor
    /// <summary>File descriptor for BBPCCHGJCPF.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "BNGODBNJBCO" field.</summary>
    ...
    /// <summary>Field number for the "NNIFJPLBDKC" field.</summary>
    ...
    /// <summary>Field number for the "IFKKGMFLFJK" field.</summary>
    ...
    /// <summary>Field number for the "IJDKOIAAILG" field.</summary>
    ...
    /// <summary>Field number for the "ADIICGEBJOG" field.</summary>
    ...
    /// <summary>Field number for the "POJFLLOOPLF" field.</summary>
    ...
    /// <summary>Field number for the "NJELMEOOIGN" field.</summary>
