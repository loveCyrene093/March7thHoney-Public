...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from AOIKHPOBDGK.proto</summary>
  public static partial class AOIKHPOBDGKReflection {

    #region Descriptor
    /// <summary>File descriptor for AOIKHPOBDGK.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "ABAMHIFECNP" field.</summary>
    ...
    /// <summary>Field number for the "KKCFOIMCLCD" field.</summary>
    ...
    /// <summary>Field number for the "BKPDBCAAGAE" field.</summary>
    ...
    /// <summary>Field number for the "PKAJLLIKJPL" field.</summary>
