...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from IJOKCGLBBMI.proto</summary>
  public static partial class IJOKCGLBBMIReflection {

    #region Descriptor
    /// <summary>File descriptor for IJOKCGLBBMI.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "NEKJKMKEJLJ" field.</summary>
    ...
    /// <summary>Field number for the "NHGPIMOFEKB" field.</summary>
    ...
    /// <summary>Field number for the "DHFKOKJIBNE" field.</summary>
    ...
    /// <summary>Field number for the "EJGNGLILFCP" field.</summary>
    ...
    /// <summary>Field number for the "ELGOICHACDN" field.</summary>
