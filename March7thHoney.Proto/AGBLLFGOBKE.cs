...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from AGBLLFGOBKE.proto</summary>
  public static partial class AGBLLFGOBKEReflection {

    #region Descriptor
    /// <summary>File descriptor for AGBLLFGOBKE.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JFFIKCFLBCH" field.</summary>
    ...
    /// <summary>Field number for the "IFDKELBKILF" field.</summary>
    ...
    /// <summary>Field number for the "ABCKMKFKAHB" field.</summary>
