...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from DFKGECLBCDK.proto</summary>
  public static partial class DFKGECLBCDKReflection {

    #region Descriptor
    /// <summary>File descriptor for DFKGECLBCDK.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "EDGEHIDLDBF" field.</summary>
    ...
    /// <summary>Field number for the "BCGCGHEPDEA" field.</summary>
    ...
    /// <summary>Field number for the "FANOLNOMHFI" field.</summary>
