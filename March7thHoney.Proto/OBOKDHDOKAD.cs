...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from OBOKDHDOKAD.proto</summary>
  public static partial class OBOKDHDOKADReflection {

    #region Descriptor
    /// <summary>File descriptor for OBOKDHDOKAD.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "CEKCLDPNFEA" field.</summary>
    ...
    /// <summary>Field number for the "GECPCNOMFFG" field.</summary>
    ...
    /// <summary>Field number for the "JCHFMDEPBMK" field.</summary>
    ...
    /// <summary>Field number for the "NPBKMKIPKOH" field.</summary>
    ...
    /// <summary>Field number for the "CBPBCDPJOKO" field.</summary>
    ...
    /// <summary>Field number for the "IIOBBODPCKN" field.</summary>
    ...
    /// <summary>Field number for the "ELBALPJIPNK" field.</summary>
    ...
    /// <summary>Field number for the "JNBMENGEDFC" field.</summary>
    ...
    /// <summary>Field number for the "BCCFDCELEKI" field.</summary>
    ...
    /// <summary>Field number for the "FKDOIKIMHAO" field.</summary>
    ...
    /// <summary>Field number for the "NCKJEPIODAD" field.</summary>
