...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from DKFAEKPKADH.proto</summary>
  public static partial class DKFAEKPKADHReflection {

    #region Descriptor
    /// <summary>File descriptor for DKFAEKPKADH.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "BFNLCFMDDJH" field.</summary>
    ...
    /// <summary>Field number for the "DKHLLGOIHKH" field.</summary>
    ...
    /// <summary>Field number for the "FGAAPCNNMIP" field.</summary>
    ...
    /// <summary>Field number for the "MEAJAEBDAOI" field.</summary>
    ...
    /// <summary>Field number for the "OLNOIIEDKEP" field.</summary>
    ...
    /// <summary>Field number for the "AFHBNKOHHHB" field.</summary>
