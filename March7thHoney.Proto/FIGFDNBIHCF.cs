...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from FIGFDNBIHCF.proto</summary>
  public static partial class FIGFDNBIHCFReflection {

    #region Descriptor
    /// <summary>File descriptor for FIGFDNBIHCF.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "HIOFNIHMFAM" field.</summary>
    ...
    /// <summary>Field number for the "PNDECPCKLHG" field.</summary>
    ...
    /// <summary>Field number for the "KLOBDDIJNHG" field.</summary>
    ...
    /// <summary>Field number for the "FJNLJOBOONH" field.</summary>
    ...
    /// <summary>Field number for the "IDGJPGAIIBJ" field.</summary>
