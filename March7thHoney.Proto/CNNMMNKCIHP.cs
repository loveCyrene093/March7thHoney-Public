...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from CNNMMNKCIHP.proto</summary>
  public static partial class CNNMMNKCIHPReflection {

    #region Descriptor
    /// <summary>File descriptor for CNNMMNKCIHP.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "PGBPLONOIPE" field.</summary>
    ...
    /// <summary>Field number for the "MHMJGPMKPDL" field.</summary>
    ...
    /// <summary>Field number for the "JMLMMJCIMHC" field.</summary>
    ...
    /// <summary>Field number for the "HGBGJACAOHB" field.</summary>
