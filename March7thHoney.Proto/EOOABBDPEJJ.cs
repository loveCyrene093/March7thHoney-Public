...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from EOOABBDPEJJ.proto</summary>
  public static partial class EOOABBDPEJJReflection {

    #region Descriptor
    /// <summary>File descriptor for EOOABBDPEJJ.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "MALOADHCLPH" field.</summary>
    ...
    /// <summary>Field number for the "KCKEMAPBCOF" field.</summary>
    ...
    /// <summary>Field number for the "JEFCNPJCPMN" field.</summary>
    ...
    /// <summary>Field number for the "AFDGEDFKAGG" field.</summary>
    ...
    /// <summary>Field number for the "NCGPNEOILPC" field.</summary>
    ...
    /// <summary>Field number for the "APPELIAGBEE" field.</summary>
    ...
    /// <summary>Field number for the "PAJDKFMMAEO" field.</summary>
    ...
    /// <summary>Field number for the "PPGFGHIPEPH" field.</summary>
    ...
    /// <summary>Field number for the "CLAJDOECAHE" field.</summary>
    ...
    /// <summary>Field number for the "ECMOFEBPNGM" field.</summary>
    ...
    /// <summary>Field number for the "FCEEEBLCBAJ" field.</summary>
    ...
    /// <summary>Field number for the "IPFOGBIFCFG" field.</summary>
    ...
    /// <summary>Field number for the "LBPLNAPFAIM" field.</summary>
    ...
    /// <summary>Field number for the "FJCODOOIGKG" field.</summary>
    ...
    /// <summary>Field number for the "FOGCABKJOLM" field.</summary>
    ...
    /// <summary>Field number for the "MLCCEEBNHOL" field.</summary>
    ...
    /// <summary>Field number for the "NEPKHDPCKPF" field.</summary>
    ...
    /// <summary>Field number for the "LIECNMCDHEB" field.</summary>
    ...
    /// <summary>Field number for the "IBODBCMEJIG" field.</summary>
    ...
    /// <summary>Field number for the "BBIEALHDKFJ" field.</summary>
    ...
    /// <summary>Field number for the "LJEMGMMJIBO" field.</summary>
    ...
    /// <summary>Field number for the "MMDJPIBEICK" field.</summary>
    ...
    /// <summary>Field number for the "IHNDGCHCNBE" field.</summary>
    ...
    /// <summary>Field number for the "FHEPDALECNE" field.</summary>
    ...
    /// <summary>Field number for the "CNPGENEOAHA" field.</summary>
    ...
    /// <summary>Field number for the "KGAJNAHHAIJ" field.</summary>
