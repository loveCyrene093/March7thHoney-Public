...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from AKCFLPEANJB.proto</summary>
  public static partial class AKCFLPEANJBReflection {

    #region Descriptor
    /// <summary>File descriptor for AKCFLPEANJB.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "MEEPFKLLIJB" field.</summary>
    ...
    /// <summary>Field number for the "HDPINGEDMCM" field.</summary>
    ...
    /// <summary>Field number for the "FPFIHHBNBAN" field.</summary>
    ...
    /// <summary>Field number for the "OPCGJFMGEEH" field.</summary>
    ...
    /// <summary>Field number for the "CHLKDEDPOBG" field.</summary>
    ...
    /// <summary>Field number for the "GDNPJLLOHEE" field.</summary>
    ...
    /// <summary>Field number for the "FGFBHFJODJA" field.</summary>
