...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from IPMPONAHFBG.proto</summary>
  public static partial class IPMPONAHFBGReflection {

    #region Descriptor
    /// <summary>File descriptor for IPMPONAHFBG.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "JFJJLGFCOMO" field.</summary>
    ...
    /// <summary>Field number for the "GHBNOAMOAND" field.</summary>
    ...
    /// <summary>Field number for the "IEDPBIABBCK" field.</summary>
    ...
    /// <summary>Field number for the "HFLIAJCNJPL" field.</summary>
