...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from GLENEKHDKLJ.proto</summary>
  public static partial class GLENEKHDKLJReflection {

    #region Descriptor
    /// <summary>File descriptor for GLENEKHDKLJ.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "NAPGANOLBGL" field.</summary>
    ...
    /// <summary>Field number for the "OPLBOCPIIBP" field.</summary>
    ...
    /// <summary>Field number for the "MGPJLHCHAME" field.</summary>
    ...
    /// <summary>Field number for the "AMHDFMFILBD" field.</summary>
