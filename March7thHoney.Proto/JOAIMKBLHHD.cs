...
namespace March7thHoney.Proto {
  ...
  /// <summary>Holder for reflection information generated from JOAIMKBLHHD.proto</summary>
  public static partial class JOAIMKBLHHDReflection {

    #region Descriptor
    /// <summary>File descriptor for JOAIMKBLHHD.proto</summary>
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "EPFDJFBCDIL" field.</summary>
    ...
    /// <summary>Field number for the "GODGALFEHJF" field.</summary>
    ...
    /// <summary>Field number for the "HHKCADKCLJC" field.</summary>
    ...
    /// <summary>Field number for the "DOHLLMLDLMP" field.</summary>
