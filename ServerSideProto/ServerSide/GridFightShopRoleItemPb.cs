...
public sealed class GridFightShopRoleItemPb : IMessage<GridFightShopRoleItemPb>, IMessage, IEquatable<GridFightShopRoleItemPb>, IDeepCloneable<GridFightShopRoleItemPb>, IBufferMessage
{
	private static readonly MessageParser<GridFightShopRoleItemPb> _parser = new MessageParser<GridFightShopRoleItemPb>(() => new GridFightShopRoleItemPb());
	...
	public static MessageParser<GridFightShopRoleItemPb> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => GridFightDataReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public GridFightShopRoleItemPb(GridFightShopRoleItemPb other)
		: this()
	{
