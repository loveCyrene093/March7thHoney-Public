...
public sealed class ChallengeStoryDataPb : IMessage<ChallengeStoryDataPb>, IMessage, IEquatable<ChallengeStoryDataPb>, IDeepCloneable<ChallengeStoryDataPb>, IBufferMessage
{
	private static readonly MessageParser<ChallengeStoryDataPb> _parser = new MessageParser<ChallengeStoryDataPb>(() => new ChallengeStoryDataPb());
	...
	public static MessageParser<ChallengeStoryDataPb> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ChallengeDataReflection.Descriptor.MessageTypes[2];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ChallengeStoryDataPb(ChallengeStoryDataPb other)
		: this()
	{
