...
public class QuestManager : BasePlayerManager
{
	public UnlockHandler UnlockHandler { get; }

	public QuestData QuestData { get; }

	public List<QuestInfo> WaitToSync { get; }

	public QuestManager(PlayerInstance player)
	{
		UnlockHandler = new UnlockHandler(player);
		QuestData = DatabaseHelper.Instance.GetInstanceOrCreateNew<QuestData>(player.Uid);
		WaitToSync = new List<QuestInfo>();
