...
public class MessageManager : BasePlayerManager
{
	public MessageData Data { get; }

	public List<MessageSectionData> PendingMessagePerformSectionList { get; private set; }

	public MessageManager(PlayerInstance player)
	{
		Data = DatabaseHelper.Instance.GetInstanceOrCreateNew<MessageData>(player.Uid);
		PendingMessagePerformSectionList = new List<MessageSectionData>();
