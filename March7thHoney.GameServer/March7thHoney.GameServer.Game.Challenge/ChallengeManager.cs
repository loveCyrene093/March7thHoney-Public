...
public class ChallengeManager : BasePlayerManager
{
	public BaseChallengeInstance? ChallengeInstance { get; set; }

	public ChallengeData ChallengeData { get; }

	public ChallengeManager(PlayerInstance player)
	{
		ChallengeData = DatabaseHelper.Instance.GetInstanceOrCreateNew<ChallengeData>(player.Uid);
