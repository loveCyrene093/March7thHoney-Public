...
public class MissionHandlerEnterMapByEntrance : MissionFinishTypeHandler
{
	...
	{
		if (arg is MapEntranceExcel mapEntranceExcel && mapEntranceExcel.ID == info.ParamInt1)
		{
	...
	{
		if (arg is MapEntranceExcel mapEntranceExcel && mapEntranceExcel.ID == excel.ParamInt1)
		{
