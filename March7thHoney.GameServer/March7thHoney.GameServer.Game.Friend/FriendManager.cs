...
public class FriendManager : BasePlayerManager
{
	public FriendData FriendData { get; set; }

	public FriendManager(PlayerInstance player)
	{
		FriendData = DatabaseHelper.Instance.GetInstanceOrCreateNew<FriendData>(player.Uid);
