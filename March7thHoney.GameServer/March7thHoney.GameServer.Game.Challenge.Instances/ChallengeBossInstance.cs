...
public class ChallengeBossInstance : BaseLegacyChallengeInstance
{
	public override ChallengeConfigExcel Config { get; }

	public ChallengeBossInstance(PlayerInstance player, ChallengeDataPb data)
	{
		Config = GameData.ChallengeConfigData[(int)data.Boss.ChallengeMazeId];
